            ...
            <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $simfoni->tanggal_lahir ? \Carbon\Carbon::parse($simfoni->tanggal_lahir)->locale('id')->format('d F Y') : '-' }}</td>
                        <td>{{ $simfoni->nuptk }}</td>
                        <td>{{ $simfoni->kartanu }}</td>
                        <td>{{ $simfoni->nipm }}</td>
                        <td>{{ $simfoni->nik }}</td>
                        <td>{{ $simfoni->tmt ? \Carbon\Carbon::parse($simfoni->tmt)->locale('id')->format('d F Y') : '-' }}</td>
                        ...
                        <td>{{ $simfoni->tanggal_sk_pertama ? \Carbon\Carbon::parse($simfoni->tanggal_sk_pertama)->locale('id')->format('d F Y') : '-' }}</td>
