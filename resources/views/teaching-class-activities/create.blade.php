...
@section('title') Tambah Kegiatan Kelas @endsection
...
@component('components.breadcrumb')
    ...
    @slot('title') Tambah Kegiatan @endslot
@endcomponent
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('teaching-class-activities.store') }}">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="activity_type" required>
                                ...
                                @foreach($types as $t)
                                    <option value="{{ $t }}" @selected(old('activity_type') === $t)>{{ $t }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Keterangan (opsional)</label>
                            <input type="text" class="form-control" name="description" value="{{ old('description') }}" placeholder="Contoh: UTS kelas VII A">
                        </div>
                    </div>
