        ...
        <div class="card filter-card mb-4">
            <div class="card-body">
                ...
                <p class="text-white-50 mb-0">
                    Kelola dan pantau tagihan iuran UPPM untuk setiap sekolah pada tahun {{ request('tahun', date('Y')) }}
                </p>
            </div>
        </div>
    </div>
                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-4">
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('uppm.tagihan') }}" class="btn btn-secondary px-4">
            ...
            <div class="card-body">
                ...
                @else
                    <div class="empty-state">
                        ...
                        <p class="text-muted">Belum ada data tagihan untuk tahun {{ request('tahun', date('Y')) }}.</p>
                    </div>
                @endif
            </div>
        </div>
