...
@section('title', 'Penilaian Pemateri - Instrument Talenta')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="pemateri_id" required>
                            ...
                            @foreach($pemateris as $pemateri)
                                <option value="{{ $pemateri->id }}"
                                        data-materi="{{ $pemateri->materi->judul_materi ?? 'N/A' }}"
                                        data-tanggal="{{ $pemateri->materi->tanggal_materi ? $pemateri->materi->tanggal_materi->format('d/m/Y') : 'N/A' }}">
                                    {{ $pemateri->nama }} ({{ $pemateri->kode_pemateri }})
                                </option>
                            @endforeach
                        </select>
                    </div>
