...
@section('title', 'Penilaian Tim Layanan Teknis - Instrument Talenta')
                        ...
                        <select class="form-select" id="materi_id" required>
                            ...
                            @foreach($materis as $materi)
                                <option value="{{ $materi->id }}"
                                        data-tanggal="{{ $materi->tanggal_materi ? $materi->tanggal_materi->format('d/m/Y') : 'N/A' }}">
                                    {{ $materi->judul_materi }} ({{ $materi->kode_materi }})
                                </option>
                            @endforeach
                        </select>
                    </div>
