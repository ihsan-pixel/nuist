                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4">
                        <div class="text-center">
                            <img src="{{ asset('images/logo favicon 1.png') }}" alt="Logo" class="img-fluid" style="max-height: 80px;">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="text-center mb-4">
                            ...
                            <a href="{{ route('instumen-talenta.input-peserta') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="col-md-3">
                        <div class="text-center mb-4">
                            ...
                            <a href="{{ route('instumen-talenta.input-pemateri') }}" class="btn btn-success btn-sm">
                    ...
                    <div class="col-md-3">
                        <div class="text-center mb-4">
                            ...
                            <a href="{{ route('instumen-talenta.input-fasilitator') }}" class="btn btn-info btn-sm">
                    ...
                    <div class="col-md-3">
                        <div class="text-center mb-4">
                            ...
                            <a href="{{ route('instumen-talenta.input-materi') }}" class="btn btn-warning btn-sm">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="text-center mb-4">
                            ...
                            <a href="{{ route('instumen-talenta.peserta') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="col-md-3">
                        <div class="text-center mb-4">
                            ...
                            <a href="{{ route('instumen-talenta.pemateri') }}" class="btn btn-success btn-sm">
                                <i class="fas fa-sign-in-alt me-1"></i> Masuk
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="text-center mb-4">
                            ...
                            <a href="{{ route('instumen-talenta.fasilitator') }}" class="btn btn-info btn-sm">
                                <i class="fas fa-sign-in-alt me-1"></i> Masuk
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="text-center mb-4">
                            ...
                            <a href="{{ route('instumen-talenta.admin') }}" class="btn btn-danger btn-sm">
                                <i class="fas fa-sign-in-alt me-1"></i> Masuk
                            </a>
                        </div>
                    </div>
