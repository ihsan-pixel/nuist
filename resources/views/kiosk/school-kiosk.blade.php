                                    ...
                                    <div class="camera-panel-copy-wrap">
                                        ...
                                        <div class="camera-summary-brand">
                                            <div class="camera-summary-logo">
                                                @if(!empty($attendanceSummary['school_logo_url']))
                                                    <img src="{{ $attendanceSummary['school_logo_url'] }}" alt="{{ $attendanceSummary['school_name'] ?? 'Sekolah' }}" loading="lazy" decoding="async">
                                                @else
                                        ...
                                        <div class="camera-summary-grid">
                                            <div class="camera-summary-card is-text">
                                                ...
                                                <span class="camera-summary-value" id="summarySchoolName">{{ $attendanceSummary['school_name'] ?? '-' }}</span>
                                            </div>
                                            <div class="camera-summary-card">
                                                <span class="camera-summary-label">Guru & Pegawai</span>
                                                <span class="camera-summary-value" id="summaryTotalPeople">{{ $attendanceSummary['total_people'] ?? 0 }}</span>
                                            </div>
                                            <div class="camera-summary-card">
                                                <span class="camera-summary-label">Sudah Presensi</span>
                                                <span class="camera-summary-value" id="summaryPresentCount">{{ $attendanceSummary['present_count'] ?? 0 }}</span>
                                            </div>
                                            <div class="camera-summary-card">
                                                <span class="camera-summary-label">Belum Presensi</span>
                                                <span class="camera-summary-value" id="summaryNotPresentCount">{{ $attendanceSummary['not_present_count'] ?? 0 }}</span>
                                            </div>
                                            <div class="camera-summary-card">
                                                <span class="camera-summary-label">Izin</span>
                                                <span class="camera-summary-value" id="summaryIzinCount">{{ $attendanceSummary['izin_count'] ?? 0 }}</span>
                                            </div>
                                            <div class="camera-summary-card">
                                                <span class="camera-summary-label">Persentase Kehadiran</span>
                                                <span class="camera-summary-value" id="summaryAttendancePercentage">{{ number_format((float) ($attendanceSummary['attendance_percentage'] ?? 0), 1) }}%</span>
                                            </div>
                                        </div>
...
<script>
    (function () {
        ...
        const verifyFaceMatchUrl = @json(route('school-kiosk.verify-face-match'));
