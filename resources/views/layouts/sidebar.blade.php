            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu collapse" id="skYayasanSubmenu">
                        ...
                        <li><a href="{{ route('sk-yayasan.pengajuan.index') }}">Pengajuan SK</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu collapse" id="ppdbSubmenu">
                        ...
                        <li><a href="{{ route('ppdb.lp.ppdb-settings', auth()->user()->madrasah_id) }}">Pengaturan</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu collapse" id="dataSekolahSubmenu">
                        <li><a href="{{ route('data-sekolah.data-siswa.index') }}">Data Siswa</a></li>
                        <li><a href="{{ route('data-sekolah.siswa') }}">Data Siswa per Tahun</a></li>
                ...
                <li>
                    <a href="{{ route('spp-siswa.transaksi') }}" class="waves-effect">
                        <i class="bx bx-credit-card"></i>
                        <span>Transaksi</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('spp-siswa.laporan') }}" class="waves-effect">
                        <i class="bx bx-bar-chart-alt-2"></i>
                        <span>Laporan</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('spp-siswa.pengaturan') }}" class="waves-effect">
                        <i class="bx bx-cog"></i>
                ...
                <li>
                    <a href="{{ route('instumen-talenta.index') }}" class="waves-effect">
                        <i class="bx bx-data"></i>
                        <span>Talenta</span>
                    </a>
                </li>
