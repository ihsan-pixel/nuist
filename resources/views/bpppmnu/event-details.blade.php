<dl>
@foreach(['type'=>'Jenis kegiatan','description'=>'Deskripsi','organizer'=>'Penyelenggara','person_in_charge'=>'Penanggung jawab','location_name'=>'Lokasi','address'=>'Alamat','rundown'=>'Susunan acara'] as $field => $label)
