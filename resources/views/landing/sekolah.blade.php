        ...
        <div class="nav-left">
            ...
            <ul class="nav-menu" id="nav-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a href="{{ route('landing') }}#features">Performa Tinggi</a></li>
                        <li><a href="{{ route('landing') }}#features">Responsif Penuh</a></li>
                        <li><a href="{{ route('landing') }}#features">Keamanan Terjamin</a></li>
                        <li><a href="{{ route('landing') }}#features">Template Modern</a></li>
                        <li><a href="{{ route('landing') }}#features">Analytics Terintegrasi</a></li>
                        <li><a href="{{ route('landing') }}#features">Dukungan 24/7</a></li>
                    </ul>
                </li>
