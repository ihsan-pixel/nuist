        ...
        <div class="about-section">
            ...
            <div class="sub-tab-content active" id="sejarah">
                <div class="about-content">
                    ...
                    <p>{{ $madrasah->sejarah ?? 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.' }}</p>
            ...
            <div class="sub-tab-content" id="visi">
                <div class="about-content">
                    <h3>Visi</h3>
                    <p>{{ $madrasah->visi ?? 'Terwujudnya lembaga pendidikan yang bermutu, berakhlakul karimah, dan mampu bersaing di era global.' }}</p>
            ...
            <div class="sub-tab-content" id="motto">
                <div class="about-content">
                    ...
                    <div style="text-align: center; padding: 40px 20px; background: linear-gradient(135deg, #f8fafc, #e2e8f0); border-radius: 16px; margin-top: 20px;">
                        ...
                        <p style="font-size: 16px; color: #64748b;">{{ $madrasah->motto ?? 'Motto ini mencerminkan komitmen sekolah dalam membentuk generasi yang berprestasi, berakhlak mulia, dan memberikan manfaat bagi masyarakat.' }}</p>
                    </div>
                </div>
            </div>
        </div>
