        ...
        <div class="school-header-grid">
            ...
            <div class="kepala-sekolah-photo">
                @if($madrasah->kepala_sekolah_foto)
                    <img src="{{ asset('storage/' . $madrasah->kepala_sekolah_foto) }}" alt="Foto Kepala Sekolah" class="ks-photo-img">
                @else
            ...
            <div class="school-info">
                ...
                <div class="kepala-sekolah-info">
                    ...
                    <span class="ks-name">{{ $madrasah->kepala_sekolah_gelar ?? '' }} {{ $madrasah->kepala_sekolah_nama }}</span>
                </div>
                @endif
            </div>
        </div>
