...
<div class="shell">
    <aside>
        ...
        <nav class="nav" style="margin-top:16px">
            <a href="{{ route('ami.dashboard') }}">Dashboard</a>
            <a href="{{ route('ami.instrumen') }}">Instrumen</a>
            <a href="{{ route('ami.evaluasi-diri') }}">Evaluasi Diri</a>
            <a href="{{ route('ami.monitoring') }}">Monitoring</a>
            <a href="{{ route('ami.penugasan') }}">Penugasan</a>
            <a href="{{ route('ami.audit') }}">Audit</a>
            <a href="{{ route('ami.klarifikasi') }}">Klarifikasi</a>
            <a href="{{ route('ami.temuan') }}">Temuan</a>
            <a href="{{ route('ami.tindak-lanjut') }}">Tindak Lanjut</a>
            <a href="{{ route('ami.peta-mutu') }}">Peta Mutu</a>
            <a href="{{ route('ami.laporan') }}">Laporan</a>
        </nav>
    </aside>
