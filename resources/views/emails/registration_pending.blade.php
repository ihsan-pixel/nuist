...
<body>
    ...
    <div class="content">
        ...
        <ul>
            ...
            @endif
            @if($pendingRegistration->asal_sekolah)
                <li><strong>Asal Sekolah:</strong> {{ $pendingRegistration->madrasah ? $pendingRegistration->madrasah->name : 'N/A' }}</li>
            @endif
        </ul>
    ...
    <div class="footer">
        <p>© {{ date('Y') }} LP. Ma'arif NU PWNU DIY. All rights reserved.</p>
