    ...
    <div class="card">
        ...
        <div class="content">
            ...
            <div class="detail-box">
                <ul>
                    <li><strong>Sekolah:</strong> {{ $registration->madrasah->name ?? '-' }}</li>
                    <li><strong>Email:</strong> {{ $registration->email }}</li>
                    <li><strong>Jabatan:</strong> {{ $registration->jabatan }}</li>
                    <li><strong>Waktu Pengajuan:</strong> {{ optional($registration->submitted_at)->format('d M Y H:i') }}</li>
                </ul>
            </div>
