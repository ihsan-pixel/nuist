...
<head>
    ...
    <title>Pesan Baru dari {{ $sender->name }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        <p>Halo <strong>{{ $receiver->name }}</strong>,</p>

        <p>Anda menerima pesan baru dari <strong>{{ $sender->name }}</strong> di sistem chat admin.</p>
        ...
        <p>
            <a href="{{ route('chat.index') }}" class="btn">Buka Chat</a>
        </p>
    ...
    <div class="footer">
        ...
        <p>&copy; {{ date('Y') }} NU IST. All rights reserved.</p>
    </div>
</body>
</html>
