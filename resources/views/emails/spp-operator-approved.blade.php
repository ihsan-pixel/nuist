...
<body>
    <div class="card">
        ...
        <div class="content">
            <p>Yth. {{ $user->name }},</p>
            <p>Permohonan akun Operator SPP untuk <strong>{{ $registration->madrasah->name ?? '-' }}</strong> telah disetujui.</p>

            <div class="credential-box">
                <p style="margin:0 0 10px;"><strong>Email Login:</strong> {{ $user->email }}</p>
