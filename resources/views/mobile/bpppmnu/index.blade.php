...
.bpp-member-code-image { width:170px; height:170px; flex:0 0 170px; padding:8px; border:1px solid #dfe9e4; border-radius:12px; background:#fff; }
...
@media(max-width:380px) { .bpp-member-code { gap:12px; padding:13px; } .bpp-member-code-image { width:140px; height:140px; flex-basis:140px; } }
</style>
