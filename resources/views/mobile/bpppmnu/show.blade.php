...
<div class="bpp-recap" id="bpp-recap" data-url="{{ route('mobile.bpppmnu.events.recap', $event) }}"><div class="bpp-recap-item"><span class="bpp-recap-value" data-recap="present">{{ $recap['present'] }}</span><span class="bpp-recap-label">Sudah hadir</span></div><div class="bpp-recap-item"><span class="bpp-recap-value" data-recap="remaining">{{ $recap['remaining'] }}</span><span class="bpp-recap-label" data-recap="remaining-label">{{ now()->gt($event->attendance_close_at) ? 'Tidak hadir' : 'Belum hadir' }}</span></div><div class="bpp-recap-item"><span class="bpp-recap-value" data-recap="percentage">{{ $recap['percentage'] }}%</span><span class="bpp-recap-label">Kehadiran</span></div></div>
