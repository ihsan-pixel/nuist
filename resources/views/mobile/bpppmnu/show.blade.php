...
<style>
.bpp-detail-shell.bpp-scanner-only .bpp-detail-back,.bpp-detail-shell.bpp-scanner-only > .bpp-detail-card:first-of-type{display:none!important}.bpp-detail-shell.bpp-scanner-only .bpp-detail-scanner{margin-top:8px;min-height:calc(100vh - 150px);display:flex;flex-direction:column;justify-content:center}
