    ...
    <div class="services-form">
        <div class="services-grid" id="servicesGrid">
            <div class="service-wrapper">
                <a href="{{ route('yayasan.index') }}" class="service-item">
                    <img src="{{ asset('images/menu_icon/yayasan.png') }}" alt="Background" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 8px; z-index: 0;">
                </a>
                <div class="service-label">Data Yayasan</div>
            </div>
            <div class="service-wrapper">
                <a href="{{ route('pengurus.index') }}" class="service-item">
                    <img src="{{ asset('images/menu_icon/pengurus.png') }}" alt="Background" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 8px; z-index: 0;">
                </a>
                <div class="service-label">Data Pengurus</div>
            </div>
            <div class="service-wrapper">
                <a href="{{ route('madrasah.index') }}" class="service-item">
                    <img src="{{ asset('images/menu_icon/madrasah.png') }}" alt="Background" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 8px; z-index: 0;">
                </a>
                <div class="service-label">Data Madrasah</div>
            </div>
            <div class="service-wrapper">
                <a href="{{ route('tenaga-pendidik.index') }}" class="service-item">
                    <img src="{{ asset('images/menu_icon/tenaga_pendidik.png') }}" alt="Background" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 8px; z-index: 0;">
                </a>
                <div class="service-label">Tenaga Pendidik</div>
            </div>
            <div class="service-wrapper">
                <a href="{{ route('status-kepegawaian.index') }}" class="service-item">
                    <img src="{{ asset('images/menu_icon/status_kepegawaian.png') }}" alt="Background" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 8px; z-index: 0;">
                </a>
                <div class="service-label">Status Kepegawaian</div>
            </div>
            <div class="service-wrapper">
                <a href="{{ route('tahun-pelajaran.index') }}" class="service-item">
                    <img src="{{ asset('images/menu_icon/tahun_pelajaran.png') }}" alt="Background" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 8px; z-index: 0;">
                </a>
                <div class="service-label">Tahun Pelajaran</div>
            </div>
            <div class="service-wrapper">
                <a href="{{ route('admin.teaching_progress') }}" class="service-item">
                    <img src="{{ asset('images/menu_icon/teaching_progress.png') }}" alt="Background" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 8px; z-index: 0;">
                </a>
                <div class="service-label">Progres Mengajar</div>
            </div>
            <div class="service-wrapper">
                <a href="{{ route('admin.data_madrasah') }}" class="service-item">
                    <img src="{{ asset('images/menu_icon/data_madrasah.png') }}" alt="Background" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 8px; z-index: 0;">
                </a>
                <div class="service-label">Kelengkapan Data</div>
            </div>
            <div class="service-wrapper">
                <a href="{{ route('uppm.index') }}" class="service-item">
                    <img src="{{ asset('images/menu_icon/uppm.png') }}" alt="Background" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 8px; z-index: 0;">
                </a>
                <div class="service-label">UPPM</div>
            </div>
            <div class="service-wrapper">
                <a href="{{ route('ppdb.index') }}" class="service-item">
                    <img src="{{ asset('images/menu_icon/ppdb.png') }}" alt="Background" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 8px; z-index: 0;">
                </a>
                <div class="service-label">PPDB</div>
            </div>
            <div class="service-wrapper">
                <a href="{{ route('development-history.index') }}" class="service-item">
                    <img src="{{ asset('images/menu_icon/development.png') }}" alt="Background" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 8px; z-index: 0;">
                </a>
                <div class="service-label">Riwayat Pengembangan</div>
            </div>
            <div class="service-wrapper">
                <a href="{{ route('active-users.index') }}" class="service-item">
                    <img src="{{ asset('images/menu_icon/active_users.png') }}" alt="Background" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; border-radius: 8px; z-index: 0;">
                </a>
