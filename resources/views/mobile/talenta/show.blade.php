    ...
    <div class="section-card">
        ...
        <div class="section-content">
            ...
            <div class="data-item">
                ...
                <a href="{{ Storage::url($talenta->sertifikat_tpt_1) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->sertifikat_tpt_2)
            <div class="data-item">
                <label>Sertifikat TPT Level 2:</label>
                <a href="{{ Storage::url($talenta->sertifikat_tpt_2) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->sertifikat_tpt_3)
            <div class="data-item">
                <label>Sertifikat TPT Level 3:</label>
                <a href="{{ Storage::url($talenta->sertifikat_tpt_3) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->sertifikat_tpt_4)
            <div class="data-item">
                <label>Sertifikat TPT Level 4:</label>
                <a href="{{ Storage::url($talenta->sertifikat_tpt_4) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->sertifikat_tpt_5)
            <div class="data-item">
                <label>Sertifikat TPT Level 5:</label>
                <a href="{{ Storage::url($talenta->sertifikat_tpt_5) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            ...
            <div class="data-item">
                ...
                <a href="{{ Storage::url($talenta->produk_unggulan_1) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->produk_unggulan_2)
            <div class="data-item">
                <label>Produk Unggulan Level 2:</label>
                <a href="{{ Storage::url($talenta->produk_unggulan_2) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->produk_unggulan_3)
            <div class="data-item">
                <label>Produk Unggulan Level 3:</label>
                <a href="{{ Storage::url($talenta->produk_unggulan_3) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->produk_unggulan_4)
            <div class="data-item">
                <label>Produk Unggulan Level 4:</label>
                <a href="{{ Storage::url($talenta->produk_unggulan_4) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->produk_unggulan_5)
            <div class="data-item">
                <label>Produk Unggulan Level 5:</label>
                <a href="{{ Storage::url($talenta->produk_unggulan_5) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            ...
            <div class="data-item">
                ...
                <a href="{{ Storage::url($talenta->pkpnu_sertifikat) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->mknu_sertifikat)
            <div class="data-item">
                <label>Sertifikat MKNU:</label>
                <a href="{{ Storage::url($talenta->mknu_sertifikat) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->pmknu_sertifikat)
            <div class="data-item">
                <label>Sertifikat PMKNU:</label>
                <a href="{{ Storage::url($talenta->pmknu_sertifikat) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            ...
            <div class="data-item">
                ...
                <a href="{{ Storage::url($talenta->foto_resmi) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->foto_bebas)
            <div class="data-item">
                <label>Foto Bebas:</label>
                <a href="{{ Storage::url($talenta->foto_bebas) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->foto_keluarga)
            <div class="data-item">
                <label>Foto Keluarga:</label>
                <a href="{{ Storage::url($talenta->foto_keluarga) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            ...
            <div class="data-item">
                ...
                <a href="{{ Storage::url($talenta->ijazah_s1) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->ijazah_s2)
            <div class="data-item">
                <label>Ijazah S2:</label>
                <a href="{{ Storage::url($talenta->ijazah_s2) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->ijazah_s3)
            <div class="data-item">
                <label>Ijazah S3:</label>
                <a href="{{ Storage::url($talenta->ijazah_s3) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            ...
            <div class="data-item">
                ...
                <a href="{{ Storage::url($talenta->gtt_ptt_sk) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->gty_sk)
            <div class="data-item">
                <label>SK GTY:</label>
                <a href="{{ Storage::url($talenta->gty_sk) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            ...
            <div class="data-item">
                ...
                <a href="{{ Storage::url($talenta->lampiran_step_1) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->lampiran_step_2)
            <div class="data-item">
                <label>Lampiran Step 2:</label>
                <a href="{{ Storage::url($talenta->lampiran_step_2) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->lampiran_step_3)
            <div class="data-item">
                <label>Lampiran Step 3:</label>
                <a href="{{ Storage::url($talenta->lampiran_step_3) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
            @if($talenta->lampiran_step_4)
            <div class="data-item">
                <label>Lampiran Step 4:</label>
                <a href="{{ Storage::url($talenta->lampiran_step_4) }}" target="_blank" class="btn btn-sm btn-outline-primary">Lihat File</a>
            </div>
            @endif
        </div>
    </div>
