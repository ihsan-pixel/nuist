...
@section('subtitle', 'Update Password')
...
<div class="container py-3" style="max-width: 420px; margin: auto;">
    ...
    <!-- Back Link -->
    <a href="{{ route('mobile.pengurus.profile') }}" class="back-link">
    ...
    <!-- Password Form -->
    <div class="form-card">
        <form action="{{ route('mobile.pengurus.update-password') }}" method="POST" id="passwordForm">
            @csrf
