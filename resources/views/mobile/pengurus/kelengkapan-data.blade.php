...
<div class="container py-3" style="max-width: 540px; margin: auto;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div class="d-flex align-items-center">
            <button href="{{ route('mobile.pengurus.dashboard') }}" class="btn btn-link p-0 me-3" style="color: #004b4c;">
    ...
    @forelse($madrasahs as $madrasah)
        <div class="card mb-3">
            <div class="card-body p-3">
                ...
                <div class="mb-2">
                    <div class="d-flex justify-content-between mb-1">
                        <span class="section-label">Laporan Akhir Tahun @if($madrasah->laporan_akhir_tahun_details['madrasah_id']) (Sudah Diisi) @else ({{ $madrasah->laporan_akhir_tahun_details['status'] }}) @endif</span>
