...
<div class="secondary-links">@unless($isSpmbHost)<a href="{{ url('register') }}">Belum punya akun? Daftar di sini</a>@endunless<a href="{{ $backUrl }}">{{ $isSpmbHost?'Kembali ke Halaman SPMB':'Kembali ke Halaman Utama' }}</a></div>
