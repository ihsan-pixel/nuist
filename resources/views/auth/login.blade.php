...
<body class="auth-body-bg">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-7">
                                            <div class="text-center">
                                                ...
                                                {{-- <h4 class="mb-3"><i class="bx bxs-quote-alt-left text-success h1 align-middle me-3"></i><span class="text-success">5k</span>+ Satisfied clients</h4>
                                                    ...
                                                    <div class="owl-carousel owl-theme auth-review-carousel" id="auth-review-carousel">
                                                        <div class="item">
                                                            <div class="py-3">
                                                                ...
                                                                <div>
                                                                    <h4 class="font-size-16 text-success">Abs1981</h4>
                                                        ...
                                                        <div class="item">
                                                            <div class="py-3">
                                                                ...
                                                                <div>
                                                                    <h4 class="font-size-16 text-success">nezerious</h4>
                                                                    <p class="font-size-14 mb-0">- Skote User</p>
                                                                </div>
                                                            </div>
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5">
                                    <a href="" class="d-block auth-logo">
                                        <img src="{{ URL::asset('build/images/logo 1.png') }}" alt="" height="90" class="auth-logo-dark">
                                        <img src="{{ URL::asset('build/images/logo 1.png') }}" alt="" height="70" class="auth-logo-light">
                                    </a>
                                </div>
                                <div class="my-auto">
                                    ...
                                    <div class="mt-4">
                                        <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                            ...
                                            {{-- <div class="mt-4 text-center">
                                                ...
                                                <ul class="list-inline">
                                                    <li class="list-inline-item">primary text-white border-primary">
                                        ...
                                        {{-- <div class="mt-5 text-center">
                                            <p>Don't have an account ? <a href="{{ url('register') }}" class="fw-medium text-success"> Signup now </a> </p>
                                        </div> --}}
                                    </div>
                                </div>
    ...
    <style>
        ...
        .bg-overlay {
            background: none !important; /* hilangkan overlay warna */
        }
    </style>
