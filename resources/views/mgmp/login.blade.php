        ...
        <div class="form-section">
            <div class="form-container">
                <div class="logo-section">
                    <img src="{{ asset('images/mgmp-logo.png') }}" alt="Logo MGMP" class="logo">
                </div>
                ...
                <form class="login-form" method="POST" action="{{ route('mgmp.authenticate') }}">
                    @csrf
                ...
                <div class="mt-3 text-center">
                    <p class="mb-0">Kembali ke <a href="{{ route('landing') }}" class="text-primary">Halaman Utama</a></p>
                </div>
        ...
        <div class="illustration-section">
            <div class="illustration-content">
                ...
                <div class="illustration-placeholder">
                    <img src="{{ asset('images/verification-img.png') }}" alt="Login Illustration" class="illustration-image">
                </div>
            </div>
        </div>
    </div>
