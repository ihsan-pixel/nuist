                    ...
                    <div class="card schedule-card h-100 position-relative {{ $cardStateClass }}">
                        ...
                        <div class="card-body p-4">
                            ...
                            @if($schedule->attendance)
                                    <div class="alert {{ $isAcademicCalendarEvent || (($schedule->attendance->status ?? 'hadir') === 'izin') ? 'alert-info' : 'alert-success' }} border-0 rounded-3 p-3 mb-0">
                                        <div class="d-flex align-items-center">
                                            <i class="bx {{ $isAcademicCalendarEvent ? 'bx-calendar-check' : ((($schedule->attendance->status ?? 'hadir') === 'izin') ? 'bx-info-circle' : 'bx-check-circle') }} fs-4 me-3"></i>
                                            <div>
                                                @if($isAcademicCalendarEvent)
