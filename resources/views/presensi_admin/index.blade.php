...
@if(in_array($user->role, ['super_admin', 'pengurus']))
    ...
    <!-- Comprehensive School Detail Modal - PPDB Style -->
            ...
            <div class="modal-content" style="border-radius: 15px !important; border: none !important; box-shadow: 0 10px 40px rgba(0,0,0,0.1) !important;">
                ...
                <div class="modal-body">
                    ...
                    <div class="map-section mb-4">
                        ...
                        <div class="map-container" id="comprehensive-map" style="height: 300px; border-radius: 10px; border: 1px solid #dee2e6;"></div>
