            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-8">
                    ...
                    <div class="hero-date-pill">
                        ...
                        Tanggal laporan: {{ $selectedDate->format('d F Y') }}
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="hero-toolbar">
                        ...
                        <div class="d-flex flex-column gap-2">
                            <form method="GET" action="{{ route('presensi_admin.index') }}" class="d-flex flex-column flex-sm-row align-items-sm-center gap-2 mb-0">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between gap-3">
                            <div>
                                ...
                                <h3 class="stat-value">{{ number_format($summary['users_presensi']) }}</h3>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between gap-3">
                            <div>
                                ...
                                <h3 class="stat-value">{{ number_format($summary['users_izin']) }}</h3>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between gap-3">
                            <div>
                                ...
                                <h3 class="stat-value">{{ number_format($summary['sekolah_presensi']) }}</h3>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between gap-3">
                            <div>
                                ...
                                <h3 class="stat-value">{{ number_format($summary['guru_tidak_presensi']) }}</h3>
