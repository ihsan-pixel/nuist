        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6">
                <div class="feature-card p-4 rounded shadow text-center animate-on-scroll" style="background: white; height: 100%;">
                    ...
                    <h5 class="fw-bold mb-3">Tanpa Instalasi & Berbasis Cloud</h5>
                    <p class="text-muted">Tidak perlu menginstal perangkat lunak atau perangkat keras khusus, hanya perlu akses internet.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="feature-card p-4 rounded shadow text-center animate-on-scroll" style="background: white; height: 100%;">
                    <i class="bi bi-device-fill display-4 mb-3" style="color: #004b4c;"></i>
                    <h5 class="fw-bold mb-3">Multi Platform & Multi Akses</h5>
                    <p class="text-muted">Dapat diakses melalui desktop, laptop, tablet, maupun ponsel pintar baik melalui internet, SMS, maupun aplikasi Android.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="feature-card p-4 rounded shadow text-center animate-on-scroll" style="background: white; height: 100%;">
                    <i class="bi bi-database-fill display-4 mb-3" style="color: #004b4c;"></i>
                    <h5 class="fw-bold mb-3">Integrasi Data Dapodik</h5>
                    <p class="text-muted">Memastikan seluruh data pendaftaran calon murid selaras dengan data pendidikan nasional.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="feature-card p-4 rounded shadow text-center animate-on-scroll" style="background: white; height: 100%;">
                    ...
                    <p class="text-muted">Tampilan dapat disesuaikan dengan perangkat yang digunakan.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="feature-card p-4 rounded shadow text-center animate-on-scroll" style="background: white; height: 100%;">
                    <i class="bi bi-diagram-3-fill display-4 mb-3" style="color: #004b4c;"></i>
                    <h5 class="fw-bold mb-3">Multi Model Alur Pendaftaran</h5>
                    <p class="text-muted">Menyediakan berbagai macam alur pendaftaran sesuai dengan petunjuk teknis.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="feature-card p-4 rounded shadow text-center animate-on-scroll" style="background: white; height: 100%;">
                    <i class="bi bi-signpost-split-fill display-4 mb-3" style="color: #004b4c;"></i>
                    <h5 class="fw-bold mb-3">Multi Jalur Seleksi</h5>
                    <p class="text-muted">Mendukung PPDB Online dengan berbagai jalur sesuai dengan Permendikbud.</p>
                </div>
            </div>
            <div class="col-12">
                <div class="feature-card p-4 rounded shadow text-center animate-on-scroll" style="background: linear-gradient(135deg, #004b4c 0%, #004b4c 100%); color: white;">
                    ...
                    <p>Memproses data pendaftaran calon murid secara real time mulai dari pendaftaran hingga pengumuman hasil seleksi.</p>
                </div>
            </div>
        </div>
    </div>
