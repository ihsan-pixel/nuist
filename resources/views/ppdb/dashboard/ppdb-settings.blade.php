                ...
                <div class="form-group">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <select class="form-select @error('ppdb_status') is-invalid @enderror" id="ppdb_status" name="ppdb_status" style="max-width: 200px;">
                            <option value="tutup" {{ old('ppdb_status', $ppdbSetting ? ($ppdbSetting->ppdb_status ?? 'tutup') : 'tutup') == 'tutup' ? 'selected' : '' }}>Tutup</option>
                            <option value="buka" {{ old('ppdb_status', $ppdbSetting ? ($ppdbSetting->ppdb_status ?? 'tutup') : 'tutup') == 'buka' ? 'selected' : '' }}>Buka</option>
                        </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control @error('ppdb_jadwal_buka') is-invalid @enderror"
                                   ...
                                   value="{{ old('ppdb_jadwal_buka', $ppdbSetting ? ($ppdbSetting->ppdb_jadwal_buka ? $ppdbSetting->ppdb_jadwal_buka->format('Y-m-d\TH:i') : '') : '') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control @error('ppdb_jadwal_tutup') is-invalid @enderror"
                                   ...
                                   value="{{ old('ppdb_jadwal_tutup', $ppdbSetting ? ($ppdbSetting->ppdb_jadwal_tutup ? $ppdbSetting->ppdb_jadwal_tutup->format('Y-m-d\TH:i') : '') : '') }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control @error('ppdb_jadwal_pengumuman') is-invalid @enderror"
                                   ...
                                   value="{{ old('ppdb_jadwal_pengumuman', $ppdbSetting ? ($ppdbSetting->ppdb_jadwal_pengumuman ? $ppdbSetting->ppdb_jadwal_pengumuman->format('Y-m-d\TH:i') : '') : '') }}">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control @error('ppdb_kuota_total') is-invalid @enderror"
                                   ...
                                   value="{{ old('ppdb_kuota_total', $ppdbSetting ? ($ppdbSetting->ppdb_kuota_total ?? '') : '') }}" readonly>
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('ppdb_biaya_pendaftaran') is-invalid @enderror"
                              ...
                              placeholder="Informasi biaya pendaftaran PPDB">{{ old('ppdb_biaya_pendaftaran', $ppdbSetting ? ($ppdbSetting->ppdb_biaya_pendaftaran ?? '') : '') }}</textarea>
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('ppdb_catatan_pengumuman') is-invalid @enderror"
                              ...
                              placeholder="Catatan tambahan untuk pengumuman hasil PPDB">{{ old('ppdb_catatan_pengumuman', $ppdbSetting ? ($ppdbSetting->ppdb_catatan_pengumuman ?? '') : '') }}</textarea>
