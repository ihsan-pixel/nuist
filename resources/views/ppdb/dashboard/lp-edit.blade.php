    ...
    <form action="{{ route('ppdb.lp.update', $madrasah->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <div class="help-text">Kuota per jurusan otomatis mengikuti jurusan yang sudah diisi di atas.</div>
                <div id="ppdb-quota-jurusan-container" class="array-input-container">
                    ...
                    @if(is_array($jurusanArray) && count($jurusanArray) > 0)
                        ...
                        @endforeach
                    @else
                        <div class="help-text">Isi jurusan terlebih dahulu untuk mengatur kuota per jurusan.</div>
                    @endif
                </div>
                <script>
