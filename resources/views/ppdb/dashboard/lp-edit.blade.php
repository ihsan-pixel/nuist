    ...
    <form action="{{ route('ppdb.lp.update', $madrasah->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-section">
            <div class="section-header">
                ...
                <p class="section-subtitle">Konfigurasi pengaturan PPDB untuk madrasah</p>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="d-flex align-items-center gap-3">
                    <select class="form-select @error('ppdb_status') is-invalid @enderror" id="ppdb_status" name="ppdb_status" style="max-width: 200px;">
                        <option value="tutup" {{ old('ppdb_status', $madrasah->ppdb_status ?? 'tutup') == 'tutup' ? 'selected' : '' }}>Tutup</option>
                        <option value="buka" {{ old('ppdb_status', $madrasah->ppdb_status ?? 'tutup') == 'buka' ? 'selected' : '' }}>Buka</option>
                    </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('ppdb_kuota_total') is-invalid @enderror"
                               id="ppdb_kuota_total" name="ppdb_kuota_total" value="{{ old('ppdb_kuota_total', $madrasah->ppdb_kuota_total ?? '') }}" min="1">
            ...
            <div class="form-group">
                ...
                <div id="ppdb-quota-jurusan-container" class="array-input-container">
                    @php $kuotaJurusan = old('ppdb_kuota_jurusan', $madrasah->ppdb_kuota_jurusan ?? [] ?? []); @endphp
            ...
            <div class="form-group">
                ...
                <textarea class="form-control @error('ppdb_biaya_pendaftaran') is-invalid @enderror"
                          ...
                          placeholder="Informasi biaya pendaftaran PPDB">{{ old('ppdb_biaya_pendaftaran', $madrasah->ppdb_biaya_pendaftaran ?? '') }}</textarea>
        ...
        <div class="form-section">
            <div class="section-header">
                <h3 class="section-title">
                    <i class="mdi mdi-account-multiple-outline me-2"></i>Opsi Pilihan Ke 2
                </h3>
                <p class="section-subtitle">Pilih sekolah alternatif dari kabupaten yang sama</p>
            </div>

            <div class="form-group">
                <label for="ppdb_opsi_pilihan_ke_2" class="form-label">Nama Sekolah</label>
                <select class="form-select @error('ppdb_opsi_pilihan_ke_2') is-invalid @enderror" id="ppdb_opsi_pilihan_ke_2" name="ppdb_opsi_pilihan_ke_2">
                    <option value="">Pilih Sekolah</option>
                    @php
                        $sekolahLain = \App\Models\Madrasah::where('kabupaten', $madrasah->kabupaten)
                            ->where('id', '!=', $madrasah->id)
                            ->orderBy('name')
                            ->get();
                    @endphp
                    @foreach($sekolahLain as $sekolah)
                        <option value="{{ $sekolah->id }}" {{ old('ppdb_opsi_pilihan_ke_2') == $sekolah->id ? 'selected' : '' }}>
                            {{ $sekolah->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label class="form-label">Jurusan Sekolah Pilihan</label>
                <div id="ppdb-jurusan-pilihan-container" class="array-input-container">
                    <div class="array-input-item">
                        <input type="text" class="form-control" name="ppdb_jurusan_pilihan[]" placeholder="Jurusan dari sekolah pilihan">
                        <button type="button" class="btn btn-remove-array remove-array-item">
                            <i class="mdi mdi-minus"></i>
                        </button>
                    </div>
                </div>
                <button type="button" class="btn btn-add-array add-array-item text-white" data-target="ppdb-jurusan-pilihan-container">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('ppdb_nomor_whatsapp_siswa') is-invalid @enderror"
                               ...
                               value="{{ old('ppdb_nomor_whatsapp_siswa', $madrasah->ppdb_nomor_whatsapp_siswa) }}"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('ppdb_nomor_whatsapp_wali') is-invalid @enderror"
                               ...
                               value="{{ old('ppdb_nomor_whatsapp_wali', $madrasah->ppdb_nomor_whatsapp_wali) }}"
                               placeholder="081234567890">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control @error('ppdb_email_siswa') is-invalid @enderror"
                               ...
                               value="{{ old('ppdb_email_siswa', $madrasah->ppdb_email_siswa) }}"
