    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="verifikasiModalLabel">Verifikasi Data Pendaftar - {{ $pendaftar->nama_lengkap }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="verifikasiForm" method="POST" action="{{ route('ppdb.pendaftar.update', $pendaftar->id) }}">
                    @csrf
                    @method('PUT')

                    <div class="alert alert-info">
                        <i class="mdi mdi-information-outline me-2"></i>
                        Lengkapi atau perbaiki data pendaftar di bawah ini. Pastikan semua informasi sudah benar sebelum menyimpan.
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nik" value="{{ $pendaftar->nik }}" maxlength="16">
                            </div>
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="agama">
                                    ...
                                    <option value="Kristen" {{ $pendaftar->agama == 'Kristen' ? 'selected' : '' }}>Kristen</option>
                        ...
                        <!-- Data Alamat -->
                        <div class="col-md-6">
                            <h6 class="fw-bold mb-3">Data Alamat</h6>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="kabupaten" value="{{ $pendaftar->kabupaten }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Kecamatan</label>
                                <input type="text" class="form-control" name="kecamatan" value="{{ $pendaftar->kecamatan }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Desa/Kelurahan</label>
                                <input type="text" class="form-control" name="desa" value="{{ $pendaftar->desa }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Alamat Lengkap</label>
                                <textarea class="form-control" name="alamat_lengkap" rows="2">{{ $pendaftar->alamat_lengkap }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_ayah" value="{{ $pendaftar->nama_ayah }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Pekerjaan Ayah</label>
                                <input type="text" class="form-control" name="pekerjaan_ayah" value="{{ $pendaftar->pekerjaan_ayah }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">No. HP Ayah</label>
                                <input type="text" class="form-control" name="nomor_hp_ayah" value="{{ $pendaftar->nomor_hp_ayah }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_ibu" value="{{ $pendaftar->nama_ibu }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Pekerjaan Ibu</label>
                                <input type="text" class="form-control" name="pekerjaan_ibu" value="{{ $pendaftar->pekerjaan_ibu }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">No. HP Ibu</label>
                                <input type="text" class="form-control" name="nomor_hp_ibu" value="{{ $pendaftar->nomor_hp_ibu }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="tahun_lulus" value="{{ $pendaftar->tahun_lulus }}" min="2000" max="{{ date('Y') + 1 }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">NPSN Sekolah Asal</label>
                                <input type="text" class="form-control" name="npsn_sekolah_asal" value="{{ $pendaftar->npsn_sekolah_asal }}" maxlength="20">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Rata-rata Nilai Raport</label>
                                <input type="number" class="form-control" name="rata_rata_nilai_raport" value="{{ $pendaftar->rata_rata_nilai_raport }}" step="0.01" min="0" max="100">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nomor_ijazah" value="{{ $pendaftar->nomor_ijazah }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Nomor SKHUN</label>
                                <input type="text" class="form-control" name="nomor_skhun" value="{{ $pendaftar->nomor_skhun }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Rencana Setelah Lulus</label>
                                <select class="form-select" name="rencana_lulus">
                                    <option value="">Pilih Rencana</option>
                                    <option value="kuliah" {{ $pendaftar->rencana_lulus == 'kuliah' ? 'selected' : '' }}>Kuliah</option>
                                    <option value="kerja" {{ $pendaftar->rencana_lulus == 'kerja' ? 'selected' : '' }}>Bekerja</option>
                                </select>
                            </div>
                        </div>
                    </div>
