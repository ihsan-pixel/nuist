        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="verifikasiModalLabel">
                    <i class="mdi mdi-account-edit me-2"></i>Verifikasi Data Pendaftar
                </h5>
            ...
            <form id="verifikasiForm" method="POST" action="{{ route('ppdb.pendaftar.update', $pendaftar->id) }}">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h6 class="text-primary mb-3">
                                <i class="mdi mdi-map-marker me-1"></i>Data Alamat
                            </h6>
                            <div class="mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h6 class="text-primary mb-3">
                                <i class="mdi mdi-account-group me-1"></i>Data Orang Tua (lanjutan)
                            </h6>
                            <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h6 class="text-primary mb-3">
                                <i class="mdi mdi-school me-1"></i>Data Akademik
                            </h6>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="npsn_sekolah_asal" value="{{ $pendaftar->npsn_sekolah_asal }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Tahun Lulus</label>
                                <input type="number" class="form-control" name="tahun_lulus" value="{{ $pendaftar->tahun_lulus }}" min="2000" max="2030">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <h6 class="text-primary mb-3">
                                <i class="mdi mdi-clipboard-check me-1"></i>Data Tambahan
                            </h6>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="jurusan_pilihan" value="{{ $pendaftar->jurusan_pilihan }}">
                            </div>
                            <div class="mb-3">
