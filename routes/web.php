...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/presensi-admin/madrasah/{madrasahId}/export-persentase-pdf', [PresensiAdminController::class, 'exportMadrasahSummaryPdf'])->name('presensi_admin.export_summary_pdf');
