...
class SimfoniController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            // G. PROYEKSI KE DEPAN
            'proyeksi_1' => 'nullable|in:0,1',
            'proyeksi_2' => 'nullable|in:0,1',
            'proyeksi_3' => 'nullable|in:0,1',
            'proyeksi_4' => 'nullable|in:0,1',
            'proyeksi_5' => 'nullable|in:0,1',
            'proyeksi_6' => 'nullable|in:0,1',
            'proyeksi_7' => 'nullable|in:0,1',
            'proyeksi_8' => 'nullable|in:0,1',
            'proyeksi_9' => 'nullable|in:0,1',
            'proyeksi_10' => 'nullable|in:0,1',
            'proyeksi_11' => 'nullable|in:0,1',
            'proyeksi_12' => 'nullable|in:0,1',
            'proyeksi_13' => 'nullable|in:0,1',
            'proyeksi_14' => 'nullable|in:0,1',
            'proyeksi_15' => 'nullable|in:0,1',
            'proyeksi_16' => 'nullable|in:0,1',
            'proyeksi_17' => 'nullable|in:0,1',
            'proyeksi_18' => 'nullable|in:0,1',
            'proyeksi_19' => 'nullable|in:0,1',
            'skor_1' => 'nullable|integer|min:0|max:1',
            'skor_2' => 'nullable|integer|min:0|max:1',
            'skor_3' => 'nullable|integer|min:0|max:1',
            'skor_4' => 'nullable|integer|min:0|max:1',
            'skor_5' => 'nullable|integer|min:0|max:1',
            'skor_6' => 'nullable|integer|min:0|max:1',
            'skor_7' => 'nullable|integer|min:0|max:1',
            'skor_8' => 'nullable|integer|min:0|max:1',
            'skor_9' => 'nullable|integer|min:0|max:1',
            'skor_10' => 'nullable|integer|min:0|max:1',
            'skor_11' => 'nullable|integer|min:0|max:1',
            'skor_12' => 'nullable|integer|min:0|max:1',
            'skor_13' => 'nullable|integer|min:0|max:1',
            'skor_14' => 'nullable|integer|min:0|max:1',
            'skor_15' => 'nullable|integer|min:0|max:1',
            'skor_16' => 'nullable|integer|min:0|max:1',
            'skor_17' => 'nullable|integer|min:0|max:1',
            'skor_18' => 'nullable|integer|min:0|max:1',
            'skor_19' => 'nullable|integer|min:0|max:1',
            'skor_proyeksi' => 'nullable|integer|min:0|max:20',
            'kategori_proyeksi' => 'nullable|string|max:100',
        ], [
