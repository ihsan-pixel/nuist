...
class SimfoniController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = Validator::make($parsedData, [
            ...
            // G. PROYEKSI KE DEPAN
            'akan_kuliah_s2' => 'required|in:iya,tidak',
            'akan_mendaftar_pns' => 'required|in:iya,tidak',
            'akan_mendaftar_pppk' => 'required|in:iya,tidak',
            'akan_mengikuti_ppg' => 'required|in:iya,tidak',
            'akan_menulis_buku_modul_riset' => 'required|in:iya,tidak',
            'akan_mengikuti_seleksi_diklat_cakep' => 'required|in:iya,tidak',
            'akan_membimbing_riset_prestasi_siswa' => 'required|in:iya,tidak',
            'akan_masuk_tim_unggulan_sekolah_madrasah' => 'required|in:iya,tidak',
            'akan_kompetisi_pimpinan_level_ii' => 'required|in:iya,tidak',
            'akan_aktif_mengikuti_pelatihan' => 'required|in:iya,tidak',
            'akan_aktif_mgmp_mkk' => 'required|in:iya,tidak',
            'akan_mengikuti_pendidikan_kader_nu' => 'required|in:iya,tidak',
            'akan_aktif_membantu_kegiatan_lembaga' => 'required|in:iya,tidak',
            'akan_aktif_mengikuti_kegiatan_nu' => 'required|in:iya,tidak',
            'akan_aktif_ikut_zis_kegiatan_sosial' => 'required|in:iya,tidak',
            'akan_mengembangkan_unit_usaha_satpen' => 'required|in:iya,tidak',
            'akan_bekerja_disiplin_produktif' => 'required|in:iya,tidak',
            'akan_loyal_nu_aktif_masyarakat' => 'required|in:iya,tidak',
            'akan_bersedia_dipindah_satpen_lain' => 'required|in:iya,tidak',
