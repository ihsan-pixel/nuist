...
class SimfoniController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            // G. PROYEKSI KE DEPAN
            'akan_kuliah_s2' => 'nullable|in:iya,sudah,tidak',
            'akan_mendaftar_pns' => 'nullable|in:iya,sudah,tidak',
            'akan_mendaftar_pppk' => 'nullable|in:iya,sudah,tidak',
            'akan_mengikuti_ppg' => 'nullable|in:iya,sudah,tidak',
            'akan_menulis_buku_modul_riset' => 'nullable|in:iya,sudah,tidak',
            'akan_mengikuti_seleksi_diklat_cakep' => 'nullable|in:iya,sudah,tidak',
            'akan_membimbing_riset_prestasi_siswa' => 'nullable|in:iya,sudah,tidak',
            'akan_masuk_tim_unggulan_sekolah_madrasah' => 'nullable|in:iya,sudah,tidak',
            'akan_kompetisi_pimpinan_level_ii' => 'nullable|in:iya,sudah,tidak',
            'akan_aktif_mengikuti_pelatihan' => 'nullable|in:iya,sudah,tidak',
            'akan_aktif_mgmp_mkk' => 'nullable|in:iya,sudah,tidak',
            'akan_mengikuti_pendidikan_kader_nu' => 'nullable|in:iya,sudah,tidak',
            'akan_aktif_membantu_kegiatan_lembaga' => 'nullable|in:iya,sudah,tidak',
            'akan_aktif_mengikuti_kegiatan_nu' => 'nullable|in:iya,sudah,tidak',
            'akan_aktif_ikut_zis_kegiatan_sosial' => 'nullable|in:iya,sudah,tidak',
            'akan_mengembangkan_unit_usaha_satpen' => 'nullable|in:iya,sudah,tidak',
            'akan_bekerja_disiplin_produktif' => 'nullable|in:iya,sudah,tidak',
            'akan_loyal_nu_aktif_masyarakat' => 'nullable|in:iya,sudah,tidak',
            'bersedia_dipindah_satpen_lain' => 'nullable|in:iya,sudah,tidak',
        ], [
