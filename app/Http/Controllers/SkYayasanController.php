...
class SkYayasanController extends Controller
{
    ...
    private function normalizeStructuredTemplateStyles(string $body, array $templateContext = []): string
    {
        ...
        foreach ([
            ...
            '.sk-reference-row .sk-content-cell, .sk-reference-row .sk-menimbang-content, .sk-reference-row .sk-menimbang-item { text-align: left; text-align-last: left; text-justify: auto; }',
