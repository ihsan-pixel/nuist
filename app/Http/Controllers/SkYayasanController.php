...
class SkYayasanController extends Controller
{
    ...
    private function normalizeStructuredTemplateStyles(string $body, array $templateContext = []): string
    {
        ...
        foreach ([
            ...
            '.sk-org-title-line { display: block; line-height: 0.25; margin: 0; }',
            ...
            '.sk-decision-row .sk-content-cell, .sk-decision-row .sk-kedua-content, .sk-decision-row .sk-ketiga-content { padding-top: 0.8mm; text-align: justify; text-align-last: auto; text-justify: inter-word; }',
