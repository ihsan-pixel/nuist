...
<?php $__env->startSection('subtitle', 'Pengajuan Izin Cuti'); ?>
...
<div class="container py-3" style="max-width: 420px; margin: auto;">
    ...
    <form id="form-izin-cuti" action="<?php echo e(route('mobile.izin.store')); ?>" method="POST" enctype="multipart/form-data" class="izin-form">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/mobile/izin-cuti.blade.php ENDPATH**/ ?>