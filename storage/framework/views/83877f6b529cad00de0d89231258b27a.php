...
<div class="container">
    <div class="row">
        <div class="col-lg-9">
            <h2 class="mb-3">Hasil Assessment (Admin)</h2>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('talenta.rekap.detail', $s->id)); ?>" class="btn btn-sm btn-info">Detail</a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/talenta/results/index.blade.php ENDPATH**/ ?>