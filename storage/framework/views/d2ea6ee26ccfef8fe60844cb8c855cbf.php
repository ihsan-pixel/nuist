...
<?php $__env->startComponent('components.breadcrumb'); ?>
    ...
    <?php $__env->slot('title'); ?> Pengaturan UPPM <?php $__env->endSlot(); ?>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h5 class="mb-0"><?php echo e($settings->count()); ?></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h5 class="mb-0"><?php echo e($settings->where('aktif', true)->count()); ?></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h5 class="mb-0"><?php echo e($settings->where('aktif', false)->count()); ?></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h5 class="mb-0"><?php echo e($settings->max('tahun_anggaran') ?: '-'); ?></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h5 class="mb-0"><?php echo e($settings->where('skema_pembayaran', 'lunas')->count()); ?></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h5 class="mb-0"><?php echo e($settings->where('skema_pembayaran', 'cicilan')->count()); ?></h5>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->count() > 0): ?>
                    <div class="row g-4">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="setting-card <?php echo e($setting->aktif ? 'active' : 'inactive'); ?>">
                                <div class="card-icon <?php echo e($setting->aktif ? 'active' : 'inactive'); ?>">
                                    <i class="bx bx-cog"></i>
                                </div>

                                <div class="card-header">
                                    <h3 class="card-title">
                                        <?php echo e($setting->tahun_anggaran); ?>
                                ...
                                <div class="card-description">
                                    Pengaturan pembayaran iuran UPPM untuk tahun <?php echo e($setting->tahun_anggaran); ?>

                                </div>

                                <div class="card-badges mb-3">
                                    <span class="badge badge-modern <?php echo e($setting->aktif ? 'bg-success' : 'bg-secondary'); ?>">
                                        <?php echo e($setting->aktif ? 'Aktif' : 'Tidak Aktif'); ?>

                                    </span>
                                    <span class="badge badge-modern bg-info">
                                        <?php echo e(ucfirst($setting->skema_pembayaran)); ?>
                                ...
                                <div class="card-details">
                                    <small>
                                        ...
                                        <strong>Jatuh Tempo:</strong> <?php echo e($setting->jatuh_tempo ?: 'Tidak ditentukan'); ?>
                                ...
                                <div class="nominal-info">
                                    <div class="nominal-item">
                                        ...
                                        <span class="nominal-value">Rp <?php echo e(number_format($setting->nominal_siswa)); ?></span>
                                    </div>
                                    <div class="nominal-item">
                                        <span class="nominal-label">PNS Sertifikasi</span>
                                        <span class="nominal-value">Rp <?php echo e(number_format($setting->nominal_pns_sertifikasi)); ?></span>
                                    </div>
                                    <div class="nominal-item">
                                ...
                                <div class="mt-3 d-flex justify-content-end gap-2">
                                    <button type="button" class="btn btn-outline-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editSettingModal<?php echo e($setting->id); ?>">
                                        <i class="bx bx-edit me-1"></i> Edit
                                    </button>
                                    <form method="POST" action="<?php echo e(route('uppm.pengaturan.destroy', $setting->id)); ?>" class="d-inline">
                                        <?php echo csrf_field(); ?>
    ...
    <!-- Edit Modals -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_0 = true; $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
        <div class="modal fade" id="editSettingModal<?php echo e($setting->id); ?>" tabindex="-1" aria-labelledby="editSettingModalLabel<?php echo e($setting->id); ?>" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editSettingModalLabel<?php echo e($setting->id); ?>"><i class="bx bx-edit me-2"></i>Edit Pengaturan UPPM <?php echo e($setting->tahun_anggaran); ?></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form id="editSettingForm<?php echo e($setting->id); ?>" method="POST" action="<?php echo e(route('uppm.pengaturan.update', $setting->id)); ?>" enctype="multipart/form-data" data-original-year="<?php echo e($setting->tahun_anggaran); ?>">
                        <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="addSettingModal" tabindex="-1" aria-labelledby="addSettingModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <form id="addSettingForm" method="POST" action="<?php echo e(route('uppm.pengaturan.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
...
$(document).ready(function() {
    ...
    <?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        existingYears.push(<?php echo e($setting->tahun_anggaran); ?>);
