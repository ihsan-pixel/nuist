<div class="row g-3">
    ...
    <div class="col-md-4">
        ...
        <select
            ...
            required
            <?php echo e(in_array($userRole, ['admin', 'admin_spp']) ? 'disabled' : ''); ?>
        ...
        >
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $madrasahOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $madrasah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <option
                    ...
                    <?php echo e((string) old('madrasah_id', $siswa->madrasah_id ?? $selectedMadrasahId) === (string) $madrasah->id ? 'selected' : ''); ?>
    ...
    <div class="col-md-4">
        ...
        <input type="text" name="scod" class="form-control js-student-scod" value="<?php echo e(old('scod', $siswa->scod ?? '')); ?>" readonly>
    </div>
    <div class="col-md-4">
        <label class="form-label">ASAL SEKOLAH/MADRASAH</label>
        <input type="text" name="asal_sekolah_madrasah" class="form-control js-student-school-name" value="<?php echo e(old('asal_sekolah_madrasah', $siswa->nama_madrasah ?? '')); ?>" readonly>
    </div>
    ...
    <div class="col-md-3">
        ...
        <input type="text" name="nis" class="form-control" value="<?php echo e(old('nis', $siswa->nis ?? '')); ?>">
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-6">
        ...
        <input type="text" name="nama_lengkap" class="form-control" value="<?php echo e(old('nama_lengkap', $siswa->nama_lengkap ?? '')); ?>">
    </div>
    <div class="col-md-2">
        <label class="form-label">JENIS_KELAMIN</label>
        <select name="jenis_kelamin" class="form-select">
            <option value="">Pilih</option>
            <option value="L" <?php echo e(old('jenis_kelamin', $siswa->jenis_kelamin ?? '') === 'L' ? 'selected' : ''); ?>>L</option>
            <option value="P" <?php echo e(old('jenis_kelamin', $siswa->jenis_kelamin ?? '') === 'P' ? 'selected' : ''); ?>>P</option>
        </select>
    </div>
    <div class="col-md-2">
    ...
    <div class="col-md-3">
        ...
        <input type="text" name="kelas" class="form-control" value="<?php echo e(old('kelas', $siswa->kelas ?? '')); ?>">
    </div>
    <div class="col-md-3">
...
<?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/data-sekolah/partials/siswa-form.blade.php ENDPATH**/ ?>