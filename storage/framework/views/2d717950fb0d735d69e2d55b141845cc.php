        ...
        <div class="card">
            <div class="card-body">
                <div class="text-center">
                    <img src="<?php echo e(asset('build/images/companies/adobe-photoshop.svg')); ?>" alt="" height="50" class="mx-auto d-block">
    ...
    <div class="col-xl-9">
        <div class="card">
            <div class="card-body border-bottom">
                <div class="d-flex">
                    <img src="<?php echo e(asset('build/images/companies/wechat.svg')); ?>" alt="" height="50">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/job-details.blade.php ENDPATH**/ ?>