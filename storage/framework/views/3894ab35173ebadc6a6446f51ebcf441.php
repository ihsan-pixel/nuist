...
<?php $__env->startComponent('components.breadcrumb'); ?>
    <?php $__env->slot('li_1'); ?> Teaching Progress <?php $__env->endSlot(); ?>
    <?php $__env->slot('title'); ?> Data Presensi Mengajar <?php $__env->endSlot(); ?>
<?php echo $__env->renderComponent(); ?>

<?php if(in_array(Auth::user()->role, ['super_admin'])): ?>
...
<div class="row">
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="stat-card total-madrasah">
            <div class="stat-number"><?php echo e($madrasahs->flatten()->count()); ?></div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="stat-card schedule-input">
            <div class="stat-number"><?php echo e(round($overallScheduleInput)); ?>%</div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="stat-card attendance">
            <div class="stat-number"><?php echo e(round($overallAttendance)); ?>%</div>
    ...
    <div class="col-lg-3 col-md-6 mb-3">
        <div class="stat-card pending">
            <div class="stat-number"><?php echo e(round($overallPending)); ?>%</div>
...
<div class="kabupaten-group">
    <div class="kabupaten-header">
        <i class="mdi mdi-map-marker-radius"></i> Kabupaten: <?php echo e($kabupaten); ?>

    </div>
    <div class="kabupaten-table p-3">
        <table id="datatable-<?php echo e(\Illuminate\Support\Str::slug($kabupaten)); ?>" class="table table-bordered dt-responsive nowrap w-100">
<thead>
    <tr>
        <th>SCOD</th>
        <th>Nama Sekolah</th>
...
<tbody>
    ...
    <tr>
        ...
        <td class="school-name"><?php echo e($madrasah->name); ?></td>
        ...
        <td style="text-align: center; font-weight: bold;">
            ...
            <td style="text-align: center;">
                <button
                    ...
                    data-madrasah-id="<?php echo e($madrasah->id); ?>"
                    data-schedule-input="<?php echo e($madrasah->schedule_input_percentage); ?>"
                    data-attendance="<?php echo e($madrasah->attendance_percentage); ?>"
                    data-pending="<?php echo e($madrasah->attendance_pending_percentage); ?>"
                >
...
<script>
    $(document).ready(function() {
        <?php $__currentLoopData = $kabupatenOrder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kabupaten): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        $('#datatable-<?php echo e(\Illuminate\Support\Str::slug($kabupaten)); ?>').DataTable({
            dom: 'Bfrtip',
            buttons: [
        ...
        $('#detailModal').on('hidden.bs.modal', function () {
            window.location.href = "<?php echo e(route('admin.teaching_progress')); ?>";
        });
