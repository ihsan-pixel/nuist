...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).ready(function () {
            const userRole = <?php echo json_encode($userRole, 15, 512) ?>;
            const isSuperAdmin = <?php echo json_encode($userRole === 'super_admin', 15, 512) ?>;
            ...
            const fillEditModal = (data) => {
                const updateUrl = <?php echo json_encode(route('tenaga-pendidik.update', '__ID__'), 512) ?>.replace('__ID__', data.id);
            ...
            let table = $("#datatable-buttons").DataTable({
                ...
                deferRender: true,
                pageLength: 25,
                ajax: "<?php echo e(route('tenaga-pendidik.data')); ?>",
                order: [[7, 'asc'], [1, 'asc']],
                columns: [
            ...
            $(document).on('click', '.delete-tenaga-pendidik-btn', function () {
                ...
                const deleteUrl = <?php echo json_encode(route('tenaga-pendidik.destroy', '__ID__'), 512) ?>.replace('__ID__', teacherId);
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/masterdata/tenaga-pendidik/index.blade.php ENDPATH**/ ?>