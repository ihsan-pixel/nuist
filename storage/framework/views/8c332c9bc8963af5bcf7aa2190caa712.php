<?php $__env->startSection('title'); ?>Template SK Yayasan <?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
<?php $__env->startComponent('components.breadcrumb'); ?>
    <?php $__env->slot('li_1'); ?> SK Yayasan <?php $__env->endSlot(); ?>
    <?php $__env->slot('title'); ?> Template SK Yayasan <?php $__env->endSlot(); ?>
...
<div class="sky-page">
    <div class="sky-hero-strip mb-4">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
            ...
            <div class="d-flex flex-wrap gap-2">
                <span class="sky-chip bg-white bg-opacity-10 border-0 text-white"><?php echo e($templates->count()); ?> template</span>
                <span class="sky-chip bg-white bg-opacity-10 border-0 text-white"><?php echo e($templates->where('is_active', true)->count()); ?> aktif</span>
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-3">
                ...
                <span class="sky-chip"><?php echo e($templates->count()); ?> data</span>
            </div>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($template->description): ?>
                                            <small class="text-muted"><?php echo e(\Illuminate\Support\Str::limit($template->description, 70)); ?></small>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </td>
                                    <td><?php echo e($template->category ?: '-'); ?></td>
                                    <td><?php echo e($template->document_title); ?></td>
                                    <td>
                                        <span class="badge bg-<?php echo e($template->is_active ? 'success' : 'secondary'); ?>-subtle text-<?php echo e($template->is_active ? 'success' : 'secondary'); ?>">
                                            <?php echo e($template->is_active ? 'Aktif' : 'Nonaktif'); ?>

                                        </span>
                                    </td>
                                    <td><?php echo e(optional($template->updated_at)->format('d M Y H:i')); ?></td>
                                    <td class="text-end">
                                        <div class="d-inline-flex flex-wrap justify-content-end gap-2">
                                            ...
                                            <button
                                                ...
                                                data-bs-target="#templateModal<?php echo e($template->id); ?>"
                                            >
                                                Edit
                                            </button>
                                            <form action="<?php echo e(route('sk-yayasan.template.duplicate', $template)); ?>" method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" class="btn btn-sm btn-outline-secondary">Duplicate</button>
                                            </form>
                                            <form action="<?php echo e(route('sk-yayasan.template.destroy', $template)); ?>" method="POST" class="d-inline" data-sk-swal-confirm data-sk-swal-title="Hapus template?" data-sk-swal-text="Template yang belum dipakai akan dihapus permanen." data-sk-swal-confirm-text="Ya, hapus">
                                                <?php echo csrf_field(); ?>
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable sk-template-modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('sk-yayasan.template.store')); ?>" method="POST" class="sk-template-editor sk-modal-form" data-preview-label="Template baru" data-sk-legacy-notice="off">
                        <?php echo csrf_field(); ?>
                        <div class="sk-modal-section">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="category" class="form-control" value="<?php echo e(old('category', 'guru')); ?>" placeholder="Contoh: guru, pegawai, umum">
                            </div>
                            <div class="row">
                                <div class="col-md-8 mb-3">
                                    <label class="form-label">Judul Dokumen</label>
                                    <input type="text" name="document_title" class="form-control" value="<?php echo e(old('document_title', "SURAT KEPUTUSAN KETUA LP MA'ARIF NU PWNU DIY")); ?>" data-sk-preview-title required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Font Judul</label>
                                    <input type="number" step="0.1" min="8" class="form-control" value="<?php echo e($defaultTemplateConfig['documentTitleFontSize']); ?>" data-sk-config-key="documentTitleFontSize">
                                </div>
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="sk-modal-section">
                            ...
                            <textarea name="body" rows="24" class="form-control sk-editor-textarea sk-editor-raw" data-sk-preview-body required><?php echo e(old('body', $defaultSkBody)); ?></textarea>
                        ...
                        <details class="sk-placeholder-help">
                            ...
                            <div class="sk-placeholder-help-body">
                                <div class="sk-placeholder-help-grid">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $officialPlaceholderGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupTitle => $groupPlaceholders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                        <div class="sk-placeholder-help-group">
                                            <div class="sk-placeholder-help-group-title"><?php echo e($groupTitle); ?></div>
                                            <div class="sk-placeholder-help-list">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $groupPlaceholders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $placeholder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                                    <span class="sk-placeholder-token"><?php echo e($placeholder); ?></span>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                            </div>
                                        </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        ...
                        <div class="sk-modal-actions">
                            ...
                            <div class="sk-modal-actions-group">
                                <button
                                    ...
                                    formaction="<?php echo e(route('sk-yayasan.template.preview-pdf')); ?>"
                                    formtarget="_blank"
                                >
                                    View PDF
                                </button>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
        <div class="modal fade" id="templateModal<?php echo e($template->id); ?>" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-scrollable sk-template-modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <div>
                            <h5 class="modal-title mb-1"><?php echo e($template->name); ?></h5>
                            <small class="text-muted"><?php echo e($template->document_title); ?></small>
                        </div>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="<?php echo e(route('sk-yayasan.template.update', $template)); ?>" method="POST" class="sk-template-editor sk-modal-form" data-preview-label="<?php echo e($template->name); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="sk-modal-section">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label">Kategori</label>
                                        <input type="text" name="category" value="<?php echo e($template->category); ?>" class="form-control">
                                    </div>
                                    <div class="col-md-5 mb-3">
                                        <label class="form-label">Judul Dokumen</label>
                                        <input type="text" name="document_title" value="<?php echo e($template->document_title); ?>" class="form-control" data-sk-preview-title required>
                                    </div>
                                ...
                                <div class="mb-0">
                                    <label class="form-label">Deskripsi</label>
                                    <textarea name="description" rows="2" class="form-control"><?php echo e($template->description); ?></textarea>
                                </div>
                            </div>
                            <div class="sk-modal-section">
                                <div class="sk-modal-section-title">
                                ...
                                <div data-sk-structured-fields></div>
                                <textarea name="body" rows="14" class="form-control sk-editor-textarea sk-editor-raw" data-sk-preview-body required><?php echo e($template->body); ?></textarea>
                            ...
                            <div class="sk-modal-actions">
                                <div class="form-check form-switch mb-0">
                                    <input class="form-check-input" type="checkbox" name="is_active" value="1" <?php if($template->is_active): echo 'checked'; endif; ?>>
                                    <label class="form-check-label">Aktifkan template</label>
                                </div>
                                <div class="sk-modal-actions-group">
                                    <button
                    ...
                    <div class="modal-footer justify-content-between">
                        <form action="<?php echo e(route('sk-yayasan.template.destroy', $template)); ?>" method="POST" data-sk-swal-confirm data-sk-swal-title="Hapus template?" data-sk-swal-text="Template yang belum dipakai akan dihapus permanen." data-sk-swal-confirm-text="Ya, hapus">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/sk-yayasan/template-index.blade.php ENDPATH**/ ?>