    ...
    <div class="mobile-auth-page">
        <div class="register-card">
            ...
            <div class="card-body">
                ...
                <form class="register-form" id="mobileRegisterForm" method="POST" action="<?php echo e(route('register')); ?>" data-loader-ignore>
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="input-group">
                        ...
                        <div class="role-grid">
                            <label class="role-option">
                                <input type="radio" name="role" value="pengurus" <?php echo e(old('role') == 'pengurus' ? 'checked' : ''); ?> required>
                                <span class="role-label">Pengurus</span>
                            </label>
                            <label class="role-option">
                                <input type="radio" name="role" value="tenaga_pendidik" <?php echo e(old('role') == 'tenaga_pendidik' ? 'checked' : ''); ?> required>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <a class="secondary-btn" href="<?php echo e(route('mobile.login')); ?>">Login</a>
                </form>

                <div class="panel-footer">
                    Sudah punya akun? <a href="<?php echo e(route('mobile.login')); ?>">Masuk di sini</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/mobile/register.blade.php ENDPATH**/ ?>