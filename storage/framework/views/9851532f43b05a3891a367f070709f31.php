<?php $__env->startSection('title', 'Menu Layanan'); ?>
<?php $__env->startSection('subtitle', 'Semua fitur dalam satu tempat'); ?>
...
<div class="services-page">
    ...
    <div class="service-group">
        ...
        <div class="service-group-grid">
            <a href="<?php echo e(route('mobile.presensi')); ?>" class="service-card">
                <div class="service-icon"><i class="bx bx-qr-scan"></i></div>
                <div class="service-label">Presensi</div>
            </a>
            <a href="<?php echo e(route('mobile.teaching-attendances')); ?>" class="service-card">
                <div class="service-icon"><i class="bx bx-chalkboard"></i></div>
                <div class="service-label">Presensi Mengajar</div>
            </a>
            <a href="<?php echo e(route('mobile.jadwal')); ?>" class="service-card">
    ...
    <div class="service-group">
        ...
        <div class="service-group-grid">
            <a href="<?php echo e(route('mobile.profile')); ?>" class="service-card">
                <div class="service-icon"><i class="bx bx-user"></i></div>
                <div class="service-label">Profil</div>
            </a>
            <a href="<?php echo e(route('mobile.laporan')); ?>" class="service-card">
                <div class="service-icon"><i class="bx bx-file"></i></div>
                <div class="service-label">Laporan</div>
            </a>
            <a href="<?php echo e(route('mobile.ubah-akun')); ?>" class="service-card">
    ...
    <div class="service-group">
        ...
        <div class="service-group-grid">
            <a href="<?php echo e(route('mobile.kelola-izin')); ?>" class="service-card">
                <div class="service-icon"><i class="bx bx-edit"></i></div>
                <div class="service-label">Kelola Izin</div>
            </a>
            <a href="<?php echo e(route('mobile.monitor-presensi')); ?>" class="service-card">
                <div class="service-icon"><i class="bx bx-calendar-check"></i></div>
                <div class="service-label">Data Presensi</div>
            </a>
            <a href="<?php echo e(route('mobile.monitor-jurnal-mengajar')); ?>" class="service-card">
                <div class="service-icon"><i class="bx bx-notepad"></i></div>
                <div class="service-label">Jurnal Mengajar</div>
            </a>
            <a href="<?php echo e(route('mobile.academic-calendar-approvals')); ?>" class="service-card">
...
<?php echo $__env->make('layouts.mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/mobile/menu-layanan.blade.php ENDPATH**/ ?>