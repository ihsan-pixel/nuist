...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isAllowed): ?>
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <div class="mb-3 d-flex justify-content-end gap-2 <?php if($userRole == 'admin'): ?> d-none <?php endif; ?>">
            ...
            <div class="table-responsive">
                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $madrasahs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $madrasah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="<?php echo e(route('madrasah.destroy', $madrasah->id)); ?>" method="POST" class="d-inline-block">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit" class="btn btn-sm btn-danger <?php if($userRole == 'admin'): ?> d-none <?php endif; ?>" onclick="return confirm('Yakin hapus madrasah ini?')">Delete</button>
                                    </form>
                                </td>
                            </tr>
    ...
    <div class="modal fade" id="modalEditMadrasah<?php echo e($madrasah->id); ?>" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form action="<?php echo e(route('madrasah.update', $madrasah->id)); ?>" method="POST" enctype="multipart/form-data" class="form-edit-madrasah">
                ...
                <input type="hidden" name="id" value="<?php echo e($madrasah->id); ?>">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label>Jam Presensi Masuk (start)</label>
                                        <input type="time" name="presensi_masuk_start" class="form-control" value="<?php echo e($madrasah->presensi_masuk_start ? \Carbon\Carbon::parse($madrasah->presensi_masuk_start)->format('H:i') : ''); ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Jam Presensi Masuk (end)</label>
                                        <input type="time" name="presensi_masuk_end" class="form-control" value="<?php echo e($madrasah->presensi_masuk_end ? \Carbon\Carbon::parse($madrasah->presensi_masuk_end)->format('H:i') : ''); ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Jam Presensi Pulang (start)</label>
                                        <input type="time" name="presensi_pulang_start" class="form-control" value="<?php echo e($madrasah->presensi_pulang_start ? \Carbon\Carbon::parse($madrasah->presensi_pulang_start)->format('H:i') : ''); ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Jam Presensi Pulang (end)</label>
                                        <input type="time" name="presensi_pulang_end" class="form-control" value="<?php echo e($madrasah->presensi_pulang_end ? \Carbon\Carbon::parse($madrasah->presensi_pulang_end)->format('H:i') : ''); ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Jam Pulang Khusus Jumat</label>
                                        <input type="time" name="presensi_pulang_jumat" class="form-control" value="<?php echo e($madrasah->presensi_pulang_jumat ? \Carbon\Carbon::parse($madrasah->presensi_pulang_jumat)->format('H:i') : ''); ?>">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label>Jam Pulang Khusus Sabtu</label>
                                        <input type="time" name="presensi_pulang_sabtu" class="form-control" value="<?php echo e($madrasah->presensi_pulang_sabtu ? \Carbon\Carbon::parse($madrasah->presensi_pulang_sabtu)->format('H:i') : ''); ?>">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label>Logo</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" name="polygon_koordinat" id="polygon_koordinat-edit-<?php echo e($madrasah->id); ?>" value="<?php echo e($madrasah->polygon_koordinat ?? '[]'); ?>">
                                    <div class="polygon-map-container" id="map-edit-<?php echo e($madrasah->id); ?>" style="height: 300px; width: 100%; border-radius: 8px; border: 2px solid #dee2e6; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1); background: #f8f9fa; position: relative;">
                                        <!-- Loading indicator -->
                                        <div id="loading-map-edit-<?php echo e($madrasah->id); ?>" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1000; color: #6c757d; text-align: center;">
                                            <i class="mdi mdi-loading mdi-spin" style="font-size: 2rem;"></i>
                                            <p class="mb-0 mt-2 small">Memuat peta...</p>
                                        </div>
                                    ...
                                    <div class="polygon-info mt-2">
                                        <div id="polygon-display-<?php echo e($madrasah->id); ?>">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($madrasah->polygon_koordinat): ?>
                                                ...
                                                ?>
                                                <strong>Jumlah titik:</strong> <?php echo e($pointCount); ?><br>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="enable_dual_polygon" id="enable_dual_polygon-edit-<?php echo e($madrasah->id); ?>" value="1" <?php echo e($madrasah->enable_dual_polygon ? 'checked' : ''); ?>>
                                        <label class="form-check-label" for="enable_dual_polygon-edit-<?php echo e($madrasah->id); ?>">
                                ...
                                <div class="mb-3" id="polygon2-container-edit-<?php echo e($madrasah->id); ?>" style="display: <?php echo e($madrasah->enable_dual_polygon ? 'block' : 'none'); ?>;">
                                    <label>Area Polygon Presensi Kedua</label>
                                    <input type="hidden" name="polygon_koordinat_2" id="polygon_koordinat_2-edit-<?php echo e($madrasah->id); ?>" value="<?php echo e($madrasah->polygon_koordinat_2 ?? '[]'); ?>">
                                    <div class="polygon-map-container" id="map2-edit-<?php echo e($madrasah->id); ?>" style="height: 300px; width: 100%; border-radius: 8px; border: 2px solid #dee2e6; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1); background: #f8f9fa; position: relative;">
                                        <!-- Loading indicator -->
                                        <div id="loading-map2-edit-<?php echo e($madrasah->id); ?>" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1000; color: #6c757d; text-align: center;">
                                            <i class="mdi mdi-loading mdi-spin" style="font-size: 2rem;"></i>
                                    ...
                                    <div class="polygon-info mt-2">
                                        <div id="polygon2-display-<?php echo e($madrasah->id); ?>">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($madrasah->polygon_koordinat_2): ?>
                                                ...
                                                ?>
                                                <strong>Jumlah titik:</strong> <?php echo e($pointCount2); ?><br>
                                                <strong>Format:</strong> GeoJSON (Longitude, Latitude)<br>
                                                <strong>Data JSON:</strong><br>
                                        ...
                                        <div class="polygon-checklist" id="polygon2-checklist-<?php echo e($madrasah->id); ?>">
                                            <div class="polygon-checklist-item <?php echo e($madrasah->enable_dual_polygon ? 'success' : 'warning'); ?>">
                                                <i class="bx bx-<?php echo e($madrasah->enable_dual_polygon ? 'check-circle' : 'info-circle'); ?>"></i>
                                                <span>Dual Polygon: <?php echo e($madrasah->enable_dual_polygon ? 'Aktif' : 'Tidak aktif'); ?></span>
                                            </div>
                                            <div class="polygon-checklist-item <?php echo e($madrasah->polygon_koordinat_2 ? 'success' : 'danger'); ?>">
                                                <i class="bx bx-<?php echo e($madrasah->polygon_koordinat_2 ? 'check-circle' : 'x-circle'); ?>"></i>
                                                <span>Poligon Kedua: <?php echo e($madrasah->polygon_koordinat_2 ? 'Tersedia' : 'Belum ada'); ?></span>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/masterdata/madrasah/index.blade.php ENDPATH**/ ?>