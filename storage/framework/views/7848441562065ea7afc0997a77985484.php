...
<head>
    <meta charset="UTF-8">
    <title><?php echo e($document->document_number ?: 'Preview SK Yayasan'); ?></title>
    <?php
...
<body>
    ...
    <div class="header">
        ...
        <div>Nomor: <?php echo e($document->document_number ?: 'Belum ditetapkan'); ?></div>
    </div>
...
<?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/pdf/sk-yayasan-template.blade.php ENDPATH**/ ?>