<?php $__env->startSection('title'); ?> Pengaturan Aplikasi <?php $__env->stopSection(); ?>
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="version-badge">
                        v<?php echo e($settings['app_version']); ?>
                ...
                <div class="row g-3">
                    <div class="col-6">
                        <div class="text-center">
                            ...
                            <strong class="d-block"><?php echo e($settings['memory_limit']); ?></strong>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="text-center">
                            ...
                            <strong class="d-block"><?php echo e($settings['max_upload_size']); ?></strong>
                        </div>
                    </div>
                </div>
...
<div class="row">
    <div class="col-12">
        <div class="card settings-card">
            ...
            <div class="card-body">
                <form id="settingsForm" method="POST" action="<?php echo e(route('app-settings.update')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="app_version" name="app_version"
                                       value="<?php echo e(old('app_version', $settings['app_version'])); ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="timezone" name="timezone">
                                    <option value="Asia/Jakarta" <?php echo e($settings['timezone'] == 'Asia/Jakarta' ? 'selected' : ''); ?>>Asia/Jakarta (WIB)</option>
                                    <option value="Asia/Makassar" <?php echo e($settings['timezone'] == 'Asia/Makassar' ? 'selected' : ''); ?>>Asia/Makassar (WITA)</option>
                                    <option value="Asia/Jayapura" <?php echo e($settings['timezone'] == 'Asia/Jayapura' ? 'selected' : ''); ?>>Asia/Jayapura (WIT)</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="locale" name="locale">
                                    <option value="id" <?php echo e($settings['locale'] == 'id' ? 'selected' : ''); ?>>Indonesia</option>
                                    <option value="en" <?php echo e($settings['locale'] == 'en' ? 'selected' : ''); ?>>English</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="debug_mode" name="debug_mode" value="1"
                                           <?php echo e($settings['debug_mode'] ? 'checked' : ''); ?>>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="cache_enabled" name="cache_enabled" value="1"
                                           <?php echo e($settings['cache_enabled'] ? 'checked' : ''); ?>>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="bni_va_enabled" name="bni_va_enabled" value="1"
                                           <?php echo e(old('bni_va_enabled', $settings['bni_va_enabled']) ? 'checked' : ''); ?>>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="bni_va_mock_mode" name="bni_va_mock_mode" value="1"
                                           <?php echo e(old('bni_va_mock_mode', $settings['bni_va_mock_mode']) ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="bni_va_api_url" name="bni_va_api_url"
                                       value="<?php echo e(old('bni_va_api_url', $settings['bni_va_api_url'])); ?>"
                                       placeholder="https://...">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="bni_va_merchant_id" name="bni_va_merchant_id"
                                       value="<?php echo e(old('bni_va_merchant_id', $settings['bni_va_merchant_id'])); ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="bni_va_client_id" name="bni_va_client_id"
                                       value="<?php echo e(old('bni_va_client_id', $settings['bni_va_client_id'])); ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="bni_va_client_secret" name="bni_va_client_secret"
                                       value="<?php echo e(old('bni_va_client_secret', $settings['bni_va_client_secret'])); ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="bni_va_prefix" name="bni_va_prefix"
                                       value="<?php echo e(old('bni_va_prefix', $settings['bni_va_prefix'])); ?>"
                                       placeholder="9888">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="bni_va_callback_token" name="bni_va_callback_token"
                                       value="<?php echo e(old('bni_va_callback_token', $settings['bni_va_callback_token'])); ?>">
                            </div>
                        </div>
                    </div>
...
function checkForUpdates() {
    ...
    fetch('<?php echo e(route("app-settings.check-updates")); ?>', {
        method: 'POST',
        headers: {
...
function turnOffDebug() {
    ...
    fetch('<?php echo e(route("app-settings.turn-off-debug")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
document.getElementById('updateVersionForm').addEventListener('submit', function(e) {
    ...
    fetch('<?php echo e(route("app-settings.update-version")); ?>', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        },
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/app-settings/index.blade.php ENDPATH**/ ?>