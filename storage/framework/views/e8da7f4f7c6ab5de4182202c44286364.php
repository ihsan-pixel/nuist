...
<div class="spp-login-shell">
    <div class="spp-login-grid">
        ...
        <section class="spp-login-card">
            ...
            <form method="POST" action="<?php echo e(route('login.operator-spp.submit')); ?>" class="spp-login-form">
                <?php echo csrf_field(); ?>
                <div class="form-block">
                    <label for="email">Email Operator SPP</label>
                    <input id="email" type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="Masukkan email operator" required autofocus>
                </div>
            ...
            <div class="action-links">
                <a href="<?php echo e(route('spp-operator.register')); ?>">Ajukan akun Operator SPP</a>
                <a href="<?php echo e(route('login')); ?>">Login umum Nuist</a>
            </div>
        </section>
    </div>
</div>
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/auth/login-operator-spp.blade.php ENDPATH**/ ?>