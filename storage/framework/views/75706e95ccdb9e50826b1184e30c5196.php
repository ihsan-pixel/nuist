                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo e($schedule->period ? $schedule->period->summary_label . ' | ' . $schedule->period->date_range_label : 'Periode belum ditentukan'); ?>" readonly>
                                <input type="hidden" name="teaching_schedule_period_id" value="<?php echo e($schedule->teaching_schedule_period_id); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="hidden" name="class_name" value="<?php echo e($schedule->class_name); ?>">
                                <textarea name="class_names_text" id="class_name" class="form-control" rows="3" required><?php echo e(old('class_names_text', implode(', ', $schedule->resolvedClassNames()))); ?></textarea>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/teaching-schedules/edit.blade.php ENDPATH**/ ?>