...
<div class="container py-3" style="max-width: 420px; margin: auto;">
    ...
    <?php elseif($hasUnclosedPresensiYesterday): ?>
    <div class="alert-custom warning">
        <div class="d-flex align-items-center">
            <div class="status-icon">
    ...
    <?php elseif($presensiHariIni && $presensiHariIni->count() > 0): ?>
        ...
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <div class="mb-2" style="border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 4px;">
                    <small class="text-white-50"><?php echo e($presensi->madrasah?->name ?? 'Madrasah'); ?></small>
                    <p class="mb-1">Masuk: <strong><?php echo e($presensi->waktu_masuk ? $presensi->waktu_masuk->format('H:i') : '-'); ?></strong></p>
    ...
    <div class="presensi-form">
        ...
        <h6 class="section-title mb-0"><?php echo e(($presensiHariIni && $presensiHariIni->count() > 0) ? 'Presensi Keluar' : 'Presensi Masuk'); ?></h6>
        </div>
    ...
    <!-- Location Status -->
        ...
        <button type="button" id="btn-presensi"
                class="presensi-btn"
                disabled
                <?php echo e((($presensiHariIni && $presensiHariIni->count() > 0) && $presensiHariIni->where('waktu_keluar', '!=', null)->count() == $presensiHariIni->count()) || $isHoliday ? 'disabled' : ''); ?>>
            <i class="bx bx-<?php echo e($isHoliday ? 'calendar-x' : 'check-circle'); ?> me-1"></i>
            <?php echo e($isHoliday ? 'Hari Libur - Presensi Ditutup' : 'Ambil Selfie'); ?>
    ...
    <div class="schedule-section">
        ...
        <div class="schedule-grid">
            <div class="schedule-item masuk">
                ...
                <p><?php echo e($timeRanges['masuk_start']); ?> - 07:00</p>
