...
<div class="container py-3" style="max-width: 420px; margin: auto;">
    ...
    <div class="status-card success">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <p class="mb-1">Masuk: <strong><?php echo e($presensiHariIni->waktu_masuk->format('H:i')); ?></strong></p>
                <?php if($presensiHariIni->waktu_keluar): ?>
                <p class="mb-0">Keluar: <strong><?php echo e($presensiHariIni->waktu_keluar->format('H:i')); ?></strong></p>
    ...
    <div class="presensi-form">
        <div class="d-flex align-items-center mb-2">
            ...
            <h6 class="section-title mb-0"><?php echo e($presensiHariIni ? 'Presensi Keluar' : 'Presensi Masuk'); ?></h6>
        </div>
    ...
    <div class="schedule-section">
        ...
        <div class="schedule-grid">
            <div class="schedule-item masuk">
                ...
                <p><?php echo e($timeRanges['masuk_start']); ?> - <?php echo e($timeRanges['masuk_end']); ?></p>
            </div>
