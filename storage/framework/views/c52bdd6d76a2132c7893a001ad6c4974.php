            ...
            <div class="table-container">
                ...
                <div style="padding:20px 24px;">
                    <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap:16px;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $countsByArea; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area => $counts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <div class="table-container" style="padding:14px;">
                                <div style="display:flex; align-items:center; justify-content:space-between; gap:12px;">
                                    <div>
                                        <h4 style="margin:0 0 6px 0; font-size:16px;"><?php echo e(ucwords(str_replace('-', ' ', $area))); ?></h4>
                                        <div style="display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
                                            <span class="badge bg-info">Onsite: <?php echo e($counts['onsite']); ?></span>
                                            <span class="badge bg-warning text-dark">Terstruktur: <?php echo e($counts['terstruktur']); ?></span>
                                            <span class="badge bg-secondary">Kelompok: <?php echo e($counts['kelompok']); ?></span>
                                        </div>
                                    </div>
                                    <div style="font-size:22px; font-weight:700; color:#00393a;">
                                        <?php echo e(array_sum($counts)); ?>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($onsite->isEmpty()): ?>
                            <tr>
                                <td colspan="8" class="no-data">Belum ada tugas Onsite yang disubmit untuk materi Anda</td>
                            </tr>
                        <?php else: ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $onsite; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tugasItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
                                    <td><?php echo e($index + 1); ?></td>
                                    <td><?php echo e($tugasItem->user->name ?? 'N/A'); ?></td>
                                    <td><?php echo e($tugasItem->user->madrasah->name ?? 'N/A'); ?></td>
                                    ...
                                    ?>
                                    <td>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentUserNilai): ?>
                                            <span class="badge bg-success"><?php echo e($currentUserNilai->nilai); ?></span>
                                        <?php else: ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::id() === 2472 && $averageNilai): ?>
                                                <span class="text-muted">Rata-rata: <?php echo e(number_format($averageNilai, 1)); ?></span>
                                            <?php else: ?>
                                    ...
                                    <td>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tugasItem->file_path): ?>
                                            <a href="<?php echo e(asset('/' . $tugasItem->file_path)); ?>" target="_blank" class="action-btn btn-view">
                                                <i class="bi bi-eye"></i> Lihat
                                            </a>
                                            <a href="<?php echo e(asset('/' . $tugasItem->file_path)); ?>" download class="action-btn btn-download">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        <?php else: ?>
                                            <span class="text-muted">Tidak ada file</span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php if(Auth::id() === 2472 || in_array($tugasItem->area, $allowedAreas, true)): ?>
                                            <button type="button" class="action-btn btn-nilai" onclick="openNilaiModal(<?php echo e($tugasItem->id); ?>, '<?php echo e($tugasItem->user->name); ?>', '<?php echo e($tugasItem->area); ?>', <?php echo e($currentUserNilai ? $currentUserNilai->nilai : 'null'); ?>, <?php echo e((Auth::id() === 2472 && $averageNilai) ? number_format($averageNilai, 1) : 'null'); ?>)">
                                                <i class="bi bi-star"></i> Nilai
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentUserNilai): ?>
                                                    (<?php echo e($currentUserNilai->nilai); ?>)
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::id() === 2472 && $averageNilai): ?>
                                                    <br><small>Rata-rata: <?php echo e(number_format($averageNilai, 1)); ?></small>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </button>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </td>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($terstruktur->isEmpty()): ?>
                            <tr>
                                <td colspan="8" class="no-data">Belum ada tugas Terstruktur yang disubmit untuk materi Anda</td>
                            </tr>
                        <?php else: ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $terstruktur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tugasItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
                                    <td><?php echo e($index + 1); ?></td>
                                    <td><?php echo e($tugasItem->user->name ?? 'N/A'); ?></td>
                                    <td><?php echo e($tugasItem->user->madrasah->name ?? 'N/A'); ?></td>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kelompok->isEmpty()): ?>
                            <tr>
                                <td colspan="8" class="no-data">Belum ada tugas Kelompok yang disubmit untuk materi Anda</td>
                            </tr>
                        <?php else: ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $kelompok; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tugasItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
                                    <td><?php echo e($index + 1); ?></td>
                                    <td><?php echo e($tugasItem->kelompok->nama_kelompok ?? $tugasItem->user->name ?? 'N/A'); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <?php if(Auth::id() === 2472 || in_array($tugasItem->area, $allowedAreas, true)): ?>
                                            ...
                                            ?>
                                            <button type="button" class="action-btn btn-nilai" onclick="openNilaiModal(<?php echo e($tugasItem->id); ?>, '<?php echo e($displayName); ?>', '<?php echo e($tugasItem->area); ?>', <?php echo e($currentUserNilai ? $currentUserNilai->nilai : 'null'); ?>, <?php echo e((Auth::id() === 2472 && $averageNilai) ? number_format($averageNilai, 1) : 'null'); ?>)">
                                                <i class="bi bi-star"></i> Nilai
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentUserNilai): ?>
                                                    (<?php echo e($currentUserNilai->nilai); ?>)
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function saveNilai(tugasId, nilai, showAlerts = false) {
        const url = '<?php echo e(route("talenta.simpan-nilai-tugas")); ?>';
        const payload = {
            tugas_id: tugasId,
            nilai: Number(nilai),
        };
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/talenta/penilaian-tugas.blade.php ENDPATH**/ ?>