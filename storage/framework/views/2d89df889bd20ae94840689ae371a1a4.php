...
<div class="container py-3" style="max-width: 420px; margin: auto;">
    ...
    <div class="presensi-header d-flex align-items-center">
        ...
        <div class="ms-auto">
            <img src="<?php echo e(isset(Auth::user()->avatar) ? asset('storage/' . Auth::user()->avatar) : asset('build/images/avatar-1.jpg')); ?>" class="rounded-circle border border-white" width="32" height="32" alt="User">
        </div>
    </div>
            ...
            <div class="schedule-card d-flex align-items-start">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="mt-3">
                        ...
                        <?php else: ?>
                            <div class="time-status-container" data-schedule-id="<?php echo e($schedule->id); ?>" data-start-time="<?php echo e($schedule->start_time); ?>" data-end-time="<?php echo e($schedule->end_time); ?>">
                                <?php
