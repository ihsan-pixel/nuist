...
<?php $__env->startSection('subtitle', 'Presensi Mengajar Hari Ini'); ?>
...
<div class="container py-3" style="max-width: 420px; margin: auto;">
    ...
    <div class="presensi-header d-flex align-items-center">
        <div class="me-2">
            ...
            <h5 class="fw-bold mb-0"><?php echo e(Auth::user()->name ?? Auth::user()->username ?? 'User'); ?></h5>
        </div>
        <div class="ms-auto">
            <img src="<?php echo e(isset(Auth::user()->avatar) ? asset('storage/app/public/' . Auth::user()->avatar) : asset('build/images/users/avatar-11.jpg')); ?>" class="rounded-circle border border-white" width="32" height="32" alt="User">
        </div>
    </div>

    <!-- Date below header (smaller font) -->
    <div class="text-center mt-2">
        <small class="small-muted presensi-date"><?php echo e(\Carbon\Carbon::parse($today)->locale('id')->isoFormat('dddd, D MMMM YYYY')); ?></small>
    </div>
            ...
            <div class="schedule-card d-flex align-items-start">
                ...
                <div class="flex-grow-1">
                    <div class="d-flex align-items-start justify-content-between">
                        <div>
                            <div class="fw-semibold"><?php echo e($schedule->subject); ?></div>
                            <div class="small-muted"><?php echo e($schedule->school->name ?? 'N/A'); ?></div>
                        </div>
                        <div class="text-end">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-2">
                        <div>
                            ...
                            <div class="fw-medium"><?php echo e($schedule->class_name); ?></div>
                        </div>
                        <div class="text-end">
                            <small class="small-muted">Waktu</small>
                            <div class="fw-medium"><?php echo e($schedule->start_time); ?> - <?php echo e($schedule->end_time); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <?php else: ?>
                            ...
                            <?php if($isWithinTime): ?>
                                <button class="presensi-btn" onclick="openAttendanceModal(<?php echo e($schedule->id); ?>, '<?php echo e(addslashes($schedule->subject)); ?>', '<?php echo e(addslashes($schedule->class_name)); ?>', '<?php echo e(addslashes($schedule->school->name ?? 'N/A')); ?>', '<?php echo e($schedule->start_time); ?>', '<?php echo e($schedule->end_time); ?>')">
