        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($approvedIzinPresensi)): ?>
            <div class="alert alert-info border-0 rounded-3 mb-3" style="background: rgba(13, 202, 240, 0.12); color: #055160; border-radius: 12px; padding: 10px;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($approvedIzinNote)): ?>
                    <div class="small mt-1"><?php echo e(Str::limit((string) $approvedIzinNote, 140)); ?></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
                                    ...
                                    <div class="alert <?php echo e(($schedule->attendance->is_academic_calendar_event ?? false) || (($schedule->attendance->status ?? 'hadir') === 'izin') ? 'alert-info' : 'alert-success'); ?> mb-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <?php elseif(($schedule->attendance->status ?? 'hadir') === 'izin'): ?>
                                                    <div class="fw-semibold"><?php echo e($schedule->attendance->display_status_label); ?></div>
                                                <?php elseif(($schedule->attendance->status_label ?? '') === 'Jurnal Terlambat'): ?>
                                                    <div class="fw-semibold"><?php echo e($schedule->attendance->display_status_label); ?></div>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <div class="text-center mt-2">
                                                <small class="small-muted bg-light px-2 py-1 rounded-pill">
                                                    <i class="bx bx-info-circle me-1"></i>Jurnal terlambat hanya bisa diajukan pada hari yang sama. Waktu mengajar: <?php echo e($schedule->start_time); ?> - <?php echo e($schedule->end_time); ?>
...
const csrfTokenUrl = '<?php echo e(url('/csrf-token')); ?>';
...
function checkLocationInPolygon(lat, lng, scheduleId) {
    return new Promise((resolve, reject) => {
        fetchWithCsrf('<?php echo e(route('teaching-attendances.check-location')); ?>', {
            method: 'POST',
            headers: {
...
document.addEventListener('click', function (e) {
    ...
    if (e.target.closest('#confirmAttendanceBtn')) {
        ...
        checkLocationInPolygon(userLocation.latitude, userLocation.longitude, currentScheduleId).then(isValid => {
            ...
            fetchWithCsrf('<?php echo e(route('teaching-attendances.store')); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
...
<?php echo $__env->make('layouts.mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/mobile/teaching-attendances.blade.php ENDPATH**/ ?>