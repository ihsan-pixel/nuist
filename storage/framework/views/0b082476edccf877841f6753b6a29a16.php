            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h5 class="mb-0"><?php echo e($stats['updates'] ?? 0); ?></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h5 class="mb-0"><?php echo e($stats['enhancements'] ?? 0); ?></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <?php if($histories->count() > 0): ?>
                    <ul class="timeline">
                        ...
                        <li>
                            <div class="timeline-badge <?php echo e($history->getTypeBadgeClass()); ?>">
                                <i class="bx <?php echo e($history->getTypeIcon()); ?>"></i>
                            </div>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4 class="timeline-title"><?php echo e($history->title); ?></h4>
                                    <p class="text-muted">
                                        <small>
                                            <i class="bx bx-calendar me-1"></i>
                                            <?php echo e($history->formatted_date); ?>

                                            <span class="text-primary ms-2">(<?php echo e($history->relative_date); ?>)</span>
                                            <?php if($history->version): ?>
                                                <span class="badge bg-info ms-2">v<?php echo e($history->version); ?></span>
                                            <?php endif; ?>
                                            <span class="badge <?php echo e($history->getTypeBadgeClass()); ?> ms-2">
                                    ...
                                    <?php if($history->migration_file): ?>
                                        <p class="text-muted mb-0">
                                            <small>
                                                ...
                                                Migration: <?php echo e($history->migration_file); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\apk_nuist\resources\views/development-history/index.blade.php ENDPATH**/ ?>