...
<?php $__env->startSection('css'); ?>
    <!-- dragula css -->
    <link href="<?php echo e(asset('build/libs/dragula/dragula.min.css')); ?>" rel="stylesheet" type="text/css" />
<?php $__env->stopSection(); ?>
                                    ...
                                    <div class="avatar-group float-start task-assigne">
                                        ...
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block" value="member-5">
                                                <img src="<?php echo e(asset('build/images/users/avatar-5.jpg')); ?>"
                                                    alt="" class="rounded-circle avatar-xs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block" value="member-6">
                                                <img src="<?php echo e(asset('build/images/users/avatar-2.jpg')); ?>"
                                                    alt="" class="rounded-circle avatar-xs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                    ...
                                    <div class="avatar-group float-start task-assigne">
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block" value="member-1">
                                                <img src="<?php echo e(asset('build/images/users/avatar-1.jpg')); ?>"
                                                    alt="" class="rounded-circle avatar-xs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                    ...
                                    <ul class="list-inine ps-0 mb-4">
                                            ...
                                            <a href="#">
                                                <div class="border rounded avatar-sm">
                                                    <span class="avatar-title bg-transparent">
                                                        <img src="<?php echo e(asset('build/images/companies/img-1.png')); ?>"
                                                            alt="" class="avatar-xs">
                                                    </span>
                                                </div>
                                            </a>
                                        ...
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div class="border rounded avatar-sm">
                                                    <span class="avatar-title bg-transparent">
                                                        <img src="<?php echo e(asset('build/images/companies/img-2.png')); ?>"
                                                            alt="" class="avatar-xs">
                                                    </span>
                                                </div>
                                            </a>
                                        ...
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div class="border rounded avatar-sm">
                                                    <span class="avatar-title bg-transparent">
                                                        <img src="<?php echo e(asset('build/images/companies/img-3.png')); ?>"
                                                            alt="" class="avatar-xs">
                                                    </span>
                                                </div>
                                            </a>
                                    ...
                                    <div class="avatar-group float-start task-assigne">
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block" value="member-7">
                                                <img src="<?php echo e(asset('build/images/users/avatar-7.jpg')); ?>"
                                                    alt="" class="rounded-circle avatar-xs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block" value="member-8">
                                                <img src="<?php echo e(asset('build/images/users/avatar-8.jpg')); ?>"
                                                    alt="" class="rounded-circle avatar-xs">
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="card task-box" id="intask-2">
                                <div class="card-body">
                                    ...
                                    <div class="avatar-group float-start task-assigne">
                                        <div class="avatar-group-item">
                                            <a href="javascript: void(0);" class="d-inline-block" value="member-6">
                                                <img src="<?php echo e(asset('build/images/users/avatar-6.jpg')); ?>"
                                                    alt="" class="rounded-circle avatar-xs">
                                            </a>
                                        </div>
                                        <div class="avatar-group-item">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-inline mb-4">
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="<?php echo e(asset('build/images/small/img-4.jpg')); ?>"
                                        ...
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="<?php echo e(asset('build/images/small/img-5.jpg')); ?>"
                                                        class="rounded" alt="" height="48">
                                                </div>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="<?php echo e(asset('build/images/small/img-6.jpg')); ?>"
                                                        class="rounded" alt="" height="48">
                                                </div>
                                            </a>
                                        </li>
...
<?php $__env->startSection('script'); ?>
    <!-- dragula plugins -->
    <script src="<?php echo e(asset('build/libs/dragula/dragula.min.js')); ?>"></script>

    <!-- jquery-validation -->
    <script src="<?php echo e(asset('build/libs/jquery-validation/jquery.validate.min.js')); ?>"></script>

    <script src="<?php echo e(asset('build/js/pages/task-kanban.init.js')); ?>"></script>

    <script src="<?php echo e(asset('build/js/pages/task-form.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/tasks-kanban.blade.php ENDPATH**/ ?>