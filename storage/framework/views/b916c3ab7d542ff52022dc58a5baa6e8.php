...
<?php $__env->startSection('script'); ?>
    <!-- Chart JS -->
    <script src="<?php echo e(asset('build/libs/chart.js/chart.umd.js')); ?>"></script>
    <script src="<?php echo e(asset('build/js/pages/chartjs.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/charts-chartjs.blade.php ENDPATH**/ ?>