...
<div class="container py-3" style="max-width: 420px; margin: auto;">
    ...
    <?php if($presensiHistory->count() > 0): ?>
        <?php $__currentLoopData = $presensiHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $presensi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="history-item">
                <div class="history-date">
                    <?php echo e(\Carbon\Carbon::parse($presensi->tanggal)->format('d M Y')); ?>

                    <span class="text-muted">(<?php echo e(\Carbon\Carbon::parse($presensi->tanggal)->locale('id')->dayName); ?>)</span>
                </div>
