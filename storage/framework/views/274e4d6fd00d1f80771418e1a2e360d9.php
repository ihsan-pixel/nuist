...
<?php $__env->startSection('script'); ?>
    <!-- form mask -->
    <script src="<?php echo e(asset('build/libs/inputmask/inputmask.min.js')); ?>"></script>

    <!-- form mask init -->
    <script src="<?php echo e(asset('build/js/pages/form-mask.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/form-mask.blade.php ENDPATH**/ ?>