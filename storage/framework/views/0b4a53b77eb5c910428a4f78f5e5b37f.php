...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($user->role, ['super_admin', 'pengurus', 'admin_yayasan'])): ?>
                ...
                <div class="col-lg-4 text-lg-end">
                    ...
                    <div class="d-flex align-items-center gap-2 mt-3 justify-content-end w-100">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->role === 'super_admin'): ?>
                            <a href="<?php echo e(route('presensi_admin.face_diagnostics')); ?>"
                ...
                <div class="stat-card h-100 hover-lift total-sekolah" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%) !important; border-radius: 15px !important; padding: 1.5rem !important; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1) !important; border: none !important; transition: all 0.3s ease !important; position: relative !important; overflow: hidden !important; color: white !important;">
                    <div class="card-body p-4" style="padding: 1.5rem !important;">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h3 id="summary-users-presensi" class="text-white mb-1" style="color: white !important;"><?php echo e(number_format($summary['users_presensi'])); ?></h3>
            ...
            <div class="col-lg-3">
                <div class="stat-card h-100 hover-lift" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%) !important; border-radius: 15px !important; padding: 1.5rem !important; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1) !important; border: none !important; transition: all 0.3s ease !important; position: relative !important; overflow: hidden !important; color: white !important;">
                    <div class="card-body p-4" style="padding: 1.5rem !important;">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h3 id="summary-users-izin" class="text-white mb-1" style="color: white !important;"><?php echo e(number_format($summary['users_izin'])); ?></h3>
            ...
            <div class="col-lg-3">
                <div class="stat-card h-100 hover-lift sekolah-buka" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%) !important; border-radius: 15px !important; padding: 1.5rem !important; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1) !important; border: none !important; transition: all 0.3s ease !important; position: relative !important; overflow: hidden !important; color: white !important;">
                    <div class="card-body p-4" style="padding: 1.5rem !important;">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h3 id="summary-sekolah-presensi" class="text-white mb-1" style="color: white !important;"><?php echo e(number_format($summary['sekolah_presensi'])); ?></h3>
            ...
            <div class="col-lg-3">
                <div class="stat-card h-100 hover-lift pending" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%) !important; border-radius: 15px !important; padding: 1.5rem !important; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1) !important; border: none !important; transition: all 0.3s ease !important; position: relative !important; overflow: hidden !important; color: white !important;">
                    <div class="card-body p-4" style="padding: 1.5rem !important;">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h3 id="summary-guru-tidak-presensi" class="text-white mb-1" style="color: white !important;"><?php echo e(number_format($summary['guru_tidak_presensi'])); ?></h3>
            ...
            <div class="kabupaten-group">
                <div class="kabupaten-header flex-column flex-md-row align-items-md-center gap-3">
                    <div class="header-title">
                        ...
                        <div>
                            <h5><?php echo e($kabupaten); ?></h5>
                            <p>Ringkasan presensi madrasah pada wilayah ini.</p>
                        </div>
                    </div>
                    <span class="section-chip"><?php echo e($kabupatenMadrasahData->count()); ?> madrasah</span>
                </div>

                <div class="kabupaten-table">
                    <div class="table-responsive">
                        <table id="madrasah-table-<?php echo e($kabupatenIndex); ?>-<?php echo e($madrasahIndex); ?>" class="table table-hover align-middle mb-0">
                            <thead>
                                <tr>
                                    <th>Nama Madrasah</th>
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $kabupatenMadrasahData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
                                    <td>
                                        <div class="sekolah-name"><?php echo e($data['madrasah']->name); ?></div>
                                        <div class="kabupaten-info"><?php echo e($kabupaten); ?></div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2 flex-wrap action-cluster">
                                            <a href="<?php echo e(route('presensi_admin.show_detail', $data['madrasah']->id)); ?>?date=<?php echo e($selectedDate->format('Y-m-d')); ?>" class="btn btn-table-primary btn-sm">
                                            ...
                                            <button type="button" class="btn btn-table-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#exportModal" data-madrasah-id="<?php echo e($data['madrasah']->id); ?>" data-madrasah-name="<?php echo e($data['madrasah']->name); ?>">
                                                <i class="bx bx-download me-1"></i>Export
                                            </button>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
            ...
            <div class="modal-content dashboard-modal">
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3" id="monthSelector" style="display: none;">
                        ...
                        <input type="month" class="form-control" id="exportMonth" value="<?php echo e(date('Y-m')); ?>">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-dashboard-secondary btn-sm" data-bs-dismiss="modal">
        ...
        <div class="col-md-6">
            <div class="card dashboard-mini-stat border-0">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div id="summary-users-presensi" class="h5 mb-1 fw-bold"><?php echo e($summary['users_presensi']); ?></div>
        ...
        <div class="col-md-6">
            <div class="card dashboard-mini-stat danger border-0">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div id="summary-guru-tidak-presensi" class="h5 mb-1 fw-bold"><?php echo e($summary['guru_tidak_presensi']); ?></div>
            ...
            <div class="card content-card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 d-flex justify-content-end">
                        <a href="<?php echo e(route('izin.index')); ?>" class="btn btn-dashboard-primary">
                    ...
                    <div class="table-responsive">
                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $presensis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $presensi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
        ...
        <div class="col-12">
            <div class="card content-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">
                        <i class="bx bx-user-x me-2"></i>Belum Melakukan Presensi pada tanggal <?php echo e($selectedDate->format('d-m-Y')); ?>

                    </h4>
                    <form method="GET" action="<?php echo e(route('presensi_admin.index')); ?>" class="d-flex align-items-center inline-filter">
                        <input type="date" name="date" class="form-control form-control-sm" value="<?php echo e($selectedDate->format('Y-m-d')); ?>" onchange="this.form.submit()">
                    </form>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($user->role, ['super_admin', 'pengurus', 'admin_yayasan'])): ?>
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $belumPresensi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userBelum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($user->role, ['super_admin', 'pengurus', 'admin_yayasan'])): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <tr>
                                    <td colspan="<?php echo e(in_array($user->role, ['super_admin', 'pengurus', 'admin_yayasan']) ? 3 : 2); ?>" class="text-center p-4">
                                        <div class="alert alert-info d-inline-block text-center" role="alert">
                                            <i class="bx bx-info-circle bx-lg me-2"></i>
        ...
        <div class="card content-card mb-4">
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <p class="text-muted mb-0">Periode <?php echo e($threeMonthAbsenceData['label']); ?></p>
                </div>
                ...
                <div class="table-responsive">
                    <table id="datatable-three-month-absence" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $threeMonthAbsenceData['rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($teacher['scod']); ?></td>
                                    <td><?php echo e($teacher['name']); ?></td>
                                    <td><?php echo e($teacher['madrasah']); ?></td>
                                    <td><?php echo e($teacher['periode']); ?></td>
                                </tr>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <tr>
            ...
            <div class="card-body">
                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-3">
                    <div>
                        ...
                        <p class="text-muted mb-0">Periode <?php echo e($teacherAbsenceRecapData['label']); ?></p>
                    </div>

                    <form method="GET" action="<?php echo e(route('presensi_admin.index')); ?>" class="d-flex flex-column flex-sm-row align-items-sm-center gap-2 inline-filter">
                        ...
                        <select name="absence_recap_period" id="absenceRecapPeriod" class="form-select form-select-sm">
                            <option value="week" <?php echo e($teacherAbsenceRecapData['period'] === 'week' ? 'selected' : ''); ?>>Mingguan</option>
                            <option value="month" <?php echo e($teacherAbsenceRecapData['period'] === 'month' ? 'selected' : ''); ?>>Bulanan</option>
                        </select>
                        ...
                        <input type="week"
                            ...
                            value="<?php echo e($teacherAbsenceRecapData['week_value']); ?>">

                        <input type="month"
                            name="absence_recap_month"
                            id="absenceRecapMonth"
                            class="form-control form-control-sm"
                            value="<?php echo e($teacherAbsenceRecapData['month_value']); ?>">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        <div class="summary-panel">
                            ...
                            <div class="summary-value"><?php echo e(number_format($teacherAbsenceRecapData['summary']['total_tenaga_pendidik'])); ?></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="summary-panel">
                            <div class="summary-label">Tenaga Pendidik Tidak Presensi</div>
                            <div class="summary-value text-danger"><?php echo e(number_format($teacherAbsenceRecapData['summary']['total_tidak_presensi'])); ?></div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="summary-panel">
                            <div class="summary-label">Total Hari Tidak Presensi</div>
                            <div class="summary-value text-warning"><?php echo e(number_format($teacherAbsenceRecapData['summary']['total_hari_tidak_presensi'])); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table id="datatable-teacher-absence-recap" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $teacherAbsenceRecapData['rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($teacher['scod']); ?></td>
                                    <td><?php echo e($teacher['name']); ?></td>
                                    <td><?php echo e($teacher['madrasah']); ?></td>
                                    <td><?php echo e($teacher['hari_kbm']); ?></td>
                                    <td><?php echo e($teacher['total_hari_kerja']); ?></td>
                                    <td><?php echo e($teacher['total_hadir']); ?></td>
                                    <td><?php echo e($teacher['total_izin']); ?></td>
                                    <td>
                                        <span class="badge bg-danger"><?php echo e($teacher['total_tidak_presensi']); ?></span>
                                    </td>
                                    <td><?php echo e(number_format($teacher['persentase_tidak_presensi'], 1)); ?>%</td>
                                </tr>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <tr>
...
<?php if(!in_array($user->role, ['super_admin', 'pengurus', 'admin_yayasan'])): ?>
    ...
    let currentDate = '<?php echo e($selectedDate->format('Y-m-d')); ?>';
    let updateInterval;

    function updateSummaryCards() {
        $.ajax({
            url: '<?php echo e(route('presensi_admin.summary')); ?>',
            type: 'GET',
...
<?php if(in_array($user->role, ['super_admin', 'pengurus', 'admin_yayasan'])): ?>
    ...
    $(document).on('click', '.user-detail-link', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(url('/presensi-admin/detail')); ?>/' + userId,
            type: 'GET',
            success: function(data) {
    ...
    $('input[type="date"]').on('change', function(e) {
        ...
        // Update export link
        let exportLink = '<?php echo e(route('presensi_admin.export', ['date' => 'PLACEHOLDER'])); ?>'.replace('PLACEHOLDER', currentDate);
    ...
    $('#exportAllBtn').on('click', function() {
        if (currentMadrasahId) {
            ...
            window.location.href = '<?php echo e(url('/presensi-admin/export-madrasah')); ?>/' + currentMadrasahId + '?type=all';
        }
    });
    ...
    $('#exportMonth').on('change', function() {
        if (currentMadrasahId) {
            let month = $(this).val();
            $('#exportModal').modal('hide');
            window.location.href = '<?php echo e(url('/presensi-admin/export-madrasah')); ?>/' + currentMadrasahId + '?type=month&month=' + month;
        }
    });
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/presensi_admin/index.blade.php ENDPATH**/ ?>