...
<div class="mgmp-page">
    <div class="mgmp-hero-strip mb-4">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div>
                <div class="mgmp-kicker mb-2"><?php echo e(auth()->user()->role === 'admin_yayasan' ? 'Admin Yayasan' : 'Super Admin'); ?></div>
            ...
            <div class="d-flex flex-wrap gap-2">
                <a href="<?php echo e(route(auth()->user()->role === 'admin_yayasan' ? 'dashboard' : 'admin.mgmp_dashboard')); ?>" class="btn btn-light">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/admin/mgmp_reset_uploads.blade.php ENDPATH**/ ?>