...
<?php $__env->startSection('css'); ?>
    ...
    <!-- dropzone css -->
    <link href="<?php echo e(asset('build/libs/dropzone/dropzone.css')); ?>" rel="stylesheet" type="text/css" />
<?php $__env->stopSection(); ?>
                                    ...
                                    <div data-simplebar style="max-height: 172px">
                                        <ul class="list-unstyled mb-0 assignto-list">
                                            ...
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center" href="#">
                                                    <div class="avatar-xs flex-shrink-0 me-2">
                                                        <img src="<?php echo e(asset('build/images/users/avatar-7.jpg')); ?>" alt=""
                                                            class="img-fluid rounded-circle" />
                                                    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('build/js/pages/project-create.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/projects-create.blade.php ENDPATH**/ ?>