...
<?php $__env->startSection('css'); ?>
    <link href="<?php echo e(asset('build/libs/bootstrap-datepicker/css/bootstrap-datepicker.min.css')); ?>" rel="stylesheet"
        type="text/css">
<?php $__env->stopSection(); ?>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(asset('build/images/companies/adobe.svg')); ?>" alt="" height="50" class="mb-3">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(asset('build/images/companies/adobe-photoshop.svg')); ?>" alt="" height="50" class="mb-3">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(asset('build/images/companies/airbnb.svg')); ?>" alt="" height="50" class="mb-3">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(asset('build/images/companies/amazon.svg')); ?>" alt="" height="50" class="mb-3">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(asset('build/images/companies/flutter.svg')); ?>" alt="" height="50" class="mb-3">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(asset('build/images/companies/mailchimp.svg')); ?>" alt="" height="50" class="mb-3">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(asset('build/images/companies/line.svg')); ?>" alt="" height="50" class="mb-3">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(asset('build/images/companies/spotify.svg')); ?>" alt="" height="50" class="mb-3">
                    <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small
                            class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(asset('build/images/companies/wordpress.svg')); ?>" alt="" height="50" class="mb-3">
                    <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small
                            class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(asset('build/images/companies/upwork.svg')); ?>" alt="" height="50" class="mb-3">
                    <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small
                            class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(asset('build/images/companies/sass.svg')); ?>" alt="" height="50" class="mb-3">
                    <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small
                            class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="<?php echo e(asset('build/images/companies/reddit.svg')); ?>" alt="" height="50" class="mb-3">
                    <h5 class="fs-17 mb-2"><a href="job-details" class="text-dark">Magento Developer</a> <small
                            class="text-muted fw-normal">(0-2 Yrs Exp.)</small></h5>
                    <ul class="list-inline mb-0">
                        <li class="list-inline-item">
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(asset('build/libs/bootstrap-datepicker/js/bootstrap-datepicker.min.js')); ?>"></script>
    <script src="<?php echo e(asset('build/js/app.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/job-grid.blade.php ENDPATH**/ ?>