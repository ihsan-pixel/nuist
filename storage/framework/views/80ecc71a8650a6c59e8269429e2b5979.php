<?php $__env->startSection('title', 'Presensi MGMP'); ?>
<?php $__env->startSection('subtitle', 'Presensi Kegiatan'); ?>
...
<div class="container py-3" style="max-width: 460px; margin: auto;">
    ...
    <div class="mgmp-hero">
        <div class="d-flex justify-content-between align-items-start gap-3">
            <div>
                <div class="text-white-50 small mb-1"><?php echo e($report->mgmpGroup->name ?? 'MGMP'); ?></div>
                <h5 class="mb-2 text-white"><?php echo e($report->judul); ?></h5>
                <div class="small">
                    <?php echo e($start ? $start->format('d M Y') : '-'); ?>

                    <span class="mx-1">.</span>
                    <?php echo e($start ? $start->format('H:i') : '-'); ?> - <?php echo e($end ? $end->format('H:i') : '-'); ?> WIB
                </div>
            </div>
    ...
    <div class="mgmp-card">
        <div class="info-grid">
            <div class="info-box">
                ...
                <div class="info-value"><?php echo e($report->lokasi ?: 'Tanpa nama lokasi'); ?></div>
            </div>
            <div class="info-box">
                <div class="info-label">Radius Presensi</div>
                <div class="info-value"><?php echo e($report->radius_meters ?? 100); ?> meter</div>
            </div>
            <div class="info-box">
                <div class="info-label">Latitude</div>
                <div class="info-value"><?php echo e($report->latitude ?: '-'); ?></div>
            </div>
            <div class="info-box">
                <div class="info-label">Longitude</div>
                <div class="info-value"><?php echo e($report->longitude ?: '-'); ?></div>
            </div>
        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($report->deskripsi): ?>
            <div class="mt-3 text-muted"><?php echo e($report->deskripsi); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($disabledReason): ?>
        <div class="mgmp-card">
            <div class="status-pill <?php echo e($existingAttendance ? 'success' : 'danger'); ?> mb-2">
                <i class="bx <?php echo e($existingAttendance ? 'bx-check-circle' : 'bx-error-circle'); ?>"></i>
                <?php echo e($existingAttendance ? 'Presensi Tercatat' : 'Presensi Tidak Tersedia'); ?>

            </div>
            <p class="mb-0 text-muted"><?php echo e($disabledReason); ?></p>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($existingAttendance): ?>
                <div class="mt-3 small">
                    <div><strong>Waktu:</strong> <?php echo e($existingAttendance->attended_at->format('d M Y H:i')); ?> WIB</div>
                    <div><strong>Jarak:</strong> <?php echo e($existingAttendance->distance_meters); ?> meter dari titik kegiatan</div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($existingAttendance->selfie_path): ?>
                        <a href="<?php echo e(route('foto.mgmp_attendance', $existingAttendance)); ?>" target="_blank" class="btn btn-outline-success btn-sm mt-3">Lihat Selfie</a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    const targetLat = parseFloat(<?php echo json_encode($report->latitude, 15, 512) ?>);
    const targetLng = parseFloat(<?php echo json_encode($report->longitude, 15, 512) ?>);
    const radiusMeters = parseInt(<?php echo json_encode($report->radius_meters ?? 100, 15, 512) ?>, 10);
    const csrfToken = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
    const storeUrl = <?php echo json_encode(route('mgmp.kegiatan.presensi.store', $report), 512) ?>;
...
<?php echo $__env->make('layouts.mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/mgmp/presensi.blade.php ENDPATH**/ ?>