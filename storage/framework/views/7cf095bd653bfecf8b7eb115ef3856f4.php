...
<?php $__env->startSection('script'); ?>
    <!-- echarts js -->
    <script src="<?php echo e(asset('build/libs/echarts/echarts.min.js')); ?>"></script>
    <!-- echarts init -->
    <script src="<?php echo e(asset('build/js/pages/echarts.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/charts-echart.blade.php ENDPATH**/ ?>