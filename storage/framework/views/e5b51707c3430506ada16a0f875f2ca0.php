...
<?php $__env->startSection('body'); ?>
                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5">
                                        <a href="index" class="d-block auth-logo">
                                            <img src="<?php echo e(asset('build/images/logo-dark.png')); ?>" alt="" height="18"
                                                class="auth-logo-dark">
                                            <img src="<?php echo e(asset('build/images/logo-light.png')); ?>" alt="" height="18"
    ...
    <?php $__env->startSection('script'); ?>
        ...
        <script src="<?php echo e(asset('build/js/pages/two-step-verification.init.js')); ?>"></script>
    <?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/auth-two-step-verification-2.blade.php ENDPATH**/ ?>