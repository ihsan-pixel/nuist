...
<body>
    ...
    <div class="content">
        ...
        <div class="password-box">
            ...
            <p class="password"><?php echo e($plainPassword); ?></p>
        </div>
        ...
        <p>You can now log in to your account at: <a href="<?php echo e(url('/login')); ?>"><?php echo e(url('/login')); ?></a></p>
    ...
    <div class="footer">
        ...
        <p>&copy; <?php echo e(date('Y')); ?> LP. Ma'arif NU PWNU DIY. All rights reserved.</p>
    </div>
</body>
</html>
<?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/emails/registration_approved.blade.php ENDPATH**/ ?>