                    ...
                    <div class="table-responsive">
                        <table class="table align-middle mb-0 table-nowrap">
                            ...
                            <tbody>
                                <tr class="product">
                                    <td>
                                        <img src="<?php echo e(asset('build/images/product/img-1.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                ...
                                <tr class="product">
                                    <td>
                                        <img src="<?php echo e(asset('build/images/product/img-2.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
                                ...
                                <tr class="product">
                                    <td>
                                        <img src="<?php echo e(asset('build/images/product/img-3.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
                                ...
                                <tr class="product">
                                    <td>
                                        <img src="<?php echo e(asset('build/images/product/img-4.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
                                ...
                                <tr class="product">
                                    <td>
                                        <img src="<?php echo e(asset('build/images/product/img-5.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
                                ...
                                <tr class="product">
                                    <td>
                                        <img src="<?php echo e(asset('build/images/product/img-6.png')); ?>" alt="product-img" title="product-img"
                                            class="avatar-md" />
                                    </td>
                                    <td>
                                        <h5 class="font-size-14 text-truncate"><a href="ecommerce-product-detail"
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('build/js/pages/ecommerce-cart.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/ecommerce-cart.blade.php ENDPATH**/ ?>