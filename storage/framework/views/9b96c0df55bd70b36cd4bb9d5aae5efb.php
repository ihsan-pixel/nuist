                ...
                <div class="card-body">
                    <div class="d-flex">
                        <div class="flex-shrink-0 me-4">
                            <img src="<?php echo e(asset('build/images/companies/img-1.png')); ?>" alt="" class="avatar-sm">
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap">
                            <tbody>
                                <tr>
                                    <td style="width: 50px;"><img src="<?php echo e(asset('build/images/users/avatar-2.jpg')); ?>"
                                ...
                                <tr>
                                    <td><img src="<?php echo e(asset('build/images/users/avatar-1.jpg')); ?>" class="rounded-circle avatar-xs"
                                            alt=""></td>
                                    <td>
                                ...
                                <tr>
                                    <td><img src="<?php echo e(asset('build/images/users/avatar-4.jpg')); ?>" class="rounded-circle avatar-xs"
                                            alt=""></td>
                                    <td>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex mb-4">
                        <div class="flex-shrink-0 me-3">
                            <img class="d-flex-object rounded-circle avatar-xs" alt=""
                                src="<?php echo e(asset('build/images/users/avatar-2.jpg')); ?>">
                        </div>
                    ...
                    <div class="d-flex mb-4">
                        <div class="flex-shrink-0 me-3">
                            <img class="d-flex-object rounded-circle avatar-xs" alt=""
                                src="<?php echo e(asset('build/images/users/avatar-3.jpg')); ?>">
                        </div>
                        <div class="flex-grow-1">
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('build/js/pages/project-overview.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/projects-overview.blade.php ENDPATH**/ ?>