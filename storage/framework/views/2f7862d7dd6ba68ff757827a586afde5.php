...
<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('build/libs/tui-time-picker/tui-time-picker.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('build/libs/tui-date-picker/tui-date-picker.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('build/libs/tui-calendar/tui-calendar.min.css')); ?>" />
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('build/libs/tui-dom/tui-dom.min.js')); ?>"></script>

    <script src="<?php echo e(asset('build/libs/tui-time-picker/tui-time-picker.min.js')); ?>"></script>
    <script src="<?php echo e(asset('build/libs/tui-date-picker/tui-date-picker.min.js')); ?>"></script>

    <script src="<?php echo e(asset('build/libs//moment/min/moment.min.js')); ?>"></script>
    <script src="<?php echo e(asset('build/libs/chance/chance.min.js')); ?>"></script>

    <script src="<?php echo e(asset('build/libs/tui-calendar/tui-calendar.min.js')); ?>"></script>

    <script src="<?php echo e(asset('build/js/pages/calendars.js')); ?>"></script>
    <script src="<?php echo e(asset('build/js/pages/schedules.js')); ?>"></script>
    <script src="<?php echo e(asset('build/js/pages/calendar.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/calendar.blade.php ENDPATH**/ ?>