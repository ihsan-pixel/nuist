...
Login MGMP - Sistem Informasi Digital LP. Ma'arif NU PWNU DIY
        ...
        <div class="form-section">
            <div class="form-container">
                <div class="logo-section">
                    <img src="<?php echo e(asset('images/mgmp-logo.png')); ?>" alt="Logo MGMP" class="logo">
                </div>
                <h1 class="login-title">LOGIN MGMP</h1>
                <p class="login-subtitle">Masuk ke sistem MGMP untuk mengelola data dan informasi Anda.</p>
                ...
                <form class="login-form" method="POST" action="<?php echo e(route('mgmp.authenticate')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/nuist/resources/views/mgmp/login.blade.php ENDPATH**/ ?>