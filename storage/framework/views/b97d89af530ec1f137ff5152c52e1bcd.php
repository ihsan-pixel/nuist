...
<?php $__env->startSection('script'); ?>
    ...
    <!-- Gmaps file -->
    <script src="<?php echo e(asset('build/libs/gmaps/gmaps.min.js')); ?>"></script>

    <!-- demo codes -->
    <script src="<?php echo e(asset('build/js/pages/gmaps.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/maps-google.blade.php ENDPATH**/ ?>