...
<div class="spp-register-shell">
    <div class="spp-register-grid">
        ...
        <section class="spp-register-card">
            <div class="card-top">
                <img src="<?php echo e(asset('images/logo1.png')); ?>" alt="NUist" class="brand-logo">
                <div>
            ...
            <form method="POST" action="<?php echo e(route('spp-operator.register.store')); ?>" class="spp-register-form">
                <?php echo csrf_field(); ?>
                <div class="form-block">
                    <label for="scod">SCOD Sekolah</label>
                    <input id="scod" type="text" name="scod" class="form-control" value="<?php echo e(old('scod')); ?>" placeholder="Ketik SCOD sekolah" required>
                </div>
                ...
                <div class="form-block">
                    ...
                    <input
                        ...
                        type="text"
                        class="form-control"
                        value="<?php echo e($matchedMadrasah?->name); ?>"
                        placeholder="Nama sekolah akan terisi otomatis"
                        readonly
                    >
                    <div id="scodHelp" class="field-help">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($matchedMadrasah): ?>
                            <?php echo e($matchedMadrasah->kabupaten ? $matchedMadrasah->kabupaten . ' • ' : ''); ?>SCOD terdeteksi
                        <?php else: ?>
                ...
                <div class="form-block">
                    ...
                    <input id="jabatan" type="text" name="jabatan" class="form-control" value="<?php echo e(old('jabatan')); ?>" required>
                </div>
                ...
                <div class="form-block">
                    ...
                    <input id="no_hp" type="text" name="no_hp" class="form-control" value="<?php echo e(old('no_hp')); ?>">
                </div>

                <button type="submit" class="submit-btn">Kirim Pendaftaran</button>
                <a href="<?php echo e(route('login.operator-spp')); ?>" class="back-link">Sudah punya akun? Login Operator SPP</a>
            </form>
        </section>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var lookupUrl = '<?php echo e(route('spp-operator.lookup-school')); ?>';
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/spp-operator/public-register.blade.php ENDPATH**/ ?>