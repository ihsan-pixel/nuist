    ...
    <div class="auth-background">
        ...
        <div class="mobile-screen" role="main">
            ...
            <div class="form-card">
                ...
                <form method="POST" action="<?php echo e(route('mobile.password.update')); ?>">
                    <?php echo csrf_field(); ?>

                    <input type="hidden" name="token" value="<?php echo e($token ?? old('token')); ?>">

                    <div class="input-wrap">
                        <input id="email" name="email" type="email" class="pill-input" placeholder="contoh@gmail.com" required value="<?php echo e($email ?? old('email')); ?>">
