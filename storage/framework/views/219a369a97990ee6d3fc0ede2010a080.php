...
<body data-layout-mode="light" class="mobile-layout">
    ...
    <div id="pwa-install-prompt" class="pwa-install-prompt">
        <div class="d-flex align-items-center">
            <img src="<?php echo e(asset('build/images/logo-light.png')); ?>" alt="NUIST" width="40" height="40" class="me-3 rounded">
    ...
    <header class="bg-white border-bottom d-md-none">
        <div class="container-fluid px-3 py-2">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <img src="<?php echo e(asset('build/images/logo-light.png')); ?>" alt="NUIST" height="32" class="me-2">
                    <div>
                ...
                <div class="d-flex align-items-center">
                    <!-- Notification Bell -->
                    <a href="<?php echo e(route('mobile.notifications')); ?>" class="btn btn-link text-decoration-none p-0 me-3 position-relative">
                 ...
                 class="rounded-circle border border-white" width="44" height="44" alt="User">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="<?php echo e(route('mobile.notifications')); ?>"><i class="bx bx-bell me-2"></i>Notifikasi</a></li>
