...
<?php $__env->startSection('css'); ?>
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(asset('build/libs/bootstrap-datepicker/css/bootstrap-datepicker.min.css')); ?>">
<?php $__env->stopSection(); ?>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mb-3">
                        <img src="<?php echo e(asset('build/images/users/avatar-1.jpg')); ?>" alt="" class="avatar-sm rounded-circle" />
        ...
        <div class="col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mb-3">
                        <img src="<?php echo e(asset('build/images/users/avatar-2.jpg')); ?>" alt="" class="avatar-sm rounded-circle" />
        ...
        <div class="col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mb-3">
                        <img src="<?php echo e(asset('build/images/users/avatar-3.jpg')); ?>" alt="" class="avatar-sm rounded-circle" />
        ...
        <div class="col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mb-3">
                        <img src="<?php echo e(asset('build/images/users/avatar-4.jpg')); ?>" alt="" class="avatar-sm rounded-circle" />
        ...
        <div class="col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mb-3">
                        <img src="<?php echo e(asset('build/images/users/avatar-5.jpg')); ?>" alt="" class="avatar-sm rounded-circle" />
        ...
        <div class="col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mb-3">
                        <img src="<?php echo e(asset('build/images/users/avatar-6.jpg')); ?>" alt="" class="avatar-sm rounded-circle" />
        ...
        <div class="col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mb-3">
                        <img src="<?php echo e(asset('build/images/users/avatar-7.jpg')); ?>" alt="" class="avatar-sm rounded-circle" />
        ...
        <div class="col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mb-3">
                        <img src="<?php echo e(asset('build/images/users/avatar-8.jpg')); ?>" alt="" class="avatar-sm rounded-circle" />
...
<?php $__env->startSection('script'); ?>
    ...
    <!-- candidate-list js -->
    <script src="<?php echo e(asset('build/js/pages/candidate-list.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/candidate-list.blade.php ENDPATH**/ ?>