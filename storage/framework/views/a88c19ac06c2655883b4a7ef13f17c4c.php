<?php $__env->startSection('title', 'Daftar Wajah'); ?>
    ...
    async function submitEnrollment() {
        ...
        try {
            ...
            window.setTimeout(function () {
                window.location.href = <?php echo json_encode(route('mobile.presensi'), 15, 512) ?>;
            }, 1200);
        } catch (error) {
            enrollButton.disabled = false;
...
<?php echo $__env->make('layouts.mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/mobile/face-enrollment.blade.php ENDPATH**/ ?>