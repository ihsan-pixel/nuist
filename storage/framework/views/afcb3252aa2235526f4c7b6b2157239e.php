<?php $__env->startSection('title', 'Monitor Map Presensi'); ?>
<?php $__env->startSection('subtitle', 'Peta Lokasi Presensi'); ?>
...
<div class="container py-3" style="max-width: 420px; margin: auto;">
    ...
    <div class="date-selector">
        <form method="GET" action="<?php echo e(route('mobile.monitor-map')); ?>">
    ...
    <div class="stats-card">
        ...
        <div class="stats-grid">
            <div class="stat-item stat-present">
                <span class="stat-number"><?php echo e($presensis->count()); ?></span>
                <span class="stat-label">Sudah Presensi</span>
            </div>
            <div class="stat-item stat-absent">
                <span class="stat-number"><?php echo e($belumPresensi->count()); ?></span>
    ...
    <!-- Menu Buttons -->
    <a href="<?php echo e(route('mobile.monitor-presensi')); ?>" class="menu-button">
        <i class="bx bx-list-ul me-1"></i>
        Lihat Daftar Presensi
    </a>

    <a href="<?php echo e(route('mobile.presensi')); ?>" class="menu-button">
        <i class="bx bx-log-in-circle me-1"></i>
        Kembali ke Presensi
    </a>

    <a href="<?php echo e(route('mobile.dashboard')); ?>" class="menu-button">
...
<?php echo $__env->make('layouts.mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/mobile/monitor-map.blade.php ENDPATH**/ ?>