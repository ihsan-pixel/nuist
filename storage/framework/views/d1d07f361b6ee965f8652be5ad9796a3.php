                    ...
                    <div class="text-center">
                        ...
                        <div class="row justify-content-center mt-5 mb-2">
                            <div class="col-sm-6 col-8">
                                <div>
                                    <img src="<?php echo e(asset('build/images/verification-img.png')); ?>" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startSection('script'); ?>
    <!-- jquery step -->
    <script src="<?php echo e(asset('build/libs/jquery-steps/build/jquery.steps.min.js')); ?>"></script>

    <!-- dropzone js -->
    <script src="<?php echo e(asset('build/libs/dropzone/dropzone-min.js')); ?>"></script>

    <!-- init js -->
    <script src="<?php echo e(asset('build/js/pages/crypto-kyc-app.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/crypto-kyc-application.blade.php ENDPATH**/ ?>