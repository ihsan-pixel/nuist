    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="<?php echo e(url('/ppdb/lp/pendaftar/' . $spmbSlug)); ?>" class="waves-effect">
                        <i class="bx bx-file"></i>
                        <span>Pendaftar</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(url('/ppdb/lp/ppdb-settings/' . auth()->user()->madrasah_id)); ?>" class="waves-effect">
                        <i class="bx bx-cog"></i>
                        <span>Pengaturan</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(url('/ppdb/lp/edit/' . auth()->user()->madrasah_id)); ?>" class="waves-effect">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($userRole === 'super_admin'): ?>
                <li>
                    <a href="<?php echo e(route('admin.pending-registrations.index')); ?>" class="waves-effect">
                        <i class="bx bx-user-plus"></i>
                        <span>Pending Registrations</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e(route('presensi_admin.kiosk_devices')); ?>" class="waves-effect">
                ...
                <li>
                    <a href="<?php echo e(route('admin.mgmp_dashboard')); ?>" class="waves-effect">
                        <i class="bx bx-bar-chart-alt-2"></i>
                ...
                <li>
                    <a href="<?php echo e(route('admin.create_mgmp_user')); ?>" class="waves-effect">
                        <i class="bx bx-user-plus"></i>
                ...
                <li>
                    ...
                    <ul class="sub-menu collapse" id="uppmSubmenu">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($userRole === 'super_admin'): ?>
                        <li><a href="<?php echo e(route('uppm.update-uppm')); ?>">Update UPPM</a></li>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <li>
                    ...
                    <ul class="sub-menu collapse" id="dataSekolahSubmenu">
                        <li><a href="<?php echo e(route('data-sekolah.data-siswa.index')); ?>">Data Siswa</a></li>
...
<!-- Left Sidebar End -->
<?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>