        ...
        <div class="col-md-6">
            <div class="card dashboard-mini-stat border-0">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="h5 mb-1 fw-bold"><?php echo e($summary['users_presensi']); ?></div>
        ...
        <div class="col-md-6">
            <div class="card dashboard-mini-stat danger border-0">
                <div class="card-body d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="h5 mb-1 fw-bold"><?php echo e($summary['guru_tidak_presensi']); ?></div>
...
<?php if(!in_array($user->role, ['super_admin', 'pengurus'])): ?>
    ...
    function updatePresensiData() {
        $.ajax({
            url: '<?php echo e(route('presensi_admin.data')); ?>',
            type: 'GET',
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/nuist/resources/views/presensi_admin/index.blade.php ENDPATH**/ ?>