                ...
                <div class="card-body p-4">
                    <div class="row align-items-center">
                        ...
                        <div class="col">
                            ...
                            <p class="text-muted mb-0"><?php echo e($selectedDate->format('d F Y')); ?></p>
                        </div>
                        <div class="col-auto">
            ...
            <div class="card summary-card h-100">
                <div class="card-body text-center p-4">
                    <div class="d-flex align-items-center justify-content-center mb-3">
                        ...
                        <div>
                            <div class="fs-2 fw-bold text-primary mb-0"><?php echo e($summary['users_presensi']); ?></div>
            ...
            <div class="card summary-card h-100">
                <div class="card-body text-center p-4">
                    <div class="d-flex align-items-center justify-content-center mb-3">
                        ...
                        <div>
                            <div class="fs-2 fw-bold text-success mb-0"><?php echo e($summary['sekolah_presensi']); ?></div>
            ...
            <div class="card summary-card h-100">
                <div class="card-body text-center p-4">
                    <div class="d-flex align-items-center justify-content-center mb-3">
                        ...
                        <div>
                            <div class="fs-2 fw-bold text-danger mb-0"><?php echo e($summary['guru_tidak_presensi']); ?></div>
        ...
        <?php if($kabupatenMadrasahData->count() > 0): ?>
            ...
            <div class="kabupaten-header">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="mb-1 text-primary"><?php echo e($kabupaten); ?></h5>
                        <small class="text-muted"><?php echo e($kabupatenMadrasahData->count()); ?> Madrasah</small>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card madrasah-card h-100">
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="flex-grow-1">
                                <h6 class="card-title mb-1">
                                    ...
                                    <span class="madrasah-detail-link fw-medium" data-madrasah-id="<?php echo e($data['madrasah']->id); ?>" data-madrasah-name="<?php echo e($data['madrasah']->name); ?>">
                                ...
                                <div class="d-flex align-items-center text-muted small">
                                    ...
                                    <?php echo e(count($data['presensi'])); ?> Tenaga Pendidik
                                </div>
                            </div>
                            <?php if($user->role === 'super_admin'): ?>
                            <div class="flex-shrink-0">
                                <button type="button" class="btn btn-outline-primary btn-sm rounded-pill px-3" data-bs-toggle="modal" data-bs-target="#exportModal" data-madrasah-id="<?php echo e($data['madrasah']->id); ?>" data-madrasah-name="<?php echo e($data['madrasah']->name); ?>">
                                    <i class="bx bx-download me-1"></i>Export
                                </button>
                            </div>
                            <?php endif; ?>
                        ...
                        <div class="card-body p-3">
                            <?php if(count($data['presensi']) > 0): ?>
                                <div class="table-responsive" style="max-height: 250px; overflow-y: auto;">
                                    <table class="table table-sm table-borderless">
                                        <tbody>
                                            <?php $__currentLoopData = $data['presensi']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $presensi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="border-bottom border-light">
                                                <td class="ps-0 py-2">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <span class="user-detail-link fw-medium small" data-user-id="<?php echo e($presensi['user_id'] ?? ''); ?>" data-user-name="<?php echo e($presensi['nama']); ?>">
                                                                <?php echo e($presensi['nama']); ?>
                                                ...
                                                <td class="pe-0 py-2 text-end">
                                                    ...
                                                    <?php endif; ?>
                                                    <?php if(isset($presensi['is_fake_location']) && $presensi['is_fake_location']): ?>
...
$(document).ready(function () {
    ...
    $(document).on('click', '.madrasah-detail-link', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(url('/presensi-admin/madrasah-detail')); ?>/' + madrasahId,
            type: 'GET',
            data: { date: currentDate },
            success: function(data) {
