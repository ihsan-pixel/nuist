<?php $__env->startSection('title', 'Instrumen Penilaian - NUIST'); ?>
<?php $__env->startSection('description', 'Instrumen Penilaian Talenta LPMNU PWNU DIY'); ?>
        ...
        <div id="trainer-section" class="instrumen-section animate fade-up tab-content active">
            <div class="table-container">
                <table class="instrumen-table trainer-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_0 = true; $__currentLoopData = $pemateriTalenta ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $trainer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <tr data-trainer-id="<?php echo e($trainer->id); ?>">
                            <td><?php echo e($index + 1); ?></td>
                            <td class="trainer-name"><?php echo e($trainer->nama ?? 'N/A'); ?></td>
                            <td><?php echo e($trainer->kode_pemateri ?? 'N/A'); ?></td>
                            <td><?php echo e($trainer->materi->nama_materi ?? 'N/A'); ?></td>
                            ...
                            <td class="rating-cell">
                                <div class="rating-scale">
                                    ...
                                    <span class="rating-option" data-trainer="<?php echo e($trainer->id); ?>" data-aspek="<?php echo e($aspek); ?>" data-nilai="<?php echo e($nilai); ?>"><?php echo e($nilai); ?></span>
            ...
            <div class="table-container">
                <table class="instrumen-table fasilitator-table">
                    ...
                    <tbody>
                        ...
                        <tr data-fasilitator-id="<?php echo e($fasilitator->id); ?>">
                            <td><?php echo e($index + 1); ?></td>
                            <td class="fasilitator-name"><?php echo e($fasilitator->nama ?? 'N/A'); ?></td>
                            <td><?php echo e($fasilitator->kode_fasilitator ?? 'N/A'); ?></td>
                            <td><?php echo e($fasilitator->materi->nama_materi ?? 'N/A'); ?></td>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($aspek = 1; $aspek <= 6; $aspek++): ?>
                            <td class="rating-cell">
                                <div class="rating-scale">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($nilai = 1; $nilai <= 5; $nilai++): ?>
                                    <span class="rating-option" data-fasilitator="<?php echo e($fasilitator->id); ?>" data-aspek="<?php echo e($aspek); ?>" data-nilai="<?php echo e($nilai); ?>"><?php echo e($nilai); ?></span>
                                    <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </div>
                            </td>
                            <?php endfor; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div id="teknis-section" class="instrumen-section animate fade-up delay-2 tab-content" style="display: none;">
            <div class="table-container">
                <table class="instrumen-table teknis-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_0 = true; $__currentLoopData = $layananTeknisTalenta ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $teknis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/nuist/resources/views/talenta/instrumen-penilaian.blade.php ENDPATH**/ ?>