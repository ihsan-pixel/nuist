...
<?php $__env->startSection('css'); ?>
    <!-- Plugins css -->
    <link href="<?php echo e(asset('build/libs/bootstrap-editable/css/bootstrap-editable.css')); ?>" rel="stylesheet" type="text/css" />
...
<?php $__env->startSection('script'); ?>
    <!-- Plugins js -->
    <script src="<?php echo e(asset('build/libs/bootstrap-editable/js/index.js')); ?>"></script>
    <script src="<?php echo e(asset('build/libs/moment/min/moment.min.js')); ?>"></script>

    <!-- Init js-->
    <script src="<?php echo e(asset('build/js/pages/form-xeditable.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/form-xeditable.blade.php ENDPATH**/ ?>