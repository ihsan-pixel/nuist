...
window.addEventListener('load', function() {
    ...
    function showFaceScanRetryButton(label = 'Ulangi Scan') {
        ...
        captureBtn.innerHTML = `<i class="bx bx-error-circle me-1"></i>${label}`;
    }
    ...
    async function captureSelfie() {
        ...
        try {
            ...
            if (faceScanRequired) {
                ...
                sendFaceDiagnostic({
                    user_id: <?php echo json_encode(optional(Auth::user())->id, 15, 512) ?>,
                    source: 'presensi',
                    outcome: 'success',
                    stage: 'scan',
...
<?php echo $__env->make('layouts.mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/mobile/presensi.blade.php ENDPATH**/ ?>