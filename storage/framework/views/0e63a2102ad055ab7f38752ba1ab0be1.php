        ...
        <?php else: ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($presensis->hasPages()): ?>
                <div class="mobile-pagination">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($presensis->onFirstPage()): ?>
                        <span class="mobile-page-btn disabled">
                            <i class="bx bx-chevron-left"></i>
                            Sebelumnya
                        </span>
                    <?php else: ?>
                        <a href="<?php echo e($presensis->previousPageUrl()); ?>" class="mobile-page-btn">
                            <i class="bx bx-chevron-left"></i>
                            Sebelumnya
                        </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mobile-page-meta">
                        <strong><?php echo e($presensis->currentPage()); ?>/<?php echo e($presensis->lastPage()); ?></strong>
                        <small><?php echo e($presensis->firstItem()); ?>-<?php echo e($presensis->lastItem()); ?> dari <?php echo e($presensis->total()); ?></small>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($presensis->hasMorePages()): ?>
                        <a href="<?php echo e($presensis->nextPageUrl()); ?>" class="mobile-page-btn next">
                            Berikutnya
                            <i class="bx bx-chevron-right"></i>
                        </a>
                    <?php else: ?>
    ...
    <div class="presensi-section">
        ...
        <?php else: ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($belumPresensi->hasPages()): ?>
                <div class="mobile-pagination">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($belumPresensi->onFirstPage()): ?>
                        <span class="mobile-page-btn disabled">
                            <i class="bx bx-chevron-left"></i>
                            Sebelumnya
                        </span>
                    <?php else: ?>
                        <a href="<?php echo e($belumPresensi->previousPageUrl()); ?>" class="mobile-page-btn">
                            <i class="bx bx-chevron-left"></i>
                            Sebelumnya
                        </a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mobile-page-meta">
                        <strong><?php echo e($belumPresensi->currentPage()); ?>/<?php echo e($belumPresensi->lastPage()); ?></strong>
                        <small><?php echo e($belumPresensi->firstItem()); ?>-<?php echo e($belumPresensi->lastItem()); ?> dari <?php echo e($belumPresensi->total()); ?></small>
                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($belumPresensi->hasMorePages()): ?>
                        <a href="<?php echo e($belumPresensi->nextPageUrl()); ?>" class="mobile-page-btn next">
                            Berikutnya
                            <i class="bx bx-chevron-right"></i>
                        </a>
                    <?php else: ?>
...
<?php echo $__env->make('layouts.mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/mobile/monitor-presensi.blade.php ENDPATH**/ ?>