        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="catatan" name="catatan" rows="3" placeholder="Tambahkan catatan jika diperlukan"><?php echo e(old('catatan', $setting->catatan ?? '')); ?></textarea>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/uppm/form.blade.php ENDPATH**/ ?>