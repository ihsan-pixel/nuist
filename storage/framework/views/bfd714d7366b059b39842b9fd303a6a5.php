...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
    ...
    ?>
    <button type="button" class="bpp-agenda-card" data-bs-toggle="modal" data-bs-target="#bpp-sheet-<?php echo e($event->id); ?>" aria-haspopup="dialog" aria-controls="bpp-sheet-<?php echo e($event->id); ?>">
        <span class="bpp-agenda-date">
            <strong><?php echo e($event->start_at->format('d')); ?></strong>
            <small><?php echo e($event->start_at->locale('id')->translatedFormat('M')); ?></small>
        </span>
        <span class="bpp-agenda-info">
            <span class="bpp-agenda-name"><?php echo e($event->name); ?></span>
            <span class="bpp-agenda-meta"><?php echo e($event->start_at->format('H:i')); ?> – <?php echo e($event->end_at->format('H:i')); ?> WIB</span>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$event->start_at->isSameDay($event->end_at)): ?>
                <span class="bpp-agenda-meta">Sampai <?php echo e($event->end_at->locale('id')->translatedFormat('d M Y')); ?></span>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <span class="bpp-agenda-meta"><?php echo e($event->location_name); ?></span>
            <span class="bpp-status bpp-status--<?php echo e($status); ?>"><?php echo e($statusLabel); ?></span>
        </span>
        <i class="bx bx-chevron-right bpp-agenda-chevron" aria-hidden="true"></i>
    </button>

    <div class="modal fade bpp-sheet" id="bpp-sheet-<?php echo e($event->id); ?>" tabindex="-1" aria-labelledby="bpp-sheet-title-<?php echo e($event->id); ?>" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 class="bpp-sheet-title" id="bpp-sheet-title-<?php echo e($event->id); ?>"><?php echo e($event->name); ?></h2>
                    <dl class="bpp-sheet-details">
                        <dt>Tanggal</dt>
                        <dd><?php echo e($event->start_at->locale('id')->translatedFormat('l, d F Y')); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$event->start_at->isSameDay($event->end_at)): ?> – <?php echo e($event->end_at->locale('id')->translatedFormat('l, d F Y')); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></dd>
                        <dt>Waktu</dt>
                        <dd><?php echo e($event->start_at->format('H:i')); ?> – <?php echo e($event->end_at->format('H:i')); ?> WIB</dd>
                        <dt>Lokasi</dt>
                        <dd><?php echo e($event->location_name); ?></dd>
                        <dt>Penyelenggara</dt>
...
<?php echo $__env->make('mobile.bpppmnu.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/mobile/bpppmnu/index.blade.php ENDPATH**/ ?>