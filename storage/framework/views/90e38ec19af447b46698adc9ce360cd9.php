<?php $__env->startSection('title', 'Dashboard PPDB - Super Admin'); ?>
...
<div class="container-fluid py-4">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 text-lg-end">
                        <div class="d-flex align-items-center justify-content-lg-end">
                            ...
                            <span class="fw-semibold">Tahun <?php echo e(date('Y')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <p class="text-muted mb-0">Data pendaftaran siswa baru tahun <?php echo e(date('Y')); ?></p>
                    </div>
                    <div class="avatar-lg">
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="stat-card h-100 hover-lift total-sekolah">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="text-white mb-1"><?php echo e(number_format($statistik['total_sekolah'])); ?></h3>
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="stat-card h-100 hover-lift total-pendaftar">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="text-white mb-1"><?php echo e(number_format($statistik['total_pendaftar'])); ?></h3>
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="stat-card h-100 hover-lift sekolah-buka">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="text-white mb-1"><?php echo e(number_format($statistik['total_buka'])); ?></h3>
                        ...
                        <div class="mt-3">
                            <div class="progress bg-white bg-opacity-25" style="height: 4px;">
                                <div class="progress-bar bg-white" style="width: <?php echo e($statistik['total_sekolah'] > 0 ? round(($statistik['total_buka'] / $statistik['total_sekolah']) * 100) : 0); ?>%"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="stat-card h-100 hover-lift pending">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="text-white mb-1"><?php echo e(number_format($statistik['pending'])); ?></h3>
                        ...
                        <div class="mt-3">
                            <div class="progress bg-white bg-opacity-25" style="height: 4px;">
                                <div class="progress-bar bg-white" style="width: <?php echo e($statistik['total_pendaftar'] > 0 ? round(($statistik['pending'] / $statistik['total_pendaftar']) * 100) : 0); ?>%"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="stat-card h-100 hover-lift verifikasi">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h4 class="text-dark mb-1"><?php echo e(number_format($statistik['verifikasi'])); ?></h4>
            ...
            <div class="col-lg-4">
                <div class="stat-card h-100 hover-lift lulus">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h4 class="text-white mb-1"><?php echo e(number_format($statistik['lulus'])); ?></h4>
            ...
            <div class="col-lg-4">
                <div class="stat-card h-100 hover-lift tidak-lulus">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h4 class="text-white mb-1"><?php echo e(number_format($statistik['tidak_lulus'])); ?></h4>
    ...
    <div class="section-wrapper">
        <div class="animate-slide-up">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $groupedByKabupaten; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kabupaten => $sekolahs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <?php
                    $kabupatenStats = [
                    ...
                    <div class="kabupaten-header">
                        ...
                        <div class="ms-auto">
                            <small class="badge bg-primary bg-opacity-10 text-primary me-2">
                                <?php echo e($kabupatenStats['total_madrasah']); ?> Madrasah
                            </small>
                            <small class="badge bg-primary bg-opacity-10 text-primary">
                                <?php echo e($kabupatenStats['total_pendaftar']); ?> Pendaftar
                            </small>
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-2 col-6">
                                <div class="text-center">
                                    <div class="fw-bold text-dark"><?php echo e($kabupatenStats['total_buka']); ?></div>
                                    <small class="text-muted">PPDB Aktif</small>
                                </div>
                            </div>
                            <div class="col-md-2 col-6">
                                <div class="text-center">
                                    <div class="fw-bold text-dark"><?php echo e($kabupatenStats['total_lulus']); ?></div>
                                    <small class="text-muted">Lulus</small>
                                </div>
                            </div>
                            <div class="col-md-2 col-6">
                                <div class="text-center">
                                    <div class="fw-bold text-dark"><?php echo e($kabupatenStats['total_pending']); ?></div>
                                    <small class="text-muted">Pending</small>
                                </div>
                            </div>
                            <div class="col-md-2 col-6">
                                <div class="text-center">
                                    <div class="fw-bold text-dark"><?php echo e($kabupatenStats['total_verifikasi']); ?></div>
                            ...
                            <div class="col-md-2 col-6">
                                <div class="text-center">
                                    <div class="fw-bold text-dark">
                                        <?php echo e($kabupatenStats['total_pendaftar'] > 0 ? round(($kabupatenStats['total_lulus'] / $kabupatenStats['total_pendaftar']) * 100, 1) : 0); ?>%
                                    </div>
                            ...
                            <div class="col-md-2 col-6">
                                <div class="text-center">
                                    <div class="fw-bold text-dark"><?php echo e($kabupatenStats['total_madrasah']); ?></div>
                    ...
                    <div class="kabupaten-table">
                        <div class="table-responsive">
                            <table class="table table-hover mb-0">
                                ...
                                <tbody>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $sekolahs->sortBy(function($item) {
                                        return $item['sekolah']->name;
                                    }); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <tr>
                                        <td>
                                            <div class="sekolah-name"><?php echo e($detail['sekolah']->name); ?></div>
                                        ...
                                        <td>
                                            ...
                                            <?php elseif($detail['status_ppdb'] === 'belum_buka'): ?>
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-warning"><?php echo e(number_format($detail['pending'])); ?></span>
                                        </td>
                                        <td class="text-center">
                                            <span class="badge bg-info"><?php echo e(number_format($detail['verifikasi'])); ?></span>
                                        </td>
                                        <td class="text-center">
                                            <span class="badge bg-success"><?php echo e(number_format($detail['lulus'])); ?></span>
                                        </td>
                                        <td class="text-center">
                                            <span class="badge bg-danger"><?php echo e(number_format($detail['tidak_lulus'])); ?></span>
                                        </td>
                                        <td class="text-center">
                                            <span class="badge <?php echo e($detail['total'] > 0 ? ($detail['lulus'] / $detail['total'] > 0.5 ? 'bg-success' : 'bg-warning') : 'bg-secondary'); ?>">
                                                <?php echo e($detail['total'] > 0 ? round(($detail['lulus'] / $detail['total']) * 100, 1) : 0); ?>%
                                            </span>
                                        </td>
                                        <td>
                                            <div class="d-flex gap-1 flex-wrap">
                                                ...
                                                <?php elseif($detail['status_ppdb'] === 'buka'): ?>
                                                    <span class="badge badge-warning">Slug Kosong</span>
                                                <?php else: ?>
                                                    
                                                    <span class="badge badge-<?php echo e($detail['status_ppdb']); ?>" title="Status PPDB: <?php echo e(ucfirst($detail['status_ppdb'])); ?>">
                                                ...
                                                <a href="<?php echo e(route('ppdb.lp.edit', $detail['sekolah']->id)); ?>" class="btn btn-outline-primary btn-sm">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    statusChartInstance = new Chart(canvas.getContext('2d'), {
        ...
        data: {
            ...
            datasets: [{
                data: [
                    <?php echo e($statistik['pending']); ?>,
                    <?php echo e($statistik['verifikasi']); ?>,
                    <?php echo e($statistik['lulus']); ?>,
                    <?php echo e($statistik['tidak_lulus']); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/ppdb/dashboard/lp.blade.php ENDPATH**/ ?>