<?php $__env->startSection('title', 'Detail Madrasah - ' . $madrasah->name); ?>
...
<link href="<?php echo e(asset('build/libs/admin-resources/rwd-table/rwd-table.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($user->role, ['super_admin', 'pengurus', 'admin', 'admin_yayasan'])): ?>
    ...
    <div class="welcome-section mb-4" style="background: linear-gradient(135deg, #004b4c 0%, #0e8549 100%) !important; border-radius: 15px !important; padding: 2rem !important; margin-bottom: 2rem !important; color: white !important; position: relative !important; overflow: hidden !important; box-shadow: 0 4px 15px rgba(0, 75, 76, 0.2) !important;">
        <div class="welcome-content" style="position: relative !important; z-index: 1 !important;">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    <h2 class="mb-2">
                        <i class="mdi mdi-school me-2"></i>Detail Madrasah: <?php echo e($madrasah->name); ?>

                    </h2>
                    <p class="mb-0 opacity-75">Pantau dan kelola presensi tenaga pendidik di <?php echo e($madrasah->name); ?></p>
                </div>
                <div class="col-lg-4 text-lg-end">
                    ...
                    <div class="d-flex gap-2 mt-3">
                        ...
                        <a href="<?php echo e(route('presensi_admin.index')); ?>" class="btn btn-success btn-sm rounded-pill px-3">
                            Kembali
                        </a>
                    </div>
                </div>
                ...
                <div class="stat-card h-100 hover-lift total-sekolah" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%) !important; border-radius: 15px !important; padding: 1.5rem !important; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1) !important; border: none !important; transition: all 0.3s ease !important; position: relative !important; overflow: hidden !important; color: white !important;">
                    <div class="card-body p-4" style="padding: 1.5rem !important;">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="text-white mb-1" style="color: white !important;"><?php echo e($tenagaPendidik->total()); ?></h3>
            ...
            <div class="col-lg-3">
                <div class="stat-card h-100 hover-lift sekolah-buka" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%) !important; border-radius: 15px !important; padding: 1.5rem !important; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1) !important; border: none !important; transition: all 0.3s ease !important; position: relative !important; overflow: hidden !important; color: white !important;">
                    <div class="card-body p-4" style="padding: 1.5rem !important;">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="text-white mb-1" style="color: white !important;"><?php echo e($tenagaPendidikData->where('status', 'hadir')->count()); ?></h3>
                        ...
                        <div class="mt-3">
                            <div class="progress bg-white bg-opacity-25" style="height: 4px !important; background: rgba(255, 255, 255, 0.25) !important;">
                                <div class="progress-bar bg-white" style="width: <?php echo e($tenagaPendidik->total() > 0 ? round(($tenagaPendidikData->where('status', 'hadir')->count() / $tenagaPendidik->total()) * 100) : 0); ?>% !important; background: white !important;"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3">
                <div class="stat-card h-100 hover-lift" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%) !important; border-radius: 15px !important; padding: 1.5rem !important; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1) !important; border: none !important; transition: all 0.3s ease !important; position: relative !important; overflow: hidden !important; color: white !important;">
                    <div class="card-body p-4" style="padding: 1.5rem !important;">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="text-white mb-1" style="color: white !important;"><?php echo e($tenagaPendidikData->where('status', 'izin')->count()); ?></h3>
                        ...
                        <div class="mt-3">
                            <div class="progress bg-white bg-opacity-25" style="height: 4px !important; background: rgba(255, 255, 255, 0.25) !important;">
                                <div class="progress-bar bg-white" style="width: <?php echo e($tenagaPendidik->total() > 0 ? round(($tenagaPendidikData->where('status', 'izin')->count() / $tenagaPendidik->total()) * 100) : 0); ?>% !important; background: white !important;"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3">
                <div class="stat-card h-100 hover-lift pending" style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%) !important; border-radius: 15px !important; padding: 1.5rem !important; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.1) !important; border: none !important; transition: all 0.3s ease !important; position: relative !important; overflow: hidden !important; color: white !important;">
                    <div class="card-body p-4" style="padding: 1.5rem !important;">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h3 class="text-white mb-1" style="color: white !important;"><?php echo e($tenagaPendidikData->where('status', 'tidak_hadir')->count()); ?></h3>
                        ...
                        <div class="mt-3">
                            <div class="progress bg-white bg-opacity-25" style="height: 4px !important; background: rgba(255, 255, 255, 0.25) !important;">
                                <div class="progress-bar bg-white" style="width: <?php echo e($tenagaPendidik->total() > 0 ? round(($tenagaPendidikData->where('status', 'tidak_hadir')->count() / $tenagaPendidik->total()) * 100) : 0); ?>% !important; background: white !important;"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="info-card">
                    ...
                    <div class="info-item">
                        ...
                        <span class="info-value"><?php echo e($madrasah->name); ?></span>
                    </div>
                    <div class="info-item">
                ...
                <div class="info-card">
                    ...
                    <div class="attendance-summary" style="display: grid; grid-template-columns: 1fr 1fr; gap: 6px;">
                        <div style="background: rgba(14, 133, 73, 0.1); padding: 8px; border-radius: 6px; text-align: center;">
                            <div id="attendance-present-count" style="font-weight: 600; font-size: 14px; color: #0e8549;"><?php echo e($tenagaPendidikData->where('status', 'hadir')->count()); ?></div>
                        ...
                        <div style="background: rgba(220, 53, 69, 0.1); padding: 8px; border-radius: 6px; text-align: center;">
                            <div id="attendance-absent-count" style="font-weight: 600; font-size: 14px; color: #dc3545;"><?php echo e($tenagaPendidikData->where('status', 'tidak_hadir')->count()); ?></div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <strong>Nama Madrasah:</strong> <?php echo e($madrasah->name); ?>

                            </div>
                            <div class="mb-3">
                                <strong>SCOD:</strong> <?php echo e($madrasah->scod ?? '-'); ?>

                            </div>
                            <div class="mb-3">
                                <strong>Kabupaten:</strong> <?php echo e($madrasah->kabupaten ?? '-'); ?>

                            </div>
                            <div class="mb-3">
                                <strong>Alamat Lengkap:</strong> <?php echo e($madrasah->alamat ?? '-'); ?>

                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <strong>Hari KBM:</strong> <?php echo e($madrasah->hari_kbm ?? '-'); ?>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <form method="GET" action="<?php echo e(route('presensi_admin.show_detail', $madrasah->id)); ?>" class="d-flex align-items-center gap-3 flex-wrap">
                                <label for="date" class="form-label mb-0 fw-semibold">Pilih Tanggal:</label>
                                <input type="date" name="date" id="date" class="form-control" style="max-width: 200px;" value="<?php echo e($selectedDate->format('Y-m-d')); ?>" onchange="this.form.submit()">
                                <input type="text" name="search" class="form-control" placeholder="Cari nama, NIP, NUPTK..." value="<?php echo e($search); ?>" style="max-width: 250px;">
                                <input type="hidden" name="summary_period" value="<?php echo e($summaryPeriod); ?>">
                                <input type="hidden" name="week" value="<?php echo e($selectedWeek->format('o-\\WW')); ?>">
                                <input type="hidden" name="month" value="<?php echo e($selectedMonth->format('Y-m')); ?>">
                                <button type="submit" class="btn btn-primary">
                                    <i class="mdi mdi-magnify"></i> Cari
                                </button>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search): ?>
                                    <a href="<?php echo e(route('presensi_admin.show_detail', $madrasah->id)); ?>?date=<?php echo e($selectedDate->format('Y-m-d')); ?>&summary_period=<?php echo e($summaryPeriod); ?>&week=<?php echo e($selectedWeek->format('o-\\WW')); ?>&month=<?php echo e($selectedMonth->format('Y-m')); ?>" class="btn btn-outline-secondary">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                        ...
                                        <span id="attendance-total-count" class="badge bg-primary ms-2"><?php echo e($tenagaPendidik->total()); ?> Orang</span>
                                        </h5>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    <table id="attendance-datatable" class="table table-bordered dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $tenagaPendidikData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                            <tr>
                                                <?php
                                                ...
                                                <td class="text-center">
                                                    <form method="POST"
                                                          action="<?php echo e(route('presensi_admin.reset_face', ['madrasahId' => $madrasah->id, 'userId' => $tp['id']])); ?>"
                                                          onsubmit="return confirm('Reset data wajah <?php echo e($tp['nama']); ?>? User harus mendaftar wajah ulang.');">
                                                        <?php echo csrf_field(); ?>
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap gap-3 mb-4">
                                    <div>
                                        <h5 class="card-title mb-1">
                                            <i class="mdi mdi-chart-box-outline me-2"></i>Persentase Presensi <?php echo e($summaryLabel); ?> Tenaga Pendidik
                                        </h5>
                                        <p class="text-muted mb-0">
                                            Periode <?php echo e($summaryStartDate->translatedFormat('d M Y')); ?> - <?php echo e($summaryEndDate->copy()->min(\Illuminate\Support\Carbon::today('Asia/Jakarta'))->translatedFormat('d M Y')); ?>

                                        </p>
                                    </div>

                                    <form method="GET" action="<?php echo e(route('presensi_admin.show_detail', $madrasah->id)); ?>" class="d-flex align-items-end gap-3 flex-wrap">
                                        ...
                                        <div>
                                            ...
                                            <select name="summary_period" id="summary_period" class="form-select">
                                                <option value="week" <?php echo e($summaryPeriod === 'week' ? 'selected' : ''); ?>>Per Minggu</option>
                                                <option value="month" <?php echo e($summaryPeriod === 'month' ? 'selected' : ''); ?>>Per Bulan</option>
                                            </select>
                                        </div>

                                        <div id="week-filter-wrapper" style="<?php echo e($summaryPeriod === 'week' ? '' : 'display:none;'); ?>">
                                            <label for="summary_week" class="form-label fw-semibold mb-1">Minggu</label>
                                            <input type="week" name="week" id="summary_week" class="form-control" value="<?php echo e($selectedWeek->format('o-\\WW')); ?>">
                                        </div>

                                        <div id="month-filter-wrapper" style="<?php echo e($summaryPeriod === 'month' ? '' : 'display:none;'); ?>">
                                            <label for="summary_month" class="form-label fw-semibold mb-1">Bulan</label>
                                            <input type="month" name="month" id="summary_month" class="form-control" value="<?php echo e($selectedMonth->format('Y-m')); ?>">
                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <small class="text-muted">
                                                            NIP: <?php echo e($row['nip'] ?: '-'); ?> | NUPTK: <?php echo e($row['nuptk'] ?: '-'); ?>

                                                        </small>
                                                    </td>
                                                    <td><?php echo e($row['status_kepegawaian']); ?></td>
                                                    <td class="text-center"><?php echo e($row['total_hari_kerja']); ?></td>
                                                    <td class="text-center"><span class="badge bg-success"><?php echo e($row['total_hadir']); ?></span></td>
                                                    <td class="text-center"><span class="badge bg-info text-white"><?php echo e($row['total_izin']); ?></span></td>
                                                    <td class="text-center"><span class="badge bg-danger"><?php echo e($row['total_belum_hadir']); ?></span></td>
                                                    <td class="text-center">
                                                        <?php
                                                        ...
                                                        ?>
                                                        <span class="badge <?php echo e($percentageClass); ?>">
                                                            <?php echo e(number_format($row['persentase_kehadiran'], 1)); ?>%
                                                        </span>
                                                    </td>
                                                </tr>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<div class="modal fade" id="exportModal" tabindex="-1" aria-labelledby="exportModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="<?php echo e(route('presensi_admin.export_excel')); ?>" method="GET">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3" id="bulan-wrapper" style="display:none;">
                        ...
                        <select class="form-select" name="bulan">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $bulanTersedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
...
$(document).ready(function() {
    ...
    const selectedDate = '<?php echo e($selectedDate->format('Y-m-d')); ?>';
    const detailUrl = '<?php echo e(route('presensi_admin.madrasah_detail', $madrasah->id)); ?>';
    ...
    try {
        ...
        if (mapContainer && typeof L !== 'undefined') {
            var map = L.map('school-map', {
                center: [<?php echo e($madrasah->latitude); ?>, <?php echo e($madrasah->longitude); ?>],
                zoom: 15,
                zoomControl: true,
            ...
            var schoolMarker = L.marker([<?php echo e($madrasah->latitude); ?>, <?php echo e($madrasah->longitude); ?>], {icon: schoolIcon})
                .addTo(map)
                .bindPopup('<div style="text-align: center; padding: 5px;"><b><?php echo e(addslashes($madrasah->name)); ?></b><br><small>Lokasi Madrasah</small></div>');

            var markers = [schoolMarker];

            // Add attendance location markers
            <?php if(count($tenagaPendidikData) > 0): ?>
                <?php $__currentLoopData = $tenagaPendidikData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <?php if($lat && $lng): ?>
                        var attendanceIcon = L.divIcon({
                            html: '<div style="width: 14px; height: 14px; border-radius: 50%; background: <?php echo e($isPresent ? '#0e8549' : '#dc3545'); ?>; border: 2px solid white; box-shadow: 0 0 6px rgba(0,0,0,0.3);"></div>',
                            className: 'custom-attendance-marker',
                            iconSize: [14, 14],
                            iconAnchor: [7, 7]
                        });

                        var attendanceMarker = L.marker([<?php echo e($lat); ?>, <?php echo e($lng); ?>], {icon: attendanceIcon})
                            .addTo(map)
                            .bindPopup(
                                '<div style="font-family: \'Poppins\', sans-serif; font-size: 12px; max-width: 220px; padding: 5px;">' +
                                '<strong style="color: #004b4c;"><?php echo e(addslashes($tp['nama'])); ?></strong><br>' +
                                '<small style="color: #666;"><?php echo e($tp['status_kepegawaian'] ?? '-'); ?></small><br>' +
                                '<small><strong>Status:</strong> <span style="color: <?php echo e($isPresent ? '#0e8549' : '#dc3545'); ?>;"><?php echo e($isPresent ? 'Sudah Presensi' : 'Belum Presensi'); ?></span></small><br>' +
                                <?php if($isPresent): ?>
                                '<small><strong>Masuk:</strong> <?php echo e($tp['waktu_masuk'] ?? '-'); ?></small><br>' +
                                '<small><strong>Keluar:</strong> <?php echo e($tp['waktu_keluar'] ?? '-'); ?></small><br>' +
                                <?php endif; ?>
                                '<small><strong>Lokasi:</strong> <?php echo e(addslashes($tp['lokasi'] ?? 'Lokasi tidak tersedia')); ?></small>' +
                                '</div>'
                            );
...
$('#download-pdf-btn').on('click', function() {
    ...
    if (selectedBulan) {
        var url = '/presensi/rekap/pdf/<?php echo e($madrasah->id); ?>/' + selectedBulan;
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/presensi_admin/detail.blade.php ENDPATH**/ ?>