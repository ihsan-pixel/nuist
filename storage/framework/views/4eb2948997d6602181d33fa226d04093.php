        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                                        ...
                                        <li>
                                            <form method="POST"
                                                ...
                                                <button type="submit" class="dropdown-item">
                                                    <i class="bx bx-printer me-2 text-primary"></i><?php echo e($schoolHasLockedNumbers ? 'Generate Semua Guru Sekolah Ini' : 'Preview Semua Guru Sekolah Ini'); ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$schoolHasLockedNumbers): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($submission->resolved_template): ?>
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($submission->template_mismatch && $submission->stored_template): ?>
                                                        <small class="text-warning d-block mt-1">
                                                            Draft tersimpan sebelumnya memakai template <strong><?php echo e($submission->stored_template->name); ?></strong>.
                                                            Generate ulang untuk menyamakan dengan keterangan pengajuan saat ini.
                                                        </small>
                                                    <?php elseif($submission->stored_template && $submission->document?->number_locked_at): ?>
                                                        <small class="text-muted d-block mt-1">
                                                            Template dokumen terkunci: <strong><?php echo e($submission->stored_template->name); ?></strong>
                                                        </small>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <?php else: ?>
                                            ...
                                            <td>
                                                <div class="d-flex flex-wrap gap-2">
                                                    <form method="POST" action="<?php echo e(route('sk-yayasan.generate.store')); ?>" data-sk-pdf-post>
                                                        <?php echo csrf_field(); ?>
                                                        ...
                                                        <button type="submit" class="btn btn-sm btn-outline-primary" <?php if(!$submission->resolved_template && !$submission->template_id): echo 'disabled'; endif; ?>>
                                                            <?php echo e($schoolHasLockedNumbers ? 'Generate 1 Guru' : 'Preview 1 Guru'); ?>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/sk-yayasan/generate-school-index.blade.php ENDPATH**/ ?>