...
<?php $__env->startSection('css'); ?>
    <!-- ION Slider -->
    <link href="<?php echo e(asset('build/libs/ion-rangeslider/css/ion.rangeSlider.min.css')); ?>" rel="stylesheet" type="text/css" />
<?php $__env->stopSection(); ?>
            ...
            <div class="row" id="product-list">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                ...
                                <img src="<?php echo e(asset('build/images/product/img-1.png')); ?>" alt=""
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                <img src="<?php echo e(asset('build/images/product/img-2.png')); ?>" alt=""
                                    class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                ...
                                <img src="<?php echo e(asset('build/images/product/img-3.png')); ?>" alt=""
                                    class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                <img src="<?php echo e(asset('build/images/product/img-4.png')); ?>" alt=""
                                    class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="product-img position-relative">
                                ...
                                <img src="<?php echo e(asset('build/images/product/img-5.png')); ?>" alt=""
                                    class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
                                <h5 class="mb-3 text-truncate"><a href="javascript: void(0);" class="text-dark">Half
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="product-img position-relative">
                                ...
                                <img src="<?php echo e(asset('build/images/product/img-6.png')); ?>" alt=""
                                    class="img-fluid mx-auto d-block">
                            </div>
                            <div class="mt-4 text-center">
...
<?php $__env->startSection('script'); ?>
    <!-- Ion Range Slider-->
    <script src="<?php echo e(asset('build/libs/ion-rangeslider/js/ion.rangeSlider.min.js')); ?>"></script>

    <!-- init js -->
    <script src="<?php echo e(asset('build/js/pages/product-list.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/ecommerce-products.blade.php ENDPATH**/ ?>