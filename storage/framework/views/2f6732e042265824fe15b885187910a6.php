        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div>
                ...
                <p class="mb-0 text-white-50">
                    Dashboard ini menampilkan ringkasan dan kondisi terkini untuk <?php echo e($scopeLabel); ?>.
                </p>
            </div>
            <div class="d-flex flex-wrap gap-2">
                ...
                <a href="<?php echo e(route('mgmp.laporan')); ?>" class="btn btn-light">
            ...
            <div class="card mgmp-stat-card p-3 h-100">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="h5 mb-0"><?php echo e($memberCount ?? 0); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card mgmp-stat-card p-3 h-100">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="h5 mb-0"><?php echo e($totalSchools ?? 0); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card mgmp-stat-card p-3 h-100">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <div class="h5 mb-0"><?php echo e($proposalCount ?? 0); ?></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm h-100 overflow-hidden">
                <div class="p-4 text-white" style="background: linear-gradient(135deg, #0e8549 0%, #0b6b4d 100%);">
                    <div class="d-flex align-items-center">
                        <div class="me-3">
                            <div class="avatar-lg profile-user-wid mb-0">
                                <div class="avatar-title bg-white bg-opacity-25 text-white rounded-circle mgmp-avatar-wrap">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mgmpGroup && !empty($mgmpGroup->logo)): ?>
                                        <img src="<?php echo e(url('/uploads/' . $mgmpGroup->logo)); ?>" alt="Logo MGMP" class="mgmp-avatar-image" />
                                    <?php else: ?>
                        ...
                        <div class="grow">
                            ...
                            <p class="mb-1 text-white-50 small"><?php echo e(Auth::user()->email ?? '-'); ?></p>
                ...
                <div class="card-body p-3">
                    <div class="mb-3">
                        ...
                        <h6 class="mb-0"><?php echo e($scopeLabel); ?></h6>
                    </div>
                    <div class="row g-2 mb-3">
                        <div class="col-6">
                            <div class="p-2 bg-light rounded text-center">
                                <div class="text-muted small">Kegiatan</div>
                                <div class="h5 mb-0"><?php echo e($totalReports ?? 0); ?></div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="p-2 bg-light rounded text-center">
                                <div class="text-muted small">Rata-rata Anggota</div>
                                <div class="h5 mb-0"><?php echo e($dashboardSummary['average_members'] ?? '0'); ?></div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="mgmp-spotlight-card h-100">
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <div>
                                                    <h6 class="mb-0"><?php echo e(Str::limit($group->name, 24)); ?></h6>
                                        ...
                                        <div class="mt-3 pt-3 border-top">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($group->latest_report_title): ?>
                                                <div class="fw-semibold"><?php echo e(Str::limit($group->latest_report_title, 42)); ?></div>
                                                <small class="text-muted">
                                                    <?php echo e(optional($group->latest_report_date)->format('d M Y') ?? '-'); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $recentReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <div class="mgmp-timeline-item">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted small"><?php echo e(Str::limit($activity->deskripsi ?? 'Belum ada deskripsi kegiatan.', 100)); ?></div>
                                    </div>
                                </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <a href="<?php echo e(route('mgmp.data-anggota')); ?>" class="btn btn-sm btn-outline-primary">Data Anggota</a>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm align-middle mb-0">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_0 = true; $__currentLoopData = $mgmpInsights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_0 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($group->latest_report_title): ?>
                                                <div class="fw-semibold"><?php echo e(Str::limit($group->latest_report_title, 32)); ?></div>
