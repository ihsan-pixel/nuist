                ...
                <div class="d-flex align-items-center">
                    <div class="me-3">
                            ...
                            <div class="avatar-title bg-white bg-opacity-25 text-white rounded-circle" style="margin-top:20px; width:72px; height:72px; display:flex; align-items:center; justify-content:center; overflow:hidden;">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($mgmpGroup) && $mgmpGroup && !empty($mgmpGroup->logo)): ?>
                                    <img src="<?php echo e(url('/uploads/' . $mgmpGroup->logo)); ?>" alt="Logo MGMP" style="width:64px; height:64px; object-fit:cover; border-radius:50%;" />
                                <?php else: ?>
                    ...
                    <div class="grow">
                        ...
                        <?php if(isset($mgmpGroup) && $mgmpGroup): ?>
                        <div class="mt-2">
                            <small class="text-white-50">Nama MGMP: <strong><?php echo e($mgmpGroup->name); ?></strong></small>
                        </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <small class="text-muted"><?php echo e(isset($recentReports) ? $recentReports->count() : 0); ?> items</small>
                        </div>
                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="grow">
                                            <div class="d-flex justify-content-between">
                                                <h6 class="mb-1"><?php echo e($activity->judul ?? $activity->title ?? $activity->name ?? '-'); ?></h6>
                                                <small class="text-muted"><?php echo e($activity->created_at->diffForHumans()); ?></small>
                                            </div>
                                            <p class="text-muted small mb-0"><?php echo e(Str::limit($activity->deskripsi ?? $activity->description ?? '', 120)); ?></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="table table-sm table-striped mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e(Str::limit($r->judul ?? $r->name ?? $r->title ?? '-', 40)); ?></td>
