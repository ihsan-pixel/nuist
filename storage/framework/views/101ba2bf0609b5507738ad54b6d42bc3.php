...
<head>
    ...
    <title>Billing <?php echo e($selectedTagihan->nomor_tagihan); ?></title>
    <style>
        :root {
            --billing-bg: #eef5ef;
...
<body>
    <div class="page">
        <div class="toolbar">
            <a href="<?php echo e(route('mobile.siswa.detail', $selectedTagihan->id)); ?>" class="btn btn-light">Kembali ke detail</a>
        ...
        <div class="sheet">
            <div class="header">
                ...
                <div style="text-align:right;">
                    ...
                    <strong><?php echo e(now()->translatedFormat('d F Y H:i')); ?></strong>
                </div>
            </div>
            ...
            <div class="grid">
                <div class="box">
                    ...
                    <strong><?php echo e($studentRecord->nama_lengkap ?? $studentUser->name); ?></strong>
                </div>
                <div class="box">
                    <small>NIS</small>
                ...
                <div class="box">
                    ...
                    <strong><?php echo e(optional($selectedTagihan->jatuh_tempo)->translatedFormat('d F Y')); ?></strong>
                </div>
                <div class="box">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($billingTransaction && $billingTransaction->va_number): ?>
                <div class="va-card">
                    <small>BNI Virtual Account</small>
                    <div class="va-number"><?php echo e($billingTransaction->va_number); ?></div>
                    <small>Berlaku sampai <?php echo e(optional($billingTransaction->va_expired_at)->translatedFormat('d F Y H:i') ?? '-'); ?></small>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <div class="notes">
                <h4>Instruksi Pembayaran</h4>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($selectedTagihan->setting->payment_provider ?? 'manual') === 'bni_va' && $billingTransaction): ?>
                    <ol>
                        ...
                        <li>Bayar sesuai nominal tagihan: Rp <?php echo e(number_format($selectedTagihan->total_tagihan, 0, ',', '.')); ?>.</li>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedTagihan->setting?->payment_notes): ?>
                    <p style="margin-top:16px;"><strong>Catatan:</strong> <?php echo e($selectedTagihan->setting->payment_notes); ?></p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedTagihan->catatan): ?>
                    <p style="margin-top:10px;"><strong>Keterangan Tagihan:</strong> <?php echo e($selectedTagihan->catatan); ?></p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
    </div>
...
<?php /**PATH /Users/lpmnudiymacpro/Documents/nuist/resources/views/mobile/siswa/billing.blade.php ENDPATH**/ ?>