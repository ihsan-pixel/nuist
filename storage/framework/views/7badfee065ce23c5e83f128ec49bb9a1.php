    ...
    <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="day-section">
            <div class="day-header">
                <h6><i class="bx bx-calendar me-2"></i><?php echo e($day); ?></h6>
            </div>
            <div class="day-content">
                <?php if(isset($schedules[$day]) && $schedules[$day]->count() > 0): ?>
                    <?php $__currentLoopData = $schedules[$day]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="schedule-item">
                            <div class="schedule-icon">
                                <i class="bx bx-book"></i>
                            </div>
                            <div class="schedule-info flex-grow-1">
                                <h6><?php echo e($schedule->subject); ?></h6>
                                <p><?php echo e($schedule->class_name); ?></p>
                                <small><i class="bx bx-time-five"></i> <?php echo e($schedule->start_time); ?> - <?php echo e($schedule->end_time); ?></small>
                            </div>
