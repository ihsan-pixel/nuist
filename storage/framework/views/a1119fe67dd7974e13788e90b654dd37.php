            ...
            <ul class="nav-menu" id="nav-menu">
                <?php
                    ...
                    $rekapKelulusanAdminUrl = Route::has('talenta.rekap.kelulusan')
                        ...
                        : url('/talenta/rekap-kelulusan');
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->role === 'pemateri'): ?>
                ...
                <?php elseif(Auth::user()->role === 'tenaga_pendidik'): ?>
                    ...
                    <li><a href="<?php echo e(route('talenta.assessment.fill')); ?>" class="<?php echo e(request()->routeIs('talenta.assessment.fill') ? 'active' : ''); ?>">Instrumen Model Layanan</a></li>
                <?php elseif(Auth::user()->role === 'super_admin'): ?>
                    <li><a href="<?php echo e(route('talenta.admin.dashboard')); ?>" class="<?php echo e(request()->routeIs('talenta.admin.dashboard') ? 'active' : ''); ?>">Dashboard</a></li>
                    <li><a href="<?php echo e(route('talenta.data')); ?>" class="<?php echo e(request()->routeIs('talenta.data') ? 'active' : ''); ?>">Data Talenta</a></li>
                    <li><a href="<?php echo e(route('talenta.questions.index')); ?>" class="<?php echo e(request()->routeIs('talenta.questions.index') ? 'active' : ''); ?>">Soal</a></li>
                    <li><a href="<?php echo e(route('talenta.results.index')); ?>" class="<?php echo e(request()->routeIs('talenta.results.index') ? 'active' : ''); ?>">Hasil</a></li>
                    <li><a href="<?php echo e($rekapKelulusanAdminUrl); ?>" class="<?php echo e(request()->routeIs('talenta.rekap.kelulusan') ? 'active' : ''); ?>">Rekap Nilai</a></li>
                <?php else: ?>
                    <li><a href="<?php echo e(route('talenta.dashboard')); ?>" class="<?php echo e(request()->routeIs('talenta.dashboard') ? 'active' : ''); ?>">Dashboard</a></li>
                    <li><a href="<?php echo e(route('talenta.data')); ?>" class="<?php echo e(request()->routeIs('talenta.data') ? 'active' : ''); ?>">Data Talenta</a></li>
                    <li><a href="<?php echo e(route('talenta.instrumen-penilaian')); ?>" class="<?php echo e(request()->routeIs('talenta.instrumen-penilaian') ? 'active' : ''); ?>">Instrumen Penilaian</a></li>
            ...
            <?php if(Auth::check()): ?>
                ...
                <div class="profile-menu" id="profileMenu">
                    ...
                    <div class="profile-actions">
                        ...
                        <form method="POST" action="<?php echo e(route('talenta.logout')); ?>" style="display: inline;">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/talenta/navbar.blade.php ENDPATH**/ ?>