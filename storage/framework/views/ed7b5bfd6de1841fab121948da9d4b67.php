...
unset($__errorArgs, $__bag); ?>" id="ppdb_status" name="ppdb_status" style="max-width: 200px;">
                            <option value="tutup" <?php echo e(old('ppdb_status', $ppdbSetting->ppdb_status ?? 'tutup') == 'tutup' ? 'selected' : ''); ?>>Tutup</option>
                            <option value="buka" <?php echo e(old('ppdb_status', $ppdbSetting->ppdb_status ?? 'tutup') == 'buka' ? 'selected' : ''); ?>>Buka</option>
                        </select>
                        ...
                        <?php if(old('ppdb_status', $ppdbSetting->ppdb_status ?? 'tutup') == 'buka'): ?>
...
unset($__errorArgs, $__bag); ?>"
                                   ...
                                   value="<?php echo e(old('ppdb_jadwal_buka', $ppdbSetting->ppdb_jadwal_buka ? $ppdbSetting->ppdb_jadwal_buka->format('Y-m-d\TH:i') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                   ...
                                   value="<?php echo e(old('ppdb_jadwal_tutup', $ppdbSetting->ppdb_jadwal_tutup ? $ppdbSetting->ppdb_jadwal_tutup->format('Y-m-d\TH:i') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                   ...
                                   value="<?php echo e(old('ppdb_jadwal_pengumuman', $ppdbSetting->ppdb_jadwal_pengumuman ? $ppdbSetting->ppdb_jadwal_pengumuman->format('Y-m-d\TH:i') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                   ...
                                   value="<?php echo e(old('ppdb_kuota_total', $ppdbSetting->ppdb_kuota_total ?? '')); ?>" readonly>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <?php if($availableJalur->count() > 0): ?>
                        <div class="row">
                            <?php $__currentLoopData = $availableJalur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jalur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="form-check d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1">
                                            <label class="form-check-label d-flex align-items-center" for="jalur_<?php echo e($jalur->id); ?>">
                                                ...
                                                <?php if(in_array($jalur->id, $selectedJalurIds)): ?>
                    ...
                    <?php $__errorArgs = ['ppdb_jalur_active'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                              ...
                              placeholder="Informasi biaya pendaftaran PPDB"><?php echo e(old('ppdb_biaya_pendaftaran', $ppdbSetting->ppdb_biaya_pendaftaran ?? '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                              ...
                              placeholder="Catatan tambahan untuk pengumuman hasil PPDB"><?php echo e(old('ppdb_catatan_pengumuman', $ppdbSetting->ppdb_catatan_pengumuman ?? '')); ?></textarea>
