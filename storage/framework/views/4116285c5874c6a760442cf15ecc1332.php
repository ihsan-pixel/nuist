                ...
                <div class="card-body">
                    <div class="invoice-title">
                        ...
                        <div class="auth-logo mb-4">
                            <img src="<?php echo e(asset('build/images/logo-dark.png')); ?>" alt="logo" class="auth-logo-dark" height="20" />
                            <img src="<?php echo e(asset('build/images/logo-light.png')); ?>" alt="logo" class="auth-logo-light" height="20" />
                        </div>
                    </div>
                    <hr>
                    <div class="row">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/invoices-detail.blade.php ENDPATH**/ ?>