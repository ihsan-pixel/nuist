...
<div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-2"><?php echo e($ppdbSetting->nama_sekolah); ?> | Tahun <?php echo e($ppdbSetting->tahun); ?></p>
                </div>
                <div class="text-right">
                    <p class="text-sm text-gray-600">Status Pendaftaran:</p>
                    <span class="inline-block px-4 py-2 rounded-full font-bold
                        <?php echo e($ppdbSetting->status === 'buka' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                        <?php echo e(ucfirst($ppdbSetting->status)); ?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($statistik['total_pendaftar']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-yellow-600 mt-2"><?php echo e($statistik['pending']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-600 mt-2"><?php echo e($statistik['verifikasi']); ?></p>
                    </div>
                    <div class="p-3 bg-blue-100 rounded-full">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600 mt-2"><?php echo e($statistik['lulus']); ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-red-600 mt-2"><?php echo e($statistik['tidak_lulus']); ?></p>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <a href="<?php echo e(route('ppdb.sekolah.verifikasi')); ?>"
               class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-yellow-500">
                ...
                <span class="inline-block mt-4 text-yellow-600 font-semibold">
                    <?php echo e($statistik['pending']); ?> menunggu verifikasi →
                </span>
            </a>

            <a href="<?php echo e(route('ppdb.sekolah.seleksi')); ?>"
               class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-blue-500">
                ...
                <span class="inline-block mt-4 text-blue-600 font-semibold">
                    <?php echo e($statistik['verifikasi']); ?> siap diseleksi →
                </span>
            </a>

            <a href="<?php echo e(route('ppdb.sekolah.export')); ?>"
               class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow cursor-pointer border-l-4 border-green-500">
                ...
                <span class="inline-block mt-4 text-green-600 font-semibold">
                    Export <?php echo e($statistik['total_pendaftar']); ?> data →
                </span>
            </a>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="border-l-4 border-green-600 pl-4">
                    ...
                    <p class="text-2xl font-bold text-green-700"><?php echo e($ppdbSetting->jadwal_buka->format('d M Y')); ?></p>
                    <p class="text-gray-500 text-xs"><?php echo e($ppdbSetting->jadwal_buka->format('H:i')); ?></p>
                </div>
                <div class="border-l-4 border-red-600 pl-4">
                    <p class="text-gray-600 text-sm">Berakhir</p>
                    <p class="text-2xl font-bold text-red-700"><?php echo e($ppdbSetting->jadwal_tutup->format('d M Y')); ?></p>
                    <p class="text-gray-500 text-xs"><?php echo e($ppdbSetting->jadwal_tutup->format('H:i')); ?></p>
                </div>
                <div class="border-l-4 border-blue-600 pl-4">
                    <p class="text-gray-600 text-sm">Sisa Waktu</p>
                    <p class="text-2xl font-bold text-blue-700"><?php echo e($ppdbSetting->remainingDays()); ?> hari</p>
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/ppdb/dashboard/sekolah-new.blade.php ENDPATH**/ ?>