<?php $__env->startSection('title', 'Penilaian Fasilitator - Instrument Talenta'); ?>
                ...
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="fasilitator_id" required>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $fasilitators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fasilitator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <option value="<?php echo e($fasilitator->id); ?>"
                                        data-materi="<?php echo e($fasilitator->materi->judul_materi ?? 'N/A'); ?>"
                                        data-tanggal="<?php echo e($fasilitator->materi->tanggal_materi ? $fasilitator->materi->tanggal_materi->format('d/m/Y') : 'N/A'); ?>">
                                    <?php echo e($fasilitator->nama); ?> (<?php echo e($fasilitator->kode_fasilitator); ?>)
                                </option>
...
<?php echo $__env->make('layouts.mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/instumen-talenta/penilaian-fasilitator.blade.php ENDPATH**/ ?>