<?php $__env->startSection('title', 'Data MGMP'); ?>
...
<section id="data-mgmp" class="section-clean">
    <div class="container">
        ...
        <div class="grid animate fade-up delay-1">
            <!-- MGMP Matematika -->
            <div class="mgmp-card">
                <img src="<?php echo e(asset('images/mgmp-matematika.png')); ?>" alt="Logo MGMP Matematika" class="mgmp-logo">
            ...
            <div class="mgmp-card">
                <img src="<?php echo e(asset('images/mgmp-bindo.png')); ?>" alt="Logo MGMP Bahasa Indonesia" class="mgmp-logo">
            ...
            <!-- MGMP IPA -->
            <div class="mgmp-card">
                <img src="<?php echo e(asset('images/mgmp-ipa.png')); ?>" alt="Logo MGMP IPA" class="mgmp-logo">
            ...
            <!-- MGMP IPS -->
            <div class="mgmp-card">
                <img src="<?php echo e(asset('images/mgmp-ips.png')); ?>" alt="Logo MGMP IPS" class="mgmp-logo">
            ...
            <!-- MGMP Bahasa Inggris -->
            <div class="mgmp-card">
                <img src="<?php echo e(asset('images/mgmp-english.png')); ?>" alt="Logo MGMP Bahasa Inggris" class="mgmp-logo">
            ...
            <!-- MGMP PKn -->
            <div class="mgmp-card">
                <img src="<?php echo e(asset('images/mgmp-pkn.png')); ?>" alt="Logo MGMP PKn" class="mgmp-logo">
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/nuist/resources/views/mgmp/data.blade.php ENDPATH**/ ?>