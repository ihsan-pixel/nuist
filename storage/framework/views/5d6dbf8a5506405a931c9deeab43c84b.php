...
<div class="form-container">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('error') || session('db_error')): ?>
        <div class="alert alert-danger" role="alert" style="margin-bottom: 16px;">
            ...
            <div style="margin-top:6px;">
                ...
                <?php elseif(session('db_error')): ?>
                    <?php echo e(session('db_error')); ?>
                ...
                <div class="section-content">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jabatan_saat_ini">
                            ...
                            <option value="kepala_sekolah" <?php echo e(old('jabatan_saat_ini') == 'kepala_sekolah' ? 'selected' : ''); ?>>Kepala Sekolah</option>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="riwayat_jabatan_pemula" value="<?php echo e(old('riwayat_jabatan_pemula')); ?>" placeholder="(1) Jelaskan Riwayat Jabatan Guru :">
                        <input type="text" name="riwayat_jabatan_terampil" value="<?php echo e(old('riwayat_jabatan_terampil')); ?>" placeholder="(2) Jelaskan Riwayat Jabatan Guru :" style="margin-top: 8px;">
                        <input type="text" name="riwayat_jabatan_mahir" value="<?php echo e(old('riwayat_jabatan_mahir')); ?>" placeholder="(3) Jelaskan Riwayat Jabatan Guru :" style="margin-top: 8px;">
                        <input type="text" name="riwayat_jabatan_ahli" value="<?php echo e(old('riwayat_jabatan_ahli')); ?>" placeholder="(4) Jelaskan Riwayat Jabatan Guru :" style="margin-top: 8px;">
...
<?php echo $__env->make('layouts.mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/mobile/talenta/create.blade.php ENDPATH**/ ?>