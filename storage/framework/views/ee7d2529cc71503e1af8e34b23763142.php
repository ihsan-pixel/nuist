<header id="home" class="landing-home-hero" aria-labelledby="landing-home-title">
    <div class="container landing-home-hero__container">
        <img
            src="<?php echo e(asset('images/image 1.png')); ?>"
        ...
        <p class="landing-home-hero__description animate fade-up delay-2">
            <?php echo e($landing->content_hero ?? 'Kelola data kelembagaan, aktivitas, sistem informasi dan layanan dalam satu aplikasi yang modern, aman, dan mudah digunakan.'); ?>

        </p>

        <img
            src="<?php echo e(asset('images/image 2.png')); ?>"
...
<?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/landing/partials/home/hero.blade.php ENDPATH**/ ?>