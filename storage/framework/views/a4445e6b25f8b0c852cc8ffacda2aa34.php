                ...
                <div class="col-lg-12">
                    <div class="text-center mb-5 text-muted">
                        <a href="index" class="d-block auth-logo">
                            <img src="<?php echo e(asset('build/images/logo-dark.png')); ?>" alt="" height="20"
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('build/js/pages/two-step-verification.init.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/x-template/auth-two-step-verification.blade.php ENDPATH**/ ?>