    ...
    <?php else: ?>
        ...
        <div class="status-result-section">
            ...
            <div class="text-center mt-4">
                <a href="<?php echo e(route('ppdb.cek-status', ['reset' => 1])); ?>" class="btn btn-back">
                    <i class="fas fa-arrow-left me-2"></i>Cek NISN Lain
                </a>
            </div>
        </div>
...
function verifyOTP() {
    ...
    fetch(`<?php echo e(url('/ppdb/verify-otp')); ?>/${pendaftarId}`, {
        method: 'POST',
        headers: {
    ...
    .then(async response => {
        ...
        window.location.href = data.redirect_url || '<?php echo e(route('ppdb.cek-status')); ?>';
    })
    .catch(error => {
...
function resetForm() {
    window.location.href = '<?php echo e(route('ppdb.cek-status', ['reset' => 1])); ?>';
}
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/ppdb/cek-status.blade.php ENDPATH**/ ?>