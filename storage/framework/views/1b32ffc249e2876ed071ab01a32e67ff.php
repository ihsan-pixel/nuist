            ...
            <div class="card mb-3">
                <div class="card-body py-2">
                    <h4 class="page-title mb-0" style="font-size: 16px; font-weight: 600; color: #004b4c;">
                        <i class="bx bx-building me-2"></i>Data Sekolah
                    </h4>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($madrasah->kecamatan ?? '-'); ?></td>
                                    <td><?php echo e($madrasah->kabupaten ?? '-'); ?></td>
                                    <td>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($madrasah->status == 'aktif'): ?>
                    ...
                    <?php echo e($madrasahs->links('vendor.pagination.bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/mobile/pengurus/data-sekolah.blade.php ENDPATH**/ ?>