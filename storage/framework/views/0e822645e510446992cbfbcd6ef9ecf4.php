...
<?php $__env->startComponent('components.breadcrumb'); ?>
    ...
    <?php $__env->slot('title'); ?> Mode Kiosk Presensi <?php $__env->endSlot(); ?>
    ...
    <div class="col-12">
        <div class="card kiosk-status-card">
            <div class="card-body p-4 p-lg-5">
                <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            Presensi guru dari komputer sekolah terdaftar dengan validasi IP, lokasi, dan <?php echo e(strtolower($verificationLabel)); ?>.
                        </p>
                    </div>
                ...
                <div class="alert <?php echo e($accessGranted ? 'alert-success' : 'alert-danger'); ?> mb-4">
                    <i class="bx <?php echo e($accessGranted ? 'bx-check-shield' : 'bx-error-circle'); ?> me-2"></i><?php echo e($accessMessage); ?>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6 col-xl-3">
                        <div class="meta-box">
                            ...
                            <div class="meta-value"><?php echo e($device?->madrasah?->name ?? '-'); ?></div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-3">
                        <div class="meta-box">
                            <div class="meta-label">Perangkat</div>
                            <div class="meta-value"><?php echo e($device?->name ?? '-'); ?></div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-3">
                        <div class="meta-box">
                            <div class="meta-label">Guru Tersedia</div>
                            <div class="meta-value"><?php echo e($teacherCount); ?></div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-3">
                        <div class="meta-box">
                            <div class="meta-label">Metode Verifikasi</div>
                            <div class="meta-value"><?php echo e($verificationLabel); ?></div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="panel-box">
                                ...
                                <div class="mb-3">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <span class="badge bg-primary-subtle text-primary border border-primary-subtle"><?php echo e($verificationLabel); ?></span>
                                    </div>
                                    <div class="d-grid gap-2">
                                        ...
                                        <button type="button" class="btn btn-primary" id="captureVerificationButton" disabled>
                                            <i class="bx bx-face me-1"></i><?php echo e($verificationMode === 'face_scan' ? 'Scan Wajah' : 'Ambil Selfie'); ?>

                                        </button>
                                    </div>
                                    <div id="captureStatus" class="small text-muted mt-2">
                                        <?php echo e($verificationMode === 'face_scan' ? 'Scan wajah belum dilakukan.' : 'Selfie belum diambil.'); ?>
                            ...
                            <div class="panel-box">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div class="small text-muted">
                                        <?php echo e($verificationMode === 'face_scan' ? 'Gunakan satu wajah, cahaya cukup, lalu ikuti arahan scan wajah yang muncul.' : 'Gunakan kamera depan dengan wajah terlihat jelas.'); ?>
...
<script>
    (function () {
        ...
        form.addEventListener('submit', async function (event) {
            ...
            try {
                const response = await fetch(<?php echo json_encode(route('school-kiosk.submit'), 15, 512) ?>, {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/nuist/resources/views/kiosk/school-kiosk.blade.php ENDPATH**/ ?>