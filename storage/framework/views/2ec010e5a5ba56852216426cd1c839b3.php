                            ...
                            <div id="schedules-container-<?php echo e($index); ?>">
                                <div class="schedule-row">
                                    <div class="row g-3 align-items-end">
                                        ...
                                        <div class="col-lg-3">
                                            <label for="class_names_text_<?php echo e($index); ?>_0" class="form-label field-label">Kelas</label>
                                            <textarea name="schedules[<?php echo e($index); ?>][0][class_names_text]" id="class_names_text_<?php echo e($index); ?>_0" class="form-control field-control" rows="2" placeholder="Contoh: VII A, VII B"><?php echo e(old("schedules.$index.0.class_names_text", old("schedules.$index.0.class_name"))); ?></textarea>
                                        </div>
                                        <div class="col-lg-2">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/teaching-schedules/create.blade.php ENDPATH**/ ?>