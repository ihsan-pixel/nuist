<?php $__env->startSection('title', 'Barcode Users'); ?>
...
<div class="container py-3" style="max-width: 540px; margin: auto;">
    ...
    <div id="usersContainer">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="card user-card" data-name="<?php echo e(strtolower($user->name)); ?>" data-nuist="<?php echo e($user->nuist_id); ?>">
                <div class="card-body p-3">
                    ...
                    <div class="barcode-container">
                        <svg id="barcode-<?php echo e($user->id); ?>" class="barcode-svg"></svg>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        JsBarcode("#barcode-<?php echo e($user->id); ?>", "<?php echo e($user->nuist_id); ?>", {
            format: "CODE128",
            width: 2,
            height: 60,
            displayValue: true,
