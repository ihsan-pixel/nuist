                ...
                <table id="datatable-<?php echo e(Str::slug($kabupaten)); ?>" class="table table-bordered dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size: 20px; text-align: center;"><?php echo e($madrasah->field_status['alamat'] ?? '❌'); ?></td>
                            <td style="font-size: 20px; text-align: center;"><?php echo e($madrasah->field_status['logo'] ?? '❌'); ?></td>
                            <td style="font-size: 20px; text-align: center;"><?php echo e($madrasah->field_status['latitude'] ?? '❌'); ?></td>
                            <td style="font-size: 20px; text-align: center;"><?php echo e($madrasah->field_status['longitude'] ?? '❌'); ?></td>
                            <td style="font-size: 20px; text-align: center;"><?php echo e($madrasah->field_status['map_link'] ?? '❌'); ?></td>
                            <td style="font-size: 20px; text-align: center;">
                                <?php echo e($madrasah->field_status['polygon_koordinat'] ?? '❌'); ?>
                            ...
                            <td style="font-size: 20px; text-align: center;"><?php echo e($madrasah->field_status['hari_kbm'] ?? '❌'); ?></td>
                            <td style="font-size: 20px; text-align: center;"><?php echo e($madrasah->field_status['status_guru'] ?? '❌'); ?></td>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/admin/data_madrasah.blade.php ENDPATH**/ ?>