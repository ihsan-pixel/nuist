...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex align-items-center mb-3" style="margin-top: -10px;">
        <a href="<?php echo e(route('mobile.dashboard')); ?>" class="btn btn-link text-decoration-none p-0 me-2" style="color: #004b4c;">
...
<div class="row g-2">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->role === 'tenaga_pendidik' && Auth::user()->ketugasan === 'kepala madrasah/sekolah'): ?>
        <div class="col-6">
            <a href="<?php echo e(route('mobile.laporan.persentase-kehadiran')); ?>" class="text-decoration-none">
                <div class="card shadow-sm text-center p-3">
                    <div class="avatar-md mx-auto mb-2">
...
<?php echo $__env->make('layouts.mobile', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/mobile/laporan.blade.php ENDPATH**/ ?>