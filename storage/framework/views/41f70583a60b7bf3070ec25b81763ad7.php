    ...
    <?php else: ?>
        ...
        <div class="izin-card">
            <div class="izin-header">
                <div>
                    <div class="izin-user"><?php echo e($presensi->user->name); ?></div>
                    <div class="izin-date"><?php echo e($presensi->tanggal->format('d M Y')); ?></div>
                </div>
                <div>
                    <span class="status-badge status-<?php echo e($presensi->status_izin); ?>">
            ...
            <div class="mb-3">
                <a href="<?php echo e(asset('storage/app/public/' . $presensi->surat_izin_path)); ?>"
                   target="_blank"
            ...
            <div class="izin-actions">
                <form action="<?php echo e(route('izin.approve', $presensi)); ?>" method="POST" style="flex: 1;">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="btn-approve">
                        <i class="bx bx-check"></i> Setujui
                    </button>
                </form>
                <form action="<?php echo e(route('izin.reject', $presensi)); ?>" method="POST" style="flex: 1;">
                    <?php echo csrf_field(); ?>
