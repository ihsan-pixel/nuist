            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-end mb-3">
                        ...
                        <a href="<?php echo e(route('instumen-talenta.belum-upload-tugas')); ?>" class="btn btn-sm btn-warning me-2" aria-label="Lihat Peserta Belum Upload">
...
<div class="modal fade" id="downloadBelumModal" tabindex="-1" aria-labelledby="downloadBelumModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="downloadBelumForm" method="GET" action="<?php echo e(route('instumen-talenta.download-tugas-belum')); ?>">
                <div class="modal-header">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/lpmnudiymacpro/Documents/Project Nuist/nuist/resources/views/instumen-talenta/upload-tugas.blade.php ENDPATH**/ ?>